...
//		private readonly int _noteMappingDtosCount;
...
//			_noteMappingDtosCount = _midiVelocity_MidiMappingDtos.Length + _midiNoteNumber_MidiMappingDtos.Length + _midiChannel_MidiMappingDtos.Length;
//		}
...
//		{
//			int j = 0;
//			var results = new(DimensionEnum dimensionEnum, string canonicalName, int? position, double value)[_noteMappingDtosCount];
