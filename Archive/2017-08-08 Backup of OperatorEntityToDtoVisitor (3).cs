...
//            Process_OperatorDtoBase(op, (OperatorDtoBase_Vars)dto);
...
//        private void Process_OperatorDtoBase(Operator op, OperatorDtoBase_Vars dto)
//        {
...
//            // TODO: Make a type vars with dimension?
//            if (dto is IOperatorDto_WithDimension dtoWithDimension)
//            {
//                SetDimensionProperties(op, dtoWithDimension);
//            }

//            _stack.Push(dto);
//        }

//        private void Process_OperatorDtoBase(Operator op, ClosestOverInlets_OperatorDto dto)
//        {
//            VisitOperatorBase(op);
...
//        private void Process_OperatorDtoBase(Operator op, OperatorDtoBase_WithCollectionRecalculation dto)
//        {
//            Process_OperatorDtoBase(op, (IOperatorDto_WithDimension)dto);
...
//        private void Process_OperatorDtoBase(Operator op, IOperatorDto_WithDimension dto)
//        {
//            Process_OperatorDtoBase(op, (IOperatorDto)dto);

//            SetDimensionProperties(op, dto);
//        }

//        /// <summary> Only works for operators that have a fixed inlet count (which is most of them). </summary>
