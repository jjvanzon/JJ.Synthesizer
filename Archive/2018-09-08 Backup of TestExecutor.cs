...
//                // Morph PatchInlet into a number operator.
...
//            CalculationMethodEnum calculationMethodEnum)
//        {
//            IList<IList<double>> inputPoints = xValues.CrossJoin(yValues, (x, y) => new[] { x, y })
//                                                      .Cast<IList<double>>()
//                                                      .ToArray();
...
//                {
//                    string message = FormatVarConstMessage(const1, const2);
//                    Console.WriteLine(message);

//                    // TODO: Replace point values with the consts. Perhaps remove duplicate points to reduce excessive testing / excessive logging.
...
//        // TODO: Implement
//        private static string FormatVarConstMessage(double? const1, double? const2) => null;
