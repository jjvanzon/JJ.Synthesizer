...
//            // Template Method
//            AudioFileOutputGridViewModel viewModel = ExecuteDeleteAction(
//                userInput,
//                () => _audioFileOutputGridPresenter.Delete(userInput, id),
//                () =>
//                    new UndoDeleteViewModel
//                    {
//                        EntityTypeEnum = EntityTypeEnum.AudioFileOutput,
//                        ID = id,
//                        OldStates = new[] { oldState }
//                    });
...
//        private TViewModel ExecuteDeleteAction<TViewModel>(TViewModel userInput, Func<TViewModel> partialAction, Func<UndoDeleteViewModel> createUndoItemViewModelDelegate)
...
//                // Undo History
//                UndoDeleteViewModel undoItemViewModel = createUndoItemViewModelDelegate();
