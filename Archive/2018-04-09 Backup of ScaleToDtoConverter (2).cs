...
//			//int sourceFirstOctave = sourceToneDtos.First().Octave;
//			//int sourceLastOctave = sourceToneDtos.Last().Octave;
//			//int sourceOctaveCount = sourceLastOctave - sourceFirstOctave + 1;
...
//					//int something = (destOctave) - sourceFirstOctave;
//					//int octavesShifted =  sourceOctaveCount * sourceRepetition;
...
//						//Frequency = sourceToneDto.Frequency * Math.Pow(2, octavesShifted)
//					};
