    ...
    public class InstrumentListPresenter
    {
        ...
        public object Show(int parentDocumentID)
        {
            ...
            if (mustCreateViewModel)
            {
                ...
                _viewModel = parentDocument.Instruments.ToChildDocumentListViewModel(parentDocument.ID, ChildDocumentTypeEnum.Instrument);
            }
        ...
        public ChildDocumentListViewModel Close()
        {
            if (_viewModel == null)
            {
                _viewModel = ViewModelHelper.CreateEmptyChildDocumentListViewModel(ChildDocumentTypeEnum.Instrument);
            }
