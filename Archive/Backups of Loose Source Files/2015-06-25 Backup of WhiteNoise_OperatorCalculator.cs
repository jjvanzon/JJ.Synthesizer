...
namespace JJ.Business.Synthesizer.Calculation.Operators.Entities
{
    internal class WhiteNoise_OperatorCalculator : OperatorCalculatorBase
    {
        ...
        /// <summary> 
        /// Prevents random offsets to be too close together, to prevent artifacts.
        /// But also should not be too big, or the chance that we get the same offset becomes bigger.
        /// </summary>
