...
//        {
//            Operator op = CreateOperatorBase(OperatorTypeEnum.AllPassFilter, inletCount: 3, outletCount: 1);
...
//            Outlet bandWidth = null)
//        {
//            Operator op = CreateOperatorBase(OperatorTypeEnum.BandPassFilterConstantPeakGain, inletCount: 3, outletCount: 1);
...
//            Outlet bandWidth = null)
//        {
//            Operator op = CreateOperatorBase(OperatorTypeEnum.BandPassFilterConstantTransitionGain, inletCount: 3, outletCount: 1);
...
//            Outlet bandWidth = null)
//        {
//            Operator op = CreateOperatorBase(OperatorTypeEnum.NotchFilter, inletCount: 3, outletCount: 1);
...
//                2,
//                DimensionEnum.Frequency,
//                DimensionEnum.Undefined,
...
//            int inletCount,
//            params DimensionEnum[] inletAndOutletDimensionEnums)
//        {
//            int outletCount = inletAndOutletDimensionEnums.Length - inletCount;

//            if (outletCount < 0)
//            {
//                throw new LessThanException(() => outletCount, 0);
//            }

//            IList<DimensionEnum> inletDimensionEnums = inletAndOutletDimensionEnums.Take(inletCount).ToArray();
//            IList<DimensionEnum> outletDimensionEnums = inletAndOutletDimensionEnums.Skip(inletCount).ToArray();

//            Operator op = CreateOperatorBase(operatorTypeEnum, inletCount, outletCount);
