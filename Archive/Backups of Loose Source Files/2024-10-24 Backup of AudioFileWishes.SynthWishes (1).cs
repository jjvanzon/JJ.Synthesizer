...
//        {
//            // Default to duration of 1 second
...
//            // If only trailing silence, return with original func
//            if (ConfigHelper.PlayLeadingSilence == 0)
//            {
//                return (func, duration2);
//            }

//            // If there is leading silence too, return a new func with a Delay
//            Outlet func2() => Delay(func(), ConfigHelper.PlayLeadingSilence);
