...
//{
//    internal class SampleCalculator_Byte_Mono_Block : SampleCalculatorBase
//    {
//        private ArrayCalculator_MinTimeZero_Block _arrayCalculator;

//        public SampleCalculator_Byte_Mono_Block(Sample sample, byte[] bytes)
//            : base(sample, bytes)
//        {
//            if (sample.GetChannelCount() != 1) throw new NotEqualException(() => sample.GetChannelCount(), 1);

//            double[][] samples = SampleCalculatorHelper.ReadByteSamples(sample, bytes);
