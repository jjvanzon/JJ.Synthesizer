...
//            // Try match by name (are always unique)
...
//                    destCustomOperatorInlets.Where(x => x.GetDimensionEnum() == sourceDimensionEnum)
//                                            .Take(2)
//                                            .ToArray();

//                bool destIsUnique = destCustomOperatorInlets_WithMatchingDimension.Count <= 1;

//                bool sourceIsUnique =
//                    sourcePatchInlet.Patch.EnumerateOperatorsOfType(OperatorTypeEnum.PatchInlet)
//                                    .Where(x => x.GetStandardDimensionEnum() == sourceDimensionEnum)
//                                    .Take(2)
//                                    .Count() <= 1;

//                bool isUnique = destCustomOperatorInlets_WithMatchingDimension.Count <= 1 &&
//                                sourceIsUnique;
//                if (isUnique)
//                {
...
//            // Try match by list index (are always unique)
