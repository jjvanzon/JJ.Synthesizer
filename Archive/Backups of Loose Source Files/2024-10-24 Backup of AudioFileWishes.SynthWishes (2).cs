...
//            [CallerMemberName] string callerMemberName = null)
//            => Play(
//                outletFunc, duration?.Calculate() ?? default, volume?.Calculate() ?? default,
//                speakerSetupEnum, sampleDataTypeEnum, audioFileFormatEnum, samplingRateOverride,
//                fileName, callerMemberName);
...
//            [CallerMemberName] string callerMemberName = null)
//            => Play(
//                outletFunc, duration, volume?.Calculate() ?? default,
//                speakerSetupEnum, sampleDataTypeEnum, audioFileFormatEnum, samplingRateOverride,
//                fileName, callerMemberName);
...
//            [CallerMemberName] string callerMemberName = null)
//            => Play(
//                outletFunc, duration?.Calculate() ?? default, volume,
//                speakerSetupEnum, sampleDataTypeEnum, audioFileFormatEnum, samplingRateOverride,
//                fileName, callerMemberName);
...
//            [CallerMemberName] string callerMemberName = null)
//            => SaveAudio(
//                func, duration?.Calculate() ?? default, volume?.Calculate() ?? default,
