...
//                // Warnings Before
//                IResult warningsResultBefore = documentManager.GetWarningsRecursive(document);
//                IList<string> warningTextsBefore = warningsResultBefore.Messages
//                                                                       .Select(x => x.Text)
//                                                                       .OrderBy(x => x)
//                                                                       .Distinct()
//                                                                       .ToArray();
...
//                // Warnings After
//                IResult warningsResultAfter = documentManager.GetWarningsRecursive(document);
//                IList<string> warningTextsAfter = warningsResultAfter.Messages
//                                                                     .Select(x => x.Text)
//                                                                     .OrderBy(x => x)
//                                                                     .Distinct()
//                                                                     .ToArray();
//                if (!warningTextsAfter.SequenceEqual(warningTextsBefore))
//                {
//                    IList<string> additionalWarnings = warningTextsAfter.Except(warningTextsBefore).ToArray();
