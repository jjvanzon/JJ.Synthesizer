...
{
    internal abstract class Interpolate_OperatorCalculator_Base_Original : OperatorCalculatorBase_WithChildCalculators
    {
        ...
        public Interpolate_OperatorCalculator_Base_Original(
