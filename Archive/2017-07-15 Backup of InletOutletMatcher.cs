...
//            OperatorTypeEnum operatorTypeEnum = sourceInletOrOutlet.Operator.GetOperatorTypeEnum();
//            if (operatorTypeEnum == OperatorTypeEnum.PatchInlet ||
//                operatorTypeEnum == OperatorTypeEnum.PatchOutlet)
//            {
//                // Can't match it by any property, because those are all custom filled in, even the position!
//                // You gotta take the first or default!
//                return candicateDestInletsOrOutlets.FirstOrDefault();
//            }
