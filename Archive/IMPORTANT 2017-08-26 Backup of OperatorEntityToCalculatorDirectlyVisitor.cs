...
//            OperatorCalculatorBase positionCalculator = new GetDimension_OperatorCalculator(dimensionStack);
...
//            else
//            {
//                calculator = new AverageFollower_OperatorCalculator(
//                    signalCalculator,
...
//            else
//            {
//                calculator = new DimensionToOutlets_OperatorCalculator_WithSignalOutput(operandCalculator, position, dimensionStack);
//            }
...
//            else
//            {
//                calculator = new Loop_OperatorCalculator_WithSignalOutput(
//                    signalCalculator,
//                    skipCalculator,
...
//            var calculator = new Noise_OperatorCalculator(new GetDimension_OperatorCalculator(dimensionStack), noiseCalculator);
//            _stack.Push(calculator);
//        }
...
//            {
//                operatorCalculator = new RangeOverDimension_OperatorCalculator_WithConsts_AndStepOne(from, till, positionCalculator);
//            }
//            else if (fromIsConst && tillIsConst && stepIsConst)
//            {
//                operatorCalculator = new RangeOverDimension_OperatorCalculator_OnlyConsts(from, till, step, positionCalculator);
//            }
//            else if (!fromIsConst && !tillIsConst && !stepIsConst)
//            {
//                operatorCalculator = new RangeOverDimension_OperatorCalculator_OnlyVars(fromCalculator, tillCalculator, stepCalculator, positionCalculator);
//            }
//            else
//            {
//                throw new CalculatorNotFoundException(MethodBase.GetCurrentMethod());
...
//            OperatorCalculatorBase positionCalculator = new GetDimension_OperatorCalculator(dimensionStack);
//            OperatorCalculatorBase channelPositionCalculator = new GetDimension_OperatorCalculator(channelDimensionStack);
...
//                {
//                    calculator = new SampleWithRate1_OperatorCalculator_NoChannelConversion(positionCalculator, channelPositionCalculator, underlyingCalculators);
//                }
//                else if (sampleChannelCount == 1 && _targetChannelCount == 2)
//                {
//                    calculator = new SampleWithRate1_OperatorCalculator_MonoToStereo(positionCalculator, underlyingCalculator);
//                }
//                else if (sampleChannelCount == 2 && _targetChannelCount == 1)
//                {
//                    calculator = new SampleWithRate1_OperatorCalculator_StereoToMono(positionCalculator, underlyingCalculators);
//                }
//            }
...
//            _stack.Push(new SineWithRate1_OperatorCalculator(positionCalculator));
//        }
...
//            else
//            {
//                calculator = new SumFollower_OperatorCalculator(signalCalculator, sliceLengthCalculator, sampleCountCalculator, positionCalculator);
//            }
...
//            _stack.Push(new TriangleWithRate1_OperatorCalculator(positionCalculator));
//        }
