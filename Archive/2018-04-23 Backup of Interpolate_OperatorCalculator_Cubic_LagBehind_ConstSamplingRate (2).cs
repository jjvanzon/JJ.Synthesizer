...
//				(_a, _b, _c) = Interpolator.Cubic_SmoothSlope_PrecalculateVariables(_x0 - 1, _x0, x1, x2, _yMinus1, _y0, _y1, _y2);
//			}
...
//			double x0 = x - dx;
//			double xMinus1 = x0 - dx;
//			double x1 = x;
//			double x2 = x + dx;

//			(_a, _b, _c) = Interpolator.Cubic_SmoothSlope_PrecalculateVariables(xMinus1, x0, x1, x2, y, y, y, y);
