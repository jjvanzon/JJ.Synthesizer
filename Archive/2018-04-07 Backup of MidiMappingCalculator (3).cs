...
//		private readonly MidiMappingDto[] _midiNote_MidiMappingDtos;
//		private readonly int _noteMappingsCount;
...
//			_midiNote_MidiMappingDtos = _midiVelocity_MidiMappingDtos.Union(_midiNoteNumber_MidiMappingDtos)
//			                                                         .Union(_midiChannel_MidiMappingDtos)
//			                                                         .ToArray();

//			_noteMappingsCount = _midiVelocity_MidiMappingDtos.Length + _midiNoteNumber_MidiMappingDtos.Length + _midiChannel_MidiMappingDtos.Length;
//		}
...
//			int midiChannel)
//		{
//			MidiMappingDto[] midiNote_MidiMappingDtos = _midiNote_MidiMappingDtos;
//			int count = midiNote_MidiMappingDtos.Length;

//			var results = new(DimensionEnum dimensionEnum, string canonicalName, int? position, double value)[count];

//			for (int i = 0; i < count; i++)
//			{
//				MidiMappingDto dto = midiNote_MidiMappingDtos[i];

//				results[i] = (
//					dto.DimensionEnum,
//					dto.Name,
//					dto.Position,
//					CalculateDimensionValue(midiNoteNumber, dto));
//			}
