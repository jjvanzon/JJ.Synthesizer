...
//        {
//            return ProcessWithDimension(dto, dimensionStack => new AverageFollower_OperatorCalculator(_stack.Pop(), _stack.Pop(), _stack.Pop(), new GetDimension_OperatorCalculator(dimensionStack)));
//        }
...
//        {
//            return ProcessWithDimension(dto, dimensionStack => new RangeOverDimension_OperatorCalculator_OnlyConsts(dto.From.Const, dto.Till.Const, dto.Step.Const, _stack.Pop()));
//        }
...
//        {
//            return ProcessWithDimension(dto, dimensionStack => new RangeOverDimension_OperatorCalculator_OnlyVars(_stack.Pop(), _stack.Pop(), _stack.Pop(), _stack.Pop()));
//        }
...
//        {
//            return ProcessWithDimension(dto, dimensionStack => new RangeOverDimension_OperatorCalculator_WithConsts_AndStepOne(dto.From.Const, dto.Till.Const, _stack.Pop()));
//        }
...
//        {
//            return ProcessWithDimension(dto, dimensionStack => new Squash_OperatorCalculator_WithOrigin_WithPositionOutput(_stack.Pop(), _stack.Pop(), _stack.Pop()));
//        }
...
//        {
//            return ProcessWithDimension(dto, dimensionStack => new SumFollower_OperatorCalculator(_stack.Pop(), _stack.Pop(), _stack.Pop(), new GetDimension_OperatorCalculator(dimensionStack)));
//        }
...
//            DimensionStack dimensionStack = CreateDimensionStack_FromPoppedPositionCalculator(dto);
