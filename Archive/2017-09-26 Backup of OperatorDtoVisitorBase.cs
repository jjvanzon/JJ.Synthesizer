...
//            IList<IOperatorDto> originalInputOperatorDtos = GetInputOperatorDtos(originalDto);

//            IOperatorDto newDto = func(originalDto);
//            IList<IOperatorDto> newInputOperatorDtos = GetInputOperatorDtos(newDto);

//            // Revisit as long as different instances keep coming.

//            while (newDto != originalDto || !newInputOperatorDtos.SequenceEqual(originalInputOperatorDtos))
//            {
//                originalDto = newDto;
//                originalInputOperatorDtos = GetInputOperatorDtos(originalDto);

//                newDto = Visit_OperatorDto_Polymorphic(newDto);
//                newInputOperatorDtos = GetInputOperatorDtos(newDto);
//            }
...
//        private static IList<IOperatorDto> GetInputOperatorDtos(IOperatorDto dto) => dto.Inputs.Select(x => x.VarOrConst).ToArray();
