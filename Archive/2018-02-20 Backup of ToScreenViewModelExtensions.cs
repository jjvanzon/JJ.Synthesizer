...
//			viewModel.Patches = NewMethod(patches);
...
//			//viewModel.Scale = currentScale.ToIDAndName();
//			//viewModel.MidiMappingElements
//			return viewModel;
//		}

//		private static List<CurrentInstrumentItemViewModel> NewMethod(IList<Patch> patches, Func<Patch>)
//		{
//			int lastIndex = patches.Count - 1;
//			return patches.Select(
//				              (x, i) => new CurrentInstrumentItemViewModel
//				              {
//					              EntityID = x.ID,
//					              Name = x.Name,
//					              CanGoBackward = i != 0,
