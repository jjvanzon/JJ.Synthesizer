...
//            // Template Method
//            AudioFileOutputGridViewModel viewModel = ExecuteDeleteAction(userInput, new[] { oldState }, () => _audioFileOutputGridPresenter.Delete(userInput, id), EntityTypeEnum.AudioFileOutput, id);
...
//                    ExecuteUndoRedoDeletion(undoInsertViewModel.EntityTypeEnum, undoInsertViewModel.ID);
//                    break;
...
//                case UndoDeleteViewModel undoDeleteViewModel:
//                    ExecuteUndoRedoDeletion(undoDeleteViewModel.EntityTypeEnum, undoDeleteViewModel.ID);
//                    break;
...
//        private TViewModel ExecuteDeleteAction<TViewModel>(TViewModel userInput, IList<ViewModelBase> oldStates, Func<TViewModel> partialAction, EntityTypeEnum entityTypeEnum, int entityID)
...
//                // Undo History
//                var undoItemViewModel = new UndoDeleteViewModel
//                {
