...
//                {
//                    (x0, y0),
//                    (Math.PI * -08 / 12, Interpolator.CubicSmoothSlope(x0, x0, x1, x2, y0, y0, y1, y2, (2 * x0 + x1) / 3)),
//                    (Math.PI * -07 / 12, Interpolator.CubicSmoothSlope(x0, x0, x1, x2, y0, y0, y1, y2, (x0 + 2 * x1) / 3)),
//                    (x1, y1),
...
//                    (x7, y7),
//                    (Math.PI * 13 / 12, Interpolator.CubicSmoothSlope(x6, x7, x8, x8, y6, y7, y8, y8, (2 * x7 + x8) / 3)),
//                    (Math.PI * 14 / 12, Interpolator.CubicSmoothSlope(x6, x7, x8, x8, y6, y7, y8, y8, (x7 + 2 * x8) / 3)),
//                    (x8, y8)
//                },
//                plotLineCount: 25);
//        }
