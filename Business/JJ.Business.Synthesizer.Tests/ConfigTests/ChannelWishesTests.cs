...
namespace JJ.Business.Synthesizer.Tests.ConfigTests
{
    ...
    public class ChannelWishesTests
    {
        ...
        public void BuffBound_Channel(string caseKey)
        {
            ...
            // By Design: Channels property is not set to avoid interfering with Channel state.
            // The same channel number results in the same (ambiguous) state, whether Mono or Stereo.
        ...
        AreEqual(StereoChannels, () => x.TapeBound.TapeConfig .Channels      );
                         ...
                         IsTrue (() => x.TapeBound.TapeConfig .IsChannelEmpty);
        ...
        AreEqual(ChannelEmpty  , () => x.TapeBound.Tape       .GetChannel    ());
        AreEqual(ChannelEmpty  , () => x.TapeBound.TapeConfig .GetChannel    ());
        AreEqual(ChannelEmpty  , () => x.TapeBound.TapeActions.GetChannel    ());
        AreEqual(ChannelEmpty  , () => x.TapeBound.TapeAction .GetChannel    ());
        ...
        AreEqual(StereoChannels, () => x.TapeBound.TapeAction .GetChannels   ());
                         ...
                         IsTrue (() => x.TapeBound.Tape       .IsChannelEmpty());
                         IsTrue (() => x.TapeBound.TapeConfig .IsChannelEmpty());
                         IsTrue (() => x.TapeBound.TapeActions.IsChannelEmpty());
                         IsTrue (() => x.TapeBound.TapeAction .IsChannelEmpty());
        ...
        AreEqual(ChannelEmpty  , () => Channel       (x.TapeBound.Tape        ));
        AreEqual(ChannelEmpty  , () => Channel       (x.TapeBound.TapeConfig  ));
        AreEqual(ChannelEmpty  , () => Channel       (x.TapeBound.TapeActions ));
        AreEqual(ChannelEmpty  , () => Channel       (x.TapeBound.TapeAction  ));
        ...
        AreEqual(ChannelEmpty  , () => GetChannel    (x.TapeBound.Tape        ));
        AreEqual(ChannelEmpty  , () => GetChannel    (x.TapeBound.TapeConfig  ));
        AreEqual(ChannelEmpty  , () => GetChannel    (x.TapeBound.TapeActions ));
        AreEqual(ChannelEmpty  , () => GetChannel    (x.TapeBound.TapeAction  ));
        ...
        AreEqual(StereoChannels, () => GetChannels   (x.TapeBound.TapeAction  ));
                         ...
                         IsTrue (() => IsChannelEmpty(x.TapeBound.Tape        ));
                         IsTrue (() => IsChannelEmpty(x.TapeBound.TapeConfig  ));
                         IsTrue (() => IsChannelEmpty(x.TapeBound.TapeActions ));
                         IsTrue (() => IsChannelEmpty(x.TapeBound.TapeAction  ));
        ...
        AreEqual(ChannelEmpty  , () => ConfigWishes.Channel       (x.TapeBound.Tape       ));
        AreEqual(ChannelEmpty  , () => ConfigWishes.Channel       (x.TapeBound.TapeConfig ));
        AreEqual(ChannelEmpty  , () => ConfigWishes.Channel       (x.TapeBound.TapeActions));
        AreEqual(ChannelEmpty  , () => ConfigWishes.Channel       (x.TapeBound.TapeAction ));
        ...
        AreEqual(ChannelEmpty  , () => ConfigWishes.GetChannel    (x.TapeBound.Tape       ));
        AreEqual(ChannelEmpty  , () => ConfigWishes.GetChannel    (x.TapeBound.TapeConfig ));
        AreEqual(ChannelEmpty  , () => ConfigWishes.GetChannel    (x.TapeBound.TapeActions));
        AreEqual(ChannelEmpty  , () => ConfigWishes.GetChannel    (x.TapeBound.TapeAction ));
        ...
        AreEqual(StereoChannels, () => ConfigWishes.GetChannels   (x.TapeBound.TapeAction ));
                         ...
                         IsTrue (() => ConfigWishes.IsChannelEmpty(x.TapeBound.Tape       ));
                         IsTrue (() => ConfigWishes.IsChannelEmpty(x.TapeBound.TapeConfig ));
                         IsTrue (() => ConfigWishes.IsChannelEmpty(x.TapeBound.TapeActions));
                         IsTrue (() => ConfigWishes.IsChannelEmpty(x.TapeBound.TapeAction ));
        ...
        AreEqual(StereoChannels, () => x.BuffBound.AudioFileOutput.GetChannels   ());
                         ...
                         IsTrue (() => x.BuffBound.Buff           .IsChannelEmpty());
                         IsTrue (() => x.BuffBound.AudioFileOutput.IsChannelEmpty());
        ...
        AreEqual(StereoChannels, () => GetChannels   (x.BuffBound.AudioFileOutput ));
                         ...
                         IsTrue (() => IsChannelEmpty(x.BuffBound.Buff            ));
                         IsTrue (() => IsChannelEmpty(x.BuffBound.AudioFileOutput ));
        ...
        AreEqual(StereoChannels, () => ConfigWishes.GetChannels   (x.BuffBound.AudioFileOutput));
                         ...
                         IsTrue (() => ConfigWishes.IsChannelEmpty(x.BuffBound.Buff           ));
                         IsTrue (() => ConfigWishes.IsChannelEmpty(x.BuffBound.AudioFileOutput));
