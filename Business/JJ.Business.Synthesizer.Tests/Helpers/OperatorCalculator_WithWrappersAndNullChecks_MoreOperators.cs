...
{
    internal class OperatorCalculator_WithWrappersAndNullChecks_MoreOperators : IOperatorCalculator
    {
        ...
        public OperatorCalculator_WithWrappersAndNullChecks_MoreOperators(int channelIndex)
        {
