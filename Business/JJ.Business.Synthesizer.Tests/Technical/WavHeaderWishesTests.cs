...
namespace JJ.Business.Synthesizer.Tests.Technical
{
    ...
    public class WavHeaderWishesTests
    {
        ...
        public void WriteWavHeader_Test(string caseKey)
        {
            ...
            AssertWrite(bin => WavHeaderWishes.WriteWavHeader(entities.BuffBound.AudioFileOutput,   bin.BinaryWriter,    courtesy), ForBinaryWriter, test); // By Design: explicit FrameCount() call omitted; would fall between two internal WriteWavHeader calls.
            ...
            AssertWrite(bin => WavHeaderWishes.WriteWavHeader(bin.BinaryWriter, entities.BuffBound.AudioFileOutput,      courtesy), ForBinaryWriter, test); // By Design: explicit FrameCount() call omitted; would fall between two internal WriteWavHeader calls.
        ...
        public void WriteWavHeader_Test_ZeroFrames(string caseKey)
        {
            ...
            AssertSetter(() => WriteWavHeader(binaries.DestStream,   entities.BuffBound.AudioFileOutput), ForDestStream  );
            AssertSetter(() => WriteWavHeader(binaries.BinaryWriter, entities.BuffBound.AudioFileOutput), ForBinaryWriter);
            AssertSetter(() => WavHeaderWishes.WriteWavHeader(entities.BuffBound.Buff,            binaries.DestFilePath), ForDestFilePath);
            AssertSetter(() => WavHeaderWishes.WriteWavHeader(entities.BuffBound.Buff,            binaries.DestBytes   ), ForDestBytes   );
            AssertSetter(() => WavHeaderWishes.WriteWavHeader(entities.BuffBound.Buff,            binaries.DestStream  ), ForDestStream  );
            AssertSetter(() => WavHeaderWishes.WriteWavHeader(entities.BuffBound.Buff,            binaries.BinaryWriter), ForBinaryWriter);
            AssertSetter(() => WavHeaderWishes.WriteWavHeader(entities.BuffBound.AudioFileOutput, binaries.DestFilePath), ForDestFilePath);
            AssertSetter(() => WavHeaderWishes.WriteWavHeader(entities.BuffBound.AudioFileOutput, binaries.DestBytes   ), ForDestBytes   );
            AssertSetter(() => WavHeaderWishes.WriteWavHeader(entities.BuffBound.AudioFileOutput, binaries.DestStream  ), ForDestStream  );
            AssertSetter(() => WavHeaderWishes.WriteWavHeader(entities.BuffBound.AudioFileOutput, binaries.BinaryWriter), ForBinaryWriter);
            AssertSetter(() => WavHeaderWishes.WriteWavHeader(binaries.DestFilePath, entities.BuffBound.Buff           ), ForDestFilePath);
            AssertSetter(() => WavHeaderWishes.WriteWavHeader(binaries.DestBytes,    entities.BuffBound.Buff           ), ForDestBytes   );
            AssertSetter(() => WavHeaderWishes.WriteWavHeader(binaries.DestStream,   entities.BuffBound.Buff           ), ForDestStream  );
            AssertSetter(() => WavHeaderWishes.WriteWavHeader(binaries.BinaryWriter, entities.BuffBound.Buff           ), ForBinaryWriter);
            AssertSetter(() => WavHeaderWishes.WriteWavHeader(binaries.DestFilePath, entities.BuffBound.AudioFileOutput), ForDestFilePath);
            AssertSetter(() => WavHeaderWishes.WriteWavHeader(binaries.DestBytes,    entities.BuffBound.AudioFileOutput), ForDestBytes   );
            AssertSetter(() => WavHeaderWishes.WriteWavHeader(binaries.DestStream,   entities.BuffBound.AudioFileOutput), ForDestStream  );
            AssertSetter(() => WavHeaderWishes.WriteWavHeader(binaries.BinaryWriter, entities.BuffBound.AudioFileOutput), ForBinaryWriter);
