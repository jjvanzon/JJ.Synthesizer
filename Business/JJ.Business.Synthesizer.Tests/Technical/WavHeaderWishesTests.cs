...
namespace JJ.Business.Synthesizer.Tests.Technical
{
    ...
    public class WavHeaderWishesTests
    {
        ...
        { 
            ...
            Assert(x.SynthBound.ConfigSection       .ToWish(),                 DefaultCase);
        ...
        { 
            ...
            //TestProp(x => { WavHeaderWishes.FromWish(x.SynthBound .ConfigResolver , info, synthWishes)      ; Assert(x.SynthBound .ConfigResolver,  test, synthWishes); });
            ...
            //TestProp(x => { WavHeaderWishes.ApplyTo(info, x.SynthBound .ConfigResolver, synthWishes)        ; Assert(x.SynthBound .ConfigResolver,  test, synthWishes); });
