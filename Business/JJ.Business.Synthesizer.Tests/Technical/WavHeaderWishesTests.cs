...
namespace JJ.Business.Synthesizer.Tests.Technical
{
    ...
    public class WavHeaderWishesTests
    {
        ...
        public void WavHeader_WriteWavHeader(string caseKey)
        {
            ...
            //AssertSetter(() => WavHeaderWishes.WriteWavHeader(entities.SynthBound.ConfigResolver,   binaries.DestFilePath, synthWishes), ForDestFilePath);
            //AssertSetter(() => WavHeaderWishes.WriteWavHeader(entities.SynthBound.ConfigResolver,   binaries.DestBytes,    synthWishes), ForDestBytes   );
            //AssertSetter(() => WavHeaderWishes.WriteWavHeader(entities.SynthBound.ConfigResolver,   binaries.DestStream,   synthWishes), ForDestStream  );
            //AssertSetter(() => WavHeaderWishes.WriteWavHeader(entities.SynthBound.ConfigResolver,   binaries.BinaryWriter, synthWishes), ForBinaryWriter);
            ...
            //AssertSetter(() => WavHeaderWishes.WriteWavHeader(binaries.DestFilePath, entities.SynthBound.ConfigResolver,   synthWishes), ForDestFilePath);
            //AssertSetter(() => WavHeaderWishes.WriteWavHeader(binaries.DestBytes,    entities.SynthBound.ConfigResolver,   synthWishes), ForDestBytes   );
            //AssertSetter(() => WavHeaderWishes.WriteWavHeader(binaries.DestStream,   entities.SynthBound.ConfigResolver,   synthWishes), ForDestStream  );
            //AssertSetter(() => WavHeaderWishes.WriteWavHeader(binaries.BinaryWriter, entities.SynthBound.ConfigResolver,   synthWishes), ForBinaryWriter);
