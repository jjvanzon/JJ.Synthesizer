...
namespace JJ.Business.Synthesizer.Tests.Technical
{
    ...
    public class WavHeaderWishesTests
    {
        ...
        { 
            ...
            TestProp((x, y) => { y.SourceFilePath.ReadWavHeader(x.SynthBound.FlowNode         )                   ; Assert(x.SynthBound.FlowNode,       test); });
            TestProp((x, y) => { y.SourceBytes   .ReadWavHeader(x.SynthBound.FlowNode         )                   ; Assert(x.SynthBound.FlowNode,       test); });
            TestProp((x, y) => { y.SourceStream  .ReadWavHeader(x.SynthBound.FlowNode         )                   ; Assert(x.SynthBound.FlowNode,       test); });
            TestProp((x, y) => { y.BinaryReader  .ReadWavHeader(x.SynthBound.FlowNode         )                   ; Assert(x.SynthBound.FlowNode,       test); });
            TestProp((x, y) => { y.SourceFilePath.ReadWavHeader(x.SynthBound.ConfigResolver   , synthWishes)      ; Assert(x.SynthBound.ConfigResolver, test, synthWishes); });
            TestProp((x, y) => { y.SourceBytes   .ReadWavHeader(x.SynthBound.ConfigResolver   , synthWishes)      ; Assert(x.SynthBound.ConfigResolver, test, synthWishes); });
            TestProp((x, y) => { y.SourceStream  .ReadWavHeader(x.SynthBound.ConfigResolver   , synthWishes)      ; Assert(x.SynthBound.ConfigResolver, test, synthWishes); });
            TestProp((x, y) => { y.BinaryReader  .ReadWavHeader(x.SynthBound.ConfigResolver   , synthWishes)      ; Assert(x.SynthBound.ConfigResolver, test, synthWishes); });
            TestProp((x, y) => { y.SourceFilePath.ReadWavHeader(x.TapeBound.Tape              )                   ; Assert(x.TapeBound.Tape,            test); });
            TestProp((x, y) => { y.SourceBytes   .ReadWavHeader(x.TapeBound.Tape              )                   ; Assert(x.TapeBound.Tape,            test); });
            TestProp((x, y) => { y.SourceStream  .ReadWavHeader(x.TapeBound.Tape              )                   ; Assert(x.TapeBound.Tape,            test); });
            TestProp((x, y) => { y.BinaryReader  .ReadWavHeader(x.TapeBound.Tape              )                   ; Assert(x.TapeBound.Tape,            test); });
            TestProp((x, y) => { y.SourceFilePath.ReadWavHeader(x.TapeBound.TapeConfig        )                   ; Assert(x.TapeBound.TapeConfig,      test); });
            TestProp((x, y) => { y.SourceBytes   .ReadWavHeader(x.TapeBound.TapeConfig        )                   ; Assert(x.TapeBound.TapeConfig,      test); });
            TestProp((x, y) => { y.SourceStream  .ReadWavHeader(x.TapeBound.TapeConfig        )                   ; Assert(x.TapeBound.TapeConfig,      test); });
            TestProp((x, y) => { y.BinaryReader  .ReadWavHeader(x.TapeBound.TapeConfig        )                   ; Assert(x.TapeBound.TapeConfig,      test); });
            TestProp((x, y) => { y.SourceFilePath.ReadWavHeader(x.TapeBound.TapeActions       )                   ; Assert(x.TapeBound.TapeActions,     test); });
            TestProp((x, y) => { y.SourceBytes   .ReadWavHeader(x.TapeBound.TapeActions       )                   ; Assert(x.TapeBound.TapeActions,     test); });
            TestProp((x, y) => { y.SourceStream  .ReadWavHeader(x.TapeBound.TapeActions       )                   ; Assert(x.TapeBound.TapeActions,     test); });
            TestProp((x, y) => { y.BinaryReader  .ReadWavHeader(x.TapeBound.TapeActions       )                   ; Assert(x.TapeBound.TapeActions,     test); });
            TestProp((x, y) => { y.SourceFilePath.ReadWavHeader(x.TapeBound.TapeAction        )                   ; Assert(x.TapeBound.TapeAction,      test); });
            TestProp((x, y) => { y.SourceBytes   .ReadWavHeader(x.TapeBound.TapeAction        )                   ; Assert(x.TapeBound.TapeAction,      test); });
            TestProp((x, y) => { y.SourceStream  .ReadWavHeader(x.TapeBound.TapeAction        )                   ; Assert(x.TapeBound.TapeAction,      test); });
            TestProp((x, y) => { y.BinaryReader  .ReadWavHeader(x.TapeBound.TapeAction        )                   ; Assert(x.TapeBound.TapeAction,      test); });
            TestProp((x, y) => { y.SourceFilePath.ReadWavHeader(x.BuffBound.Buff              , courtesy, context); Assert(x.BuffBound.Buff,            test); });
            TestProp((x, y) => { y.SourceBytes   .ReadWavHeader(x.BuffBound.Buff              , courtesy, context); Assert(x.BuffBound.Buff,            test); });
            TestProp((x, y) => { y.SourceStream  .ReadWavHeader(x.BuffBound.Buff              , courtesy, context); Assert(x.BuffBound.Buff,            test); });
            TestProp((x, y) => { y.BinaryReader  .ReadWavHeader(x.BuffBound.Buff              , courtesy, context); Assert(x.BuffBound.Buff,            test); });
            TestProp((x, y) => { y.SourceFilePath.ReadWavHeader(x.BuffBound.AudioFileOutput   , courtesy, context); Assert(x.BuffBound.AudioFileOutput, test); });
            TestProp((x, y) => { y.SourceBytes   .ReadWavHeader(x.BuffBound.AudioFileOutput   , courtesy, context); Assert(x.BuffBound.AudioFileOutput, test); });
            TestProp((x, y) => { y.SourceStream  .ReadWavHeader(x.BuffBound.AudioFileOutput   , courtesy, context); Assert(x.BuffBound.AudioFileOutput, test); });
            TestProp((x, y) => { y.BinaryReader  .ReadWavHeader(x.BuffBound.AudioFileOutput   , courtesy, context); Assert(x.BuffBound.AudioFileOutput, test); });
            TestProp((x, y) => { y.SourceFilePath.ReadWavHeader(x.Independent.Sample          ,           context); Assert(x.Independent.Sample,        test); });
            TestProp((x, y) => { y.SourceBytes   .ReadWavHeader(x.Independent.Sample          ,           context); Assert(x.Independent.Sample,        test); });
            TestProp((x, y) => { y.SourceStream  .ReadWavHeader(x.Independent.Sample          ,           context); Assert(x.Independent.Sample,        test); });
            TestProp((x, y) => { y.BinaryReader  .ReadWavHeader(x.Independent.Sample          ,           context); Assert(x.Independent.Sample,        test); });
            TestProp((x, y) => { y.SourceFilePath.ReadWavHeader(x.Independent.AudioFileInfo   )                   ; Assert(x.Independent.AudioFileInfo, test); });
            TestProp((x, y) => { y.SourceBytes   .ReadWavHeader(x.Independent.AudioFileInfo   )                   ; Assert(x.Independent.AudioFileInfo, test); });
            TestProp((x, y) => { y.SourceStream  .ReadWavHeader(x.Independent.AudioFileInfo   )                   ; Assert(x.Independent.AudioFileInfo, test); });
            TestProp((x, y) => { y.BinaryReader  .ReadWavHeader(x.Independent.AudioFileInfo   )                   ; Assert(x.Independent.AudioFileInfo, test); });
            TestProp((x, y) => { y.SourceFilePath.ReadWavHeader(x.Independent.AudioInfoWish   )                   ; Assert(x.Independent.AudioInfoWish, test); });
            TestProp((x, y) => { y.SourceBytes   .ReadWavHeader(x.Independent.AudioInfoWish   )                   ; Assert(x.Independent.AudioInfoWish, test); });
            TestProp((x, y) => { y.SourceStream  .ReadWavHeader(x.Independent.AudioInfoWish   )                   ; Assert(x.Independent.AudioInfoWish, test); });
            TestProp((x, y) => { y.BinaryReader  .ReadWavHeader(x.Independent.AudioInfoWish   )                   ; Assert(x.Independent.AudioInfoWish, test); });
            TestProp((x, y) => { ReadWavHeader(x.SynthBound.SynthWishes     , y.SourceFilePath)                   ; Assert(x.SynthBound.SynthWishes,    test); });
            TestProp((x, y) => { ReadWavHeader(x.SynthBound.SynthWishes     , y.SourceBytes   )                   ; Assert(x.SynthBound.SynthWishes,    test); });
            TestProp((x, y) => { ReadWavHeader(x.SynthBound.SynthWishes     , y.SourceStream  )                   ; Assert(x.SynthBound.SynthWishes,    test); });
            TestProp((x, y) => { ReadWavHeader(x.SynthBound.SynthWishes     , y.BinaryReader  )                   ; Assert(x.SynthBound.SynthWishes,    test); });
            TestProp((x, y) => { ReadWavHeader(x.SynthBound.FlowNode        , y.SourceFilePath)                   ; Assert(x.SynthBound.FlowNode,       test); });
            TestProp((x, y) => { ReadWavHeader(x.SynthBound.FlowNode        , y.SourceBytes   )                   ; Assert(x.SynthBound.FlowNode,       test); });
            TestProp((x, y) => { ReadWavHeader(x.SynthBound.FlowNode        , y.SourceStream  )                   ; Assert(x.SynthBound.FlowNode,       test); });
            TestProp((x, y) => { ReadWavHeader(x.SynthBound.FlowNode        , y.BinaryReader  )                   ; Assert(x.SynthBound.FlowNode,       test); });
            //TestProp((x, y) => { ReadWavHeader(x.SynthBound.ConfigResolver  , y.SourceFilePath, synthWishes)      ; Assert(x.SynthBound.ConfigResolver, test, synthWishes); });
            //TestProp((x, y) => { ReadWavHeader(x.SynthBound.ConfigResolver  , y.SourceBytes   , synthWishes)      ; Assert(x.SynthBound.ConfigResolver, test, synthWishes); });
            //TestProp((x, y) => { ReadWavHeader(x.SynthBound.ConfigResolver  , y.SourceStream  , synthWishes)      ; Assert(x.SynthBound.ConfigResolver, test, synthWishes); });
            //TestProp((x, y) => { ReadWavHeader(x.SynthBound.ConfigResolver  , y.BinaryReader  , synthWishes)      ; Assert(x.SynthBound.ConfigResolver, test, synthWishes); });
            TestProp((x, y) => { ReadWavHeader(x.TapeBound.Tape             , y.SourceFilePath)                   ; Assert(x.TapeBound.Tape,            test); });
            TestProp((x, y) => { ReadWavHeader(x.TapeBound.Tape             , y.SourceBytes   )                   ; Assert(x.TapeBound.Tape,            test); });
            TestProp((x, y) => { ReadWavHeader(x.TapeBound.Tape             , y.SourceStream  )                   ; Assert(x.TapeBound.Tape,            test); });
            TestProp((x, y) => { ReadWavHeader(x.TapeBound.Tape             , y.BinaryReader  )                   ; Assert(x.TapeBound.Tape,            test); });
            TestProp((x, y) => { ReadWavHeader(x.TapeBound.TapeConfig       , y.SourceFilePath)                   ; Assert(x.TapeBound.TapeConfig,      test); });
            TestProp((x, y) => { ReadWavHeader(x.TapeBound.TapeConfig       , y.SourceBytes   )                   ; Assert(x.TapeBound.TapeConfig,      test); });
            TestProp((x, y) => { ReadWavHeader(x.TapeBound.TapeConfig       , y.SourceStream  )                   ; Assert(x.TapeBound.TapeConfig,      test); });
            TestProp((x, y) => { ReadWavHeader(x.TapeBound.TapeConfig       , y.BinaryReader  )                   ; Assert(x.TapeBound.TapeConfig,      test); });
            TestProp((x, y) => { ReadWavHeader(x.TapeBound.TapeActions      , y.SourceFilePath)                   ; Assert(x.TapeBound.TapeActions,     test); });
            TestProp((x, y) => { ReadWavHeader(x.TapeBound.TapeActions      , y.SourceBytes   )                   ; Assert(x.TapeBound.TapeActions,     test); });
            TestProp((x, y) => { ReadWavHeader(x.TapeBound.TapeActions      , y.SourceStream  )                   ; Assert(x.TapeBound.TapeActions,     test); });
            TestProp((x, y) => { ReadWavHeader(x.TapeBound.TapeActions      , y.BinaryReader  )                   ; Assert(x.TapeBound.TapeActions,     test); });
            TestProp((x, y) => { ReadWavHeader(x.TapeBound.TapeAction       , y.SourceFilePath)                   ; Assert(x.TapeBound.TapeAction,      test); });
            TestProp((x, y) => { ReadWavHeader(x.TapeBound.TapeAction       , y.SourceBytes   )                   ; Assert(x.TapeBound.TapeAction,      test); });
            TestProp((x, y) => { ReadWavHeader(x.TapeBound.TapeAction       , y.SourceStream  )                   ; Assert(x.TapeBound.TapeAction,      test); });
            TestProp((x, y) => { ReadWavHeader(x.TapeBound.TapeAction       , y.BinaryReader  )                   ; Assert(x.TapeBound.TapeAction,      test); });
            TestProp((x, y) => { ReadWavHeader(x.BuffBound.Buff             , y.SourceFilePath, courtesy, context); Assert(x.BuffBound.Buff,            test); });
            TestProp((x, y) => { ReadWavHeader(x.BuffBound.Buff             , y.SourceBytes   , courtesy, context); Assert(x.BuffBound.Buff,            test); });
            TestProp((x, y) => { ReadWavHeader(x.BuffBound.Buff             , y.SourceStream  , courtesy, context); Assert(x.BuffBound.Buff,            test); });
            TestProp((x, y) => { ReadWavHeader(x.BuffBound.Buff             , y.BinaryReader  , courtesy, context); Assert(x.BuffBound.Buff,            test); });
            TestProp((x, y) => { ReadWavHeader(x.BuffBound.AudioFileOutput  , y.SourceFilePath, courtesy, context); Assert(x.BuffBound.AudioFileOutput, test); });
            TestProp((x, y) => { ReadWavHeader(x.BuffBound.AudioFileOutput  , y.SourceBytes   , courtesy, context); Assert(x.BuffBound.AudioFileOutput, test); });
            TestProp((x, y) => { ReadWavHeader(x.BuffBound.AudioFileOutput  , y.SourceStream  , courtesy, context); Assert(x.BuffBound.AudioFileOutput, test); });
            TestProp((x, y) => { ReadWavHeader(x.BuffBound.AudioFileOutput  , y.BinaryReader  , courtesy, context); Assert(x.BuffBound.AudioFileOutput, test); });
            TestProp((x, y) => { ReadWavHeader(x.Independent.Sample         , y.SourceFilePath,           context); Assert(x.Independent.Sample,        test); });
            TestProp((x, y) => { ReadWavHeader(x.Independent.Sample         , y.SourceBytes   ,           context); Assert(x.Independent.Sample,        test); });
            TestProp((x, y) => { ReadWavHeader(x.Independent.Sample         , y.SourceStream  ,           context); Assert(x.Independent.Sample,        test); });
            TestProp((x, y) => { ReadWavHeader(x.Independent.Sample         , y.BinaryReader  ,           context); Assert(x.Independent.Sample,        test); });
            TestProp((x, y) => { ReadWavHeader(x.Independent.AudioFileInfo  , y.SourceFilePath)                   ; Assert(x.Independent.AudioFileInfo, test); });
            TestProp((x, y) => { ReadWavHeader(x.Independent.AudioFileInfo  , y.SourceBytes   )                   ; Assert(x.Independent.AudioFileInfo, test); });
            TestProp((x, y) => { ReadWavHeader(x.Independent.AudioFileInfo  , y.SourceStream  )                   ; Assert(x.Independent.AudioFileInfo, test); });
            TestProp((x, y) => { ReadWavHeader(x.Independent.AudioFileInfo  , y.BinaryReader  )                   ; Assert(x.Independent.AudioFileInfo, test); });
            TestProp((x, y) => { ReadWavHeader(x.Independent.AudioInfoWish  , y.SourceFilePath)                   ; Assert(x.Independent.AudioInfoWish, test); });
            TestProp((x, y) => { ReadWavHeader(x.Independent.AudioInfoWish  , y.SourceBytes   )                   ; Assert(x.Independent.AudioInfoWish, test); });
            TestProp((x, y) => { ReadWavHeader(x.Independent.AudioInfoWish  , y.SourceStream  )                   ; Assert(x.Independent.AudioInfoWish, test); });
            TestProp((x, y) => { ReadWavHeader(x.Independent.AudioInfoWish  , y.BinaryReader  )                   ; Assert(x.Independent.AudioInfoWish, test); });
            TestProp((x, y) => { ReadWavHeader(y.SourceFilePath, x.SynthBound.SynthWishes     )                   ; Assert(x.SynthBound.SynthWishes,    test); });
            TestProp((x, y) => { ReadWavHeader(y.SourceBytes   , x.SynthBound.SynthWishes     )                   ; Assert(x.SynthBound.SynthWishes,    test); });
            TestProp((x, y) => { ReadWavHeader(y.SourceStream  , x.SynthBound.SynthWishes     )                   ; Assert(x.SynthBound.SynthWishes,    test); });
            TestProp((x, y) => { ReadWavHeader(y.BinaryReader  , x.SynthBound.SynthWishes     )                   ; Assert(x.SynthBound.SynthWishes,    test); });
            TestProp((x, y) => { ReadWavHeader(y.SourceFilePath, x.SynthBound.FlowNode        )                   ; Assert(x.SynthBound.FlowNode,       test); });
            TestProp((x, y) => { ReadWavHeader(y.SourceBytes   , x.SynthBound.FlowNode        )                   ; Assert(x.SynthBound.FlowNode,       test); });
            TestProp((x, y) => { ReadWavHeader(y.SourceStream  , x.SynthBound.FlowNode        )                   ; Assert(x.SynthBound.FlowNode,       test); });
            TestProp((x, y) => { ReadWavHeader(y.BinaryReader  , x.SynthBound.FlowNode        )                   ; Assert(x.SynthBound.FlowNode,       test); });
            //TestProp((x, y) => { ReadWavHeader(y.SourceFilePath, x.SynthBound.ConfigResolver  , synthWishes)      ; Assert(x.SynthBound.ConfigResolver, test, synthWishes); });
            //TestProp((x, y) => { ReadWavHeader(y.SourceBytes   , x.SynthBound.ConfigResolver  , synthWishes)      ; Assert(x.SynthBound.ConfigResolver, test, synthWishes); });
            //TestProp((x, y) => { ReadWavHeader(y.SourceStream  , x.SynthBound.ConfigResolver  , synthWishes)      ; Assert(x.SynthBound.ConfigResolver, test, synthWishes); });
            //TestProp((x, y) => { ReadWavHeader(y.BinaryReader  , x.SynthBound.ConfigResolver  , synthWishes)      ; Assert(x.SynthBound.ConfigResolver, test, synthWishes); });
            TestProp((x, y) => { ReadWavHeader(y.SourceFilePath, x.TapeBound.Tape             )                   ; Assert(x.TapeBound.Tape,            test); });
            TestProp((x, y) => { ReadWavHeader(y.SourceBytes   , x.TapeBound.Tape             )                   ; Assert(x.TapeBound.Tape,            test); });
            TestProp((x, y) => { ReadWavHeader(y.SourceStream  , x.TapeBound.Tape             )                   ; Assert(x.TapeBound.Tape,            test); });
            TestProp((x, y) => { ReadWavHeader(y.BinaryReader  , x.TapeBound.Tape             )                   ; Assert(x.TapeBound.Tape,            test); });
            TestProp((x, y) => { ReadWavHeader(y.SourceFilePath, x.TapeBound.TapeConfig       )                   ; Assert(x.TapeBound.TapeConfig,      test); });
            TestProp((x, y) => { ReadWavHeader(y.SourceBytes   , x.TapeBound.TapeConfig       )                   ; Assert(x.TapeBound.TapeConfig,      test); });
            TestProp((x, y) => { ReadWavHeader(y.SourceStream  , x.TapeBound.TapeConfig       )                   ; Assert(x.TapeBound.TapeConfig,      test); });
            TestProp((x, y) => { ReadWavHeader(y.BinaryReader  , x.TapeBound.TapeConfig       )                   ; Assert(x.TapeBound.TapeConfig,      test); });
            TestProp((x, y) => { ReadWavHeader(y.SourceFilePath, x.TapeBound.TapeActions      )                   ; Assert(x.TapeBound.TapeActions,     test); });
            TestProp((x, y) => { ReadWavHeader(y.SourceBytes   , x.TapeBound.TapeActions      )                   ; Assert(x.TapeBound.TapeActions,     test); });
            TestProp((x, y) => { ReadWavHeader(y.SourceStream  , x.TapeBound.TapeActions      )                   ; Assert(x.TapeBound.TapeActions,     test); });
            TestProp((x, y) => { ReadWavHeader(y.BinaryReader  , x.TapeBound.TapeActions      )                   ; Assert(x.TapeBound.TapeActions,     test); });
            TestProp((x, y) => { ReadWavHeader(y.SourceFilePath, x.TapeBound.TapeAction       )                   ; Assert(x.TapeBound.TapeAction,      test); });
            TestProp((x, y) => { ReadWavHeader(y.SourceBytes   , x.TapeBound.TapeAction       )                   ; Assert(x.TapeBound.TapeAction,      test); });
            TestProp((x, y) => { ReadWavHeader(y.SourceStream  , x.TapeBound.TapeAction       )                   ; Assert(x.TapeBound.TapeAction,      test); });
            TestProp((x, y) => { ReadWavHeader(y.BinaryReader  , x.TapeBound.TapeAction       )                   ; Assert(x.TapeBound.TapeAction,      test); });
            TestProp((x, y) => { ReadWavHeader(y.SourceFilePath, x.BuffBound.Buff             , courtesy, context); Assert(x.BuffBound.Buff,            test); });
            TestProp((x, y) => { ReadWavHeader(y.SourceBytes   , x.BuffBound.Buff             , courtesy, context); Assert(x.BuffBound.Buff,            test); });
            TestProp((x, y) => { ReadWavHeader(y.SourceStream  , x.BuffBound.Buff             , courtesy, context); Assert(x.BuffBound.Buff,            test); });
            TestProp((x, y) => { ReadWavHeader(y.BinaryReader  , x.BuffBound.Buff             , courtesy, context); Assert(x.BuffBound.Buff,            test); });
            TestProp((x, y) => { ReadWavHeader(y.SourceFilePath, x.BuffBound.AudioFileOutput  , courtesy, context); Assert(x.BuffBound.AudioFileOutput, test); });
            TestProp((x, y) => { ReadWavHeader(y.SourceBytes   , x.BuffBound.AudioFileOutput  , courtesy, context); Assert(x.BuffBound.AudioFileOutput, test); });
            TestProp((x, y) => { ReadWavHeader(y.SourceStream  , x.BuffBound.AudioFileOutput  , courtesy, context); Assert(x.BuffBound.AudioFileOutput, test); });
            TestProp((x, y) => { ReadWavHeader(y.BinaryReader  , x.BuffBound.AudioFileOutput  , courtesy, context); Assert(x.BuffBound.AudioFileOutput, test); });
            TestProp((x, y) => { ReadWavHeader(y.SourceFilePath, x.Independent.Sample         ,           context); Assert(x.Independent.Sample,        test); });
            TestProp((x, y) => { ReadWavHeader(y.SourceBytes   , x.Independent.Sample         ,           context); Assert(x.Independent.Sample,        test); });
            TestProp((x, y) => { ReadWavHeader(y.SourceStream  , x.Independent.Sample         ,           context); Assert(x.Independent.Sample,        test); });
            TestProp((x, y) => { ReadWavHeader(y.BinaryReader  , x.Independent.Sample         ,           context); Assert(x.Independent.Sample,        test); });
            TestProp((x, y) => { ReadWavHeader(y.SourceFilePath, x.Independent.AudioFileInfo  )                   ; Assert(x.Independent.AudioFileInfo, test); });
            TestProp((x, y) => { ReadWavHeader(y.SourceBytes   , x.Independent.AudioFileInfo  )                   ; Assert(x.Independent.AudioFileInfo, test); });
            TestProp((x, y) => { ReadWavHeader(y.SourceStream  , x.Independent.AudioFileInfo  )                   ; Assert(x.Independent.AudioFileInfo, test); });
            TestProp((x, y) => { ReadWavHeader(y.BinaryReader  , x.Independent.AudioFileInfo  )                   ; Assert(x.Independent.AudioFileInfo, test); });
            TestProp((x, y) => { ReadWavHeader(y.SourceFilePath, x.Independent.AudioInfoWish  )                   ; Assert(x.Independent.AudioInfoWish, test); });
            TestProp((x, y) => { ReadWavHeader(y.SourceBytes   , x.Independent.AudioInfoWish  )                   ; Assert(x.Independent.AudioInfoWish, test); });
            TestProp((x, y) => { ReadWavHeader(y.SourceStream  , x.Independent.AudioInfoWish  )                   ; Assert(x.Independent.AudioInfoWish, test); });
            TestProp((x, y) => { ReadWavHeader(y.BinaryReader  , x.Independent.AudioInfoWish  )                   ; Assert(x.Independent.AudioInfoWish, test); });
