...
namespace JJ.Business.Synthesizer.Tests.Technical
{
    ...
    public class FrameworkWishesTests
    {
        ...
        [TestMethod]
        public void Test_FrameworkWishes_PrettyByteCount_1000Bytes_ShowsBytes()
            => AreEqual("1000 bytes", () => PrettyByteCount(1000));

        [TestMethod]
        public void Test_FrameworkWishes_PrettyByteCount_5kBMinus1_ShowsBytes()
            => AreEqual("5119 bytes", () => PrettyByteCount(5 * 1024 - 1));

        [TestMethod]
        public void Test_FrameworkWishes_PrettyByteCount_5kBPlus1_ShowskB()
        ...
        [TestMethod]
        public void Test_FrameworkWishes_PrettyByteCount_100kB_ShowskB()
            => AreEqual("100 kB", () => PrettyByteCount(100 * 1024));

        [TestMethod]
        public void Test_FrameworkWishes_PrettyByteCount_1000kB_ShowskB()
            => AreEqual("1000 kB", () => PrettyByteCount(1000 * 1024));

        [TestMethod]
        public void Test_FrameworkWishes_PrettyByteCount_5MBMinus1_ShowskB()
            => AreEqual("5120 kB", () => PrettyByteCount(5 * 1024 * 1024 - 1));

        [TestMethod]
        public void Test_FrameworkWishes_PrettyByteCount_5MBPlus1_ShowsMB()
            => AreEqual("5 MB", () => PrettyByteCount(5 * 1024 * 1024 + 1));

        [TestMethod]
        public void Test_FrameworkWishes_PrettyByteCount_100MB_ShowsMB()
            => AreEqual("100 MB", () => PrettyByteCount(100 * 1024 * 1024));

        [TestMethod]
        public void Test_FrameworkWishes_PrettyByteCount_1000MB_ShowsMB()
            => AreEqual("1000 MB", () => PrettyByteCount(1000 * 1024 * 1024));

        [TestMethod]
        public void Test_FrameworkWishes_PrettyByteCount_5GBMinus1_ShowsMB()
            => AreEqual("5120 MB", () => PrettyByteCount((long)5 * 1024 * 1024 * 1024 - 1));

        [TestMethod]
        public void Test_FrameworkWishes_PrettyByteCount_5GBPlus1_ShowsGB()
        ...
        [TestMethod]
        public void Test_FrameworkWishes_PrettyByteCount_100GB_ShowsGB()
            => AreEqual("100 GB", () => PrettyByteCount((long)100 * 1024 * 1024 * 1024));
        
        [TestMethod]
        public void Test_FrameworkWishes_PrettyByteCount_1000GB_ShowsGB()
