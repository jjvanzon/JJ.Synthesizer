...
namespace JJ.Business.Synthesizer.Tests.Technical
{
    ...
    public class WavWishesTests : SynthWishes
    {
        ...
        {
            var testEntities = new TestEntities(withDisk, x => x.DontLogCats(LogCats.SynthLog, LogCats.TapeTree, LogCats.Math)
        ...
        {
            var testEntities = new TestEntities(withDisk, x => x.DontLogCats("SynthLog", "TapeTree", "Math")
        ...
        public void WriteWavHeader_Test_Extensions_EntityThenStreamy(string caseKey)
        {
            ...
            AssertWrite(bin => AreEqual(x.BuffBound.AudioFileOutput, () => x.BuffBound.AudioFileOutput  .WriteWavHeader(bin.BinaryWriter              )), ForBinaryWriter, test);
        ...
        public void WriteWavHeader_Test_Extensions_StreamyThenEntity(string caseKey)
        {
            ...
            AssertWrite(bin => AreEqual(bin.BinaryWriter           , () => bin.BinaryWriter.WriteWavHeader(x.BuffBound.AudioFileOutput                )), ForBinaryWriter, test);
        ...
        public void WriteWavHeader_Test_ShortStatic_EntityThenStreamy(string caseKey)
        {
            ...
            AssertWrite(bin => AreEqual(x.BuffBound.AudioFileOutput, () => WriteWavHeader(x.BuffBound.AudioFileOutput,   bin.BinaryWriter             )), ForBinaryWriter, test);
        ...
        public void WriteWavHeader_Test_ShortStatic_StreamyThenEntity(string caseKey)
        {
            ...
            AssertWrite(bin => AreEqual(bin.BinaryWriter,            () => WriteWavHeader(bin.BinaryWriter, x.BuffBound.AudioFileOutput               )), ForBinaryWriter, test);
        ...
        public void WriteWavHeader_Test_LongStatic_EntityThenStreamy(string caseKey)
        {
            ...
            AssertWrite(bin => AreEqual(x.BuffBound.AudioFileOutput, () => WavWishes.WriteWavHeader(x.BuffBound.AudioFileOutput,   bin.BinaryWriter)), ForBinaryWriter, test);
        ...
        public void WriteWavHeader_Test_LongStatic_StreamyThenEntity(string caseKey)
        {
            ...
            AssertWrite(bin => AreEqual(bin.BinaryWriter,            () => WavWishes.WriteWavHeader(bin.BinaryWriter, x.BuffBound.AudioFileOutput  )), ForBinaryWriter, test);
        ...
        [TestMethod]
        [DynamicData(nameof(InvariantCases))]
        public void WriteWavHeader_Test_WithTypeArguments(string caseKey)
        {
            Case test = Cases[caseKey];
            int frameCount = test.FrameCount;
        ...
        /// <inheritdoc cref="_areequalint />
        private static void AreEqualInt(int expected, int actual, int delta) => AreEqual(expected, actual, delta);
        ///// <inheritdoc cref="_areequalint />
        //private static void AreEqualInt(int expected, int actual) => AreEqual(expected, actual);
