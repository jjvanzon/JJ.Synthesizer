    ...
    public class WavWishesTests
    {
        ...
        public void ReadWavHeader_Test(string caseKey)
        {
            ...
            using (TestEntities modifiedEntities = CreateModifiedEntities(test, withDisk: true))
            {
                ...
                TestProp(x => { AreEqual(x.BuffBound.Buff             , () => x.BuffBound.Buff             .ReadWavHeader(binaries.SourceFilePath    , courtesy, context)); AssertEntity(x.BuffBound.Buff,            test); });
                TestProp(x => { AreEqual(x.BuffBound.Buff             , () => x.BuffBound.Buff             .ReadWavHeader(binaries.SourceBytes       , courtesy, context)); AssertEntity(x.BuffBound.Buff,            test); });
                TestProp(x => { AreEqual(x.BuffBound.Buff             , () => x.BuffBound.Buff             .ReadWavHeader(binaries.SourceStream      , courtesy, context)); AssertEntity(x.BuffBound.Buff,            test); });
                TestProp(x => { AreEqual(x.BuffBound.Buff             , () => x.BuffBound.Buff             .ReadWavHeader(binaries.BinaryReader      , courtesy, context)); AssertEntity(x.BuffBound.Buff,            test); });
                TestProp(x => { AreEqual(x.BuffBound.AudioFileOutput  , () => x.BuffBound.AudioFileOutput  .ReadWavHeader(binaries.SourceFilePath    , courtesy, context)); AssertEntity(x.BuffBound.AudioFileOutput, test); });
                TestProp(x => { AreEqual(x.BuffBound.AudioFileOutput  , () => x.BuffBound.AudioFileOutput  .ReadWavHeader(binaries.SourceBytes       , courtesy, context)); AssertEntity(x.BuffBound.AudioFileOutput, test); });
                TestProp(x => { AreEqual(x.BuffBound.AudioFileOutput  , () => x.BuffBound.AudioFileOutput  .ReadWavHeader(binaries.SourceStream      , courtesy, context)); AssertEntity(x.BuffBound.AudioFileOutput, test); });
                TestProp(x => { AreEqual(x.BuffBound.AudioFileOutput  , () => x.BuffBound.AudioFileOutput  .ReadWavHeader(binaries.BinaryReader      , courtesy, context)); AssertEntity(x.BuffBound.AudioFileOutput, test); });
                ...
                TestProp(x => { AreEqual(binaries.SourceFilePath      , () => binaries.SourceFilePath      .ReadWavHeader(x.BuffBound.Buff           , courtesy, context)); AssertEntity(x.BuffBound.Buff,            test); });
                TestProp(x => { AreEqual(binaries.SourceBytes         , () => binaries.SourceBytes         .ReadWavHeader(x.BuffBound.Buff           , courtesy, context)); AssertEntity(x.BuffBound.Buff,            test); });
                TestProp(x => { AreEqual(binaries.SourceStream        , () => binaries.SourceStream        .ReadWavHeader(x.BuffBound.Buff           , courtesy, context)); AssertEntity(x.BuffBound.Buff,            test); });
                TestProp(x => { AreEqual(binaries.BinaryReader        , () => binaries.BinaryReader        .ReadWavHeader(x.BuffBound.Buff           , courtesy, context)); AssertEntity(x.BuffBound.Buff,            test); });
                TestProp(x => { AreEqual(binaries.SourceFilePath      , () => binaries.SourceFilePath      .ReadWavHeader(x.BuffBound.AudioFileOutput, courtesy, context)); AssertEntity(x.BuffBound.AudioFileOutput, test); });
                TestProp(x => { AreEqual(binaries.SourceBytes         , () => binaries.SourceBytes         .ReadWavHeader(x.BuffBound.AudioFileOutput, courtesy, context)); AssertEntity(x.BuffBound.AudioFileOutput, test); });
                TestProp(x => { AreEqual(binaries.SourceStream        , () => binaries.SourceStream        .ReadWavHeader(x.BuffBound.AudioFileOutput, courtesy, context)); AssertEntity(x.BuffBound.AudioFileOutput, test); });
                TestProp(x => { AreEqual(binaries.BinaryReader        , () => binaries.BinaryReader        .ReadWavHeader(x.BuffBound.AudioFileOutput, courtesy, context)); AssertEntity(x.BuffBound.AudioFileOutput, test); });
                ...
                TestProp(x => { AreEqual(x.BuffBound.Buff,              () => ReadWavHeader(x.BuffBound.Buff,             binaries.SourceFilePath    , courtesy, context)); AssertEntity(x.BuffBound.Buff,            test); });
                TestProp(x => { AreEqual(x.BuffBound.Buff,              () => ReadWavHeader(x.BuffBound.Buff,             binaries.SourceBytes       , courtesy, context)); AssertEntity(x.BuffBound.Buff,            test); });
                TestProp(x => { AreEqual(x.BuffBound.Buff,              () => ReadWavHeader(x.BuffBound.Buff,             binaries.SourceStream      , courtesy, context)); AssertEntity(x.BuffBound.Buff,            test); });
                TestProp(x => { AreEqual(x.BuffBound.Buff,              () => ReadWavHeader(x.BuffBound.Buff,             binaries.BinaryReader      , courtesy, context)); AssertEntity(x.BuffBound.Buff,            test); });
                TestProp(x => { AreEqual(x.BuffBound.AudioFileOutput,   () => ReadWavHeader(x.BuffBound.AudioFileOutput,  binaries.SourceFilePath    , courtesy, context)); AssertEntity(x.BuffBound.AudioFileOutput, test); });
                TestProp(x => { AreEqual(x.BuffBound.AudioFileOutput,   () => ReadWavHeader(x.BuffBound.AudioFileOutput,  binaries.SourceBytes       , courtesy, context)); AssertEntity(x.BuffBound.AudioFileOutput, test); });
                TestProp(x => { AreEqual(x.BuffBound.AudioFileOutput,   () => ReadWavHeader(x.BuffBound.AudioFileOutput,  binaries.SourceStream      , courtesy, context)); AssertEntity(x.BuffBound.AudioFileOutput, test); });
                TestProp(x => { AreEqual(x.BuffBound.AudioFileOutput,   () => ReadWavHeader(x.BuffBound.AudioFileOutput,  binaries.BinaryReader      , courtesy, context)); AssertEntity(x.BuffBound.AudioFileOutput, test); });
                ...
                TestProp(x => { AreEqual(binaries.SourceFilePath,       () => ReadWavHeader(binaries.SourceFilePath,      x.BuffBound.Buff           , courtesy, context)); AssertEntity(x.BuffBound.Buff,            test); });
                TestProp(x => { AreEqual(binaries.SourceBytes,          () => ReadWavHeader(binaries.SourceBytes,         x.BuffBound.Buff           , courtesy, context)); AssertEntity(x.BuffBound.Buff,            test); });
                TestProp(x => { AreEqual(binaries.SourceStream,         () => ReadWavHeader(binaries.SourceStream,        x.BuffBound.Buff           , courtesy, context)); AssertEntity(x.BuffBound.Buff,            test); });
                TestProp(x => { AreEqual(binaries.BinaryReader,         () => ReadWavHeader(binaries.BinaryReader,        x.BuffBound.Buff           , courtesy, context)); AssertEntity(x.BuffBound.Buff,            test); });
                TestProp(x => { AreEqual(binaries.SourceFilePath,       () => ReadWavHeader(binaries.SourceFilePath,      x.BuffBound.AudioFileOutput, courtesy, context)); AssertEntity(x.BuffBound.AudioFileOutput, test); });
                TestProp(x => { AreEqual(binaries.SourceBytes,          () => ReadWavHeader(binaries.SourceBytes,         x.BuffBound.AudioFileOutput, courtesy, context)); AssertEntity(x.BuffBound.AudioFileOutput, test); });
                TestProp(x => { AreEqual(binaries.SourceStream,         () => ReadWavHeader(binaries.SourceStream,        x.BuffBound.AudioFileOutput, courtesy, context)); AssertEntity(x.BuffBound.AudioFileOutput, test); });
                TestProp(x => { AreEqual(binaries.BinaryReader,         () => ReadWavHeader(binaries.BinaryReader,        x.BuffBound.AudioFileOutput, courtesy, context)); AssertEntity(x.BuffBound.AudioFileOutput, test); });
                ...
                TestProp(x => { AreEqual(x.BuffBound.Buff,              () => WavWishes.ReadWavHeader(x.BuffBound.Buff,              binaries.SourceFilePath    , courtesy, context)); AssertEntity(x.BuffBound.Buff,            test); });
                TestProp(x => { AreEqual(x.BuffBound.Buff,              () => WavWishes.ReadWavHeader(x.BuffBound.Buff,              binaries.SourceBytes       , courtesy, context)); AssertEntity(x.BuffBound.Buff,            test); });
                TestProp(x => { AreEqual(x.BuffBound.Buff,              () => WavWishes.ReadWavHeader(x.BuffBound.Buff,              binaries.SourceStream      , courtesy, context)); AssertEntity(x.BuffBound.Buff,            test); });
                TestProp(x => { AreEqual(x.BuffBound.Buff,              () => WavWishes.ReadWavHeader(x.BuffBound.Buff,              binaries.BinaryReader      , courtesy, context)); AssertEntity(x.BuffBound.Buff,            test); });
                TestProp(x => { AreEqual(x.BuffBound.AudioFileOutput,   () => WavWishes.ReadWavHeader(x.BuffBound.AudioFileOutput,   binaries.SourceFilePath    , courtesy, context)); AssertEntity(x.BuffBound.AudioFileOutput, test); });
                TestProp(x => { AreEqual(x.BuffBound.AudioFileOutput,   () => WavWishes.ReadWavHeader(x.BuffBound.AudioFileOutput,   binaries.SourceBytes       , courtesy, context)); AssertEntity(x.BuffBound.AudioFileOutput, test); });
                TestProp(x => { AreEqual(x.BuffBound.AudioFileOutput,   () => WavWishes.ReadWavHeader(x.BuffBound.AudioFileOutput,   binaries.SourceStream      , courtesy, context)); AssertEntity(x.BuffBound.AudioFileOutput, test); });
                TestProp(x => { AreEqual(x.BuffBound.AudioFileOutput,   () => WavWishes.ReadWavHeader(x.BuffBound.AudioFileOutput,   binaries.BinaryReader      , courtesy, context)); AssertEntity(x.BuffBound.AudioFileOutput, test); });
                ...
                TestProp(x => { AreEqual(binaries.SourceFilePath,       () => WavWishes.ReadWavHeader(binaries.SourceFilePath,       x.BuffBound.Buff           , courtesy, context)); AssertEntity(x.BuffBound.Buff,            test); });
                TestProp(x => { AreEqual(binaries.SourceBytes,          () => WavWishes.ReadWavHeader(binaries.SourceBytes,          x.BuffBound.Buff           , courtesy, context)); AssertEntity(x.BuffBound.Buff,            test); });
                TestProp(x => { AreEqual(binaries.SourceStream,         () => WavWishes.ReadWavHeader(binaries.SourceStream,         x.BuffBound.Buff           , courtesy, context)); AssertEntity(x.BuffBound.Buff,            test); });
                TestProp(x => { AreEqual(binaries.BinaryReader,         () => WavWishes.ReadWavHeader(binaries.BinaryReader,         x.BuffBound.Buff           , courtesy, context)); AssertEntity(x.BuffBound.Buff,            test); });
                TestProp(x => { AreEqual(binaries.SourceFilePath,       () => WavWishes.ReadWavHeader(binaries.SourceFilePath,       x.BuffBound.AudioFileOutput, courtesy, context)); AssertEntity(x.BuffBound.AudioFileOutput, test); });
                TestProp(x => { AreEqual(binaries.SourceBytes,          () => WavWishes.ReadWavHeader(binaries.SourceBytes,          x.BuffBound.AudioFileOutput, courtesy, context)); AssertEntity(x.BuffBound.AudioFileOutput, test); });
                TestProp(x => { AreEqual(binaries.SourceStream,         () => WavWishes.ReadWavHeader(binaries.SourceStream,         x.BuffBound.AudioFileOutput, courtesy, context)); AssertEntity(x.BuffBound.AudioFileOutput, test); });
                TestProp(x => { AreEqual(binaries.BinaryReader,         () => WavWishes.ReadWavHeader(binaries.BinaryReader,         x.BuffBound.AudioFileOutput, courtesy, context)); AssertEntity(x.BuffBound.AudioFileOutput, test); });
        ...
        public void WriteWavHeader_Test(string caseKey)
        {
            ...
            AssertWrite(bin => AreEqual(x.BuffBound.Buff           , () => x.BuffBound.Buff             .WriteWavHeader(bin.DestFilePath,     courtesy)), ForDestFilePath, test);
            AssertWrite(bin => AreEqual(x.BuffBound.Buff           , () => x.BuffBound.Buff             .WriteWavHeader(bin.DestBytes,        courtesy)), ForDestBytes,    test);
            AssertWrite(bin => AreEqual(x.BuffBound.Buff           , () => x.BuffBound.Buff             .WriteWavHeader(bin.DestStream,       courtesy)), ForDestStream,   test);
            AssertWrite(bin => AreEqual(x.BuffBound.Buff           , () => x.BuffBound.Buff             .WriteWavHeader(bin.BinaryWriter,     courtesy)), ForBinaryWriter, test);
            AssertWrite(bin => AreEqual(x.BuffBound.AudioFileOutput, () => x.BuffBound.AudioFileOutput  .WriteWavHeader(bin.DestFilePath,     courtesy)), ForDestFilePath, test);
            AssertWrite(bin => AreEqual(x.BuffBound.AudioFileOutput, () => x.BuffBound.AudioFileOutput  .WriteWavHeader(bin.DestBytes,        courtesy)), ForDestBytes,    test);
            AssertWrite(bin => AreEqual(x.BuffBound.AudioFileOutput, () => x.BuffBound.AudioFileOutput  .WriteWavHeader(bin.DestStream,       courtesy)), ForDestStream,   test);
            AssertWrite(bin => AreEqual(x.BuffBound.AudioFileOutput, () => x.BuffBound.AudioFileOutput  .WriteWavHeader(bin.BinaryWriter,     courtesy)), ForBinaryWriter, test); // By Design: explicit FrameCount() call omitted; would fall between two internal WriteWavHeader calls.
            ...
            AssertWrite(bin => AreEqual(bin.DestFilePath           , () => bin.DestFilePath.WriteWavHeader(x.BuffBound.Buff,                  courtesy)), ForDestFilePath, test);
            AssertWrite(bin => AreEqual(bin.DestBytes              , () => bin.DestBytes   .WriteWavHeader(x.BuffBound.Buff,                  courtesy)), ForDestBytes,    test);
            AssertWrite(bin => AreEqual(bin.DestStream             , () => bin.DestStream  .WriteWavHeader(x.BuffBound.Buff,                  courtesy)), ForDestStream,   test);
            AssertWrite(bin => AreEqual(bin.BinaryWriter           , () => bin.BinaryWriter.WriteWavHeader(x.BuffBound.Buff,                  courtesy)), ForBinaryWriter, test);
            AssertWrite(bin => AreEqual(bin.DestFilePath           , () => bin.DestFilePath.WriteWavHeader(x.BuffBound.AudioFileOutput,       courtesy)), ForDestFilePath, test);
            AssertWrite(bin => AreEqual(bin.DestBytes              , () => bin.DestBytes   .WriteWavHeader(x.BuffBound.AudioFileOutput,       courtesy)), ForDestBytes,    test);
            AssertWrite(bin => AreEqual(bin.DestStream             , () => bin.DestStream  .WriteWavHeader(x.BuffBound.AudioFileOutput,       courtesy)), ForDestStream,   test);
            AssertWrite(bin => AreEqual(bin.BinaryWriter           , () => bin.BinaryWriter.WriteWavHeader(x.BuffBound.AudioFileOutput,       courtesy)), ForBinaryWriter, test); // By Design: explicit FrameCount() call omitted; would fall between two internal WriteWavHeader calls.
            ...
            AssertWrite(bin => AreEqual(x.BuffBound.Buff,            () => WriteWavHeader(x.BuffBound.Buff,              bin.DestFilePath,    courtesy)), ForDestFilePath, test);
            AssertWrite(bin => AreEqual(x.BuffBound.Buff,            () => WriteWavHeader(x.BuffBound.Buff,              bin.DestBytes,       courtesy)), ForDestBytes,    test);
            AssertWrite(bin => AreEqual(x.BuffBound.Buff,            () => WriteWavHeader(x.BuffBound.Buff,              bin.DestStream,      courtesy)), ForDestStream,   test);
            AssertWrite(bin => AreEqual(x.BuffBound.Buff,            () => WriteWavHeader(x.BuffBound.Buff,              bin.BinaryWriter,    courtesy)), ForBinaryWriter, test);
            AssertWrite(bin => AreEqual(x.BuffBound.AudioFileOutput, () => WriteWavHeader(x.BuffBound.AudioFileOutput,   bin.DestFilePath,    courtesy)), ForDestFilePath, test);
            AssertWrite(bin => AreEqual(x.BuffBound.AudioFileOutput, () => WriteWavHeader(x.BuffBound.AudioFileOutput,   bin.DestBytes,       courtesy)), ForDestBytes,    test);
            AssertWrite(bin => AreEqual(x.BuffBound.AudioFileOutput, () => WriteWavHeader(x.BuffBound.AudioFileOutput,   bin.DestStream,      courtesy)), ForDestStream,   test);
            AssertWrite(bin => AreEqual(x.BuffBound.AudioFileOutput, () => WriteWavHeader(x.BuffBound.AudioFileOutput,   bin.BinaryWriter,    courtesy)), ForBinaryWriter, test); // By Design: explicit FrameCount() call omitted; would fall between two internal WriteWavHeader calls.
            ...
            AssertWrite(bin => AreEqual(bin.DestFilePath,            () => WriteWavHeader(bin.DestFilePath, x.BuffBound.Buff,                 courtesy)), ForDestFilePath, test);
            AssertWrite(bin => AreEqual(bin.DestBytes,               () => WriteWavHeader(bin.DestBytes,    x.BuffBound.Buff,                 courtesy)), ForDestBytes,    test);
            AssertWrite(bin => AreEqual(bin.DestStream,              () => WriteWavHeader(bin.DestStream,   x.BuffBound.Buff,                 courtesy)), ForDestStream,   test);
            AssertWrite(bin => AreEqual(bin.BinaryWriter,            () => WriteWavHeader(bin.BinaryWriter, x.BuffBound.Buff,                 courtesy)), ForBinaryWriter, test);
            AssertWrite(bin => AreEqual(bin.DestFilePath,            () => WriteWavHeader(bin.DestFilePath, x.BuffBound.AudioFileOutput,      courtesy)), ForDestFilePath, test);
            AssertWrite(bin => AreEqual(bin.DestBytes,               () => WriteWavHeader(bin.DestBytes,    x.BuffBound.AudioFileOutput,      courtesy)), ForDestBytes,    test);
            AssertWrite(bin => AreEqual(bin.DestStream,              () => WriteWavHeader(bin.DestStream,   x.BuffBound.AudioFileOutput,      courtesy)), ForDestStream,   test);
            AssertWrite(bin => AreEqual(bin.BinaryWriter,            () => WriteWavHeader(bin.BinaryWriter, x.BuffBound.AudioFileOutput,      courtesy)), ForBinaryWriter, test); // By Design: explicit FrameCount() call omitted; would fall between two internal WriteWavHeader calls.
            ...
            AssertWrite(bin => AreEqual(x.BuffBound.Buff,            () => WavWishes.WriteWavHeader(x.BuffBound.Buff,              bin.DestFilePath,    courtesy)), ForDestFilePath, test);
            AssertWrite(bin => AreEqual(x.BuffBound.Buff,            () => WavWishes.WriteWavHeader(x.BuffBound.Buff,              bin.DestBytes,       courtesy)), ForDestBytes,    test);
            AssertWrite(bin => AreEqual(x.BuffBound.Buff,            () => WavWishes.WriteWavHeader(x.BuffBound.Buff,              bin.DestStream,      courtesy)), ForDestStream,   test);
            AssertWrite(bin => AreEqual(x.BuffBound.Buff,            () => WavWishes.WriteWavHeader(x.BuffBound.Buff,              bin.BinaryWriter,    courtesy)), ForBinaryWriter, test);
            AssertWrite(bin => AreEqual(x.BuffBound.AudioFileOutput, () => WavWishes.WriteWavHeader(x.BuffBound.AudioFileOutput,   bin.DestFilePath,    courtesy)), ForDestFilePath, test);
            AssertWrite(bin => AreEqual(x.BuffBound.AudioFileOutput, () => WavWishes.WriteWavHeader(x.BuffBound.AudioFileOutput,   bin.DestBytes,       courtesy)), ForDestBytes,    test);
            AssertWrite(bin => AreEqual(x.BuffBound.AudioFileOutput, () => WavWishes.WriteWavHeader(x.BuffBound.AudioFileOutput,   bin.DestStream,      courtesy)), ForDestStream,   test);
            AssertWrite(bin => AreEqual(x.BuffBound.AudioFileOutput, () => WavWishes.WriteWavHeader(x.BuffBound.AudioFileOutput,   bin.BinaryWriter,    courtesy)), ForBinaryWriter, test); // By Design: explicit FrameCount() call omitted; would fall between two internal WriteWavHeader calls.
            ...
            AssertWrite(bin => AreEqual(bin.DestFilePath,            () => WavWishes.WriteWavHeader(bin.DestFilePath, x.BuffBound.Buff,                 courtesy)), ForDestFilePath, test);
            AssertWrite(bin => AreEqual(bin.DestBytes,               () => WavWishes.WriteWavHeader(bin.DestBytes,    x.BuffBound.Buff,                 courtesy)), ForDestBytes,    test);
            AssertWrite(bin => AreEqual(bin.DestStream,              () => WavWishes.WriteWavHeader(bin.DestStream,   x.BuffBound.Buff,                 courtesy)), ForDestStream,   test);
            AssertWrite(bin => AreEqual(bin.BinaryWriter,            () => WavWishes.WriteWavHeader(bin.BinaryWriter, x.BuffBound.Buff,                 courtesy)), ForBinaryWriter, test);
            AssertWrite(bin => AreEqual(bin.DestFilePath,            () => WavWishes.WriteWavHeader(bin.DestFilePath, x.BuffBound.AudioFileOutput,      courtesy)), ForDestFilePath, test);
            AssertWrite(bin => AreEqual(bin.DestBytes,               () => WavWishes.WriteWavHeader(bin.DestBytes,    x.BuffBound.AudioFileOutput,      courtesy)), ForDestBytes,    test);
            AssertWrite(bin => AreEqual(bin.DestStream,              () => WavWishes.WriteWavHeader(bin.DestStream,   x.BuffBound.AudioFileOutput,      courtesy)), ForDestStream,   test);
            AssertWrite(bin => AreEqual(bin.BinaryWriter,            () => WavWishes.WriteWavHeader(bin.BinaryWriter, x.BuffBound.AudioFileOutput,      courtesy)), ForBinaryWriter, test); // By Design: explicit FrameCount() call omitted; would fall between two internal WriteWavHeader calls.
