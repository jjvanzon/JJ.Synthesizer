...
{
    private static ConfigWishesHelperAccessor _accessor = new(typeof(ConfigWishes));
    private static AccessorCore _accessorCore = new(typeof(ConfigWishes));

    // AudioFormat

    //internal static bool IsWav(ConfigResolverAccessor obj) => (bool)_accessorCore.Call(obj.Obj);
    ...
    public static int? ByteCount   (ConfigSectionAccessor obj) => (int?)_accessor.Call(obj.Obj);
    public static int? GetByteCount(ConfigSectionAccessor obj) => (int?)_accessor.Call(obj.Obj);
    ...
    public static ConfigResolverAccessor AnyChannel      (ConfigResolverAccessor obj) => _accessor.Call(obj);
    public static ConfigResolverAccessor EveryChannel    (ConfigResolverAccessor obj) => _accessor.Call(obj);
    ...
    public static ConfigResolverAccessor WithAnyChannel  (ConfigResolverAccessor obj) => _accessor.Call(obj);
    public static ConfigResolverAccessor WithEveryChannel(ConfigResolverAccessor obj) => _accessor.Call(obj);
    public static ConfigResolverAccessor WithNoChannel   (ConfigResolverAccessor obj) => _accessor.Call(obj);
    ...
    public static ConfigResolverAccessor AsAnyChannel    (ConfigResolverAccessor obj) => _accessor.Call(obj);
    public static ConfigResolverAccessor AsEveryChannel  (ConfigResolverAccessor obj) => _accessor.Call(obj);
    public static ConfigResolverAccessor AsNoChannel     (ConfigResolverAccessor obj) => _accessor.Call(obj);
    ...
    public static ConfigResolverAccessor SetAnyChannel   (ConfigResolverAccessor obj) => _accessor.Call(obj);
    public static ConfigResolverAccessor SetEveryChannel (ConfigResolverAccessor obj) => _accessor.Call(obj);
    ...
    public static bool IsMono     (ConfigSectionAccessor obj) => (bool)_accessor.Call(obj.Obj);
    public static bool IsStereo   (ConfigSectionAccessor obj) => (bool)_accessor.Call(obj.Obj);
    public static int? Channels   (ConfigSectionAccessor obj) => (int?)_accessor.Call(obj.Obj);
    public static int? GetChannels(ConfigSectionAccessor obj) => (int?)_accessor.Call(obj.Obj);
    ...
    public static int  FrameSize   (ConfigResolverAccessor obj) => _accessor.GetInt(obj);
    public static int  GetFrameSize(ConfigResolverAccessor obj) => _accessor.GetInt(obj);
    public static int? FrameSize   (ConfigSectionAccessor obj) => _accessor.GetNullyInt(obj);
    public static int? GetFrameSize(ConfigSectionAccessor obj) => _accessor.GetNullyInt(obj);
    ...
    public static bool IsLinear(ConfigSectionAccessor obj) => (bool)_accessor.Call(obj.Obj);
    public static bool IsBlocky(ConfigSectionAccessor obj) => (bool)_accessor.Call(obj.Obj);
