...
namespace JJ.Business.Synthesizer.Tests.Accessors
{
    ...
    internal static class BitExtensionWishesAccessor
    {
        ...
        public static int Bits(this ConfigResolverAccessor obj) => (int)_accessor.InvokeMethod(MemberName(), obj.UnderlyingObject);
        public static ConfigResolverAccessor Bits(this ConfigResolverAccessor obj, int? value) => new ConfigResolverAccessor(_accessor.InvokeMethod(MemberName(), new[]{ obj.UnderlyingObject, value }, new[]{ null, typeof(int?) }));
        public static bool Is8Bit(this ConfigResolverAccessor obj) => (bool)_accessor.InvokeMethod(MemberName(), obj.UnderlyingObject);
        public static bool Is16Bit(this ConfigResolverAccessor obj) => (bool)_accessor.InvokeMethod(MemberName(), obj.UnderlyingObject);
        public static bool Is32Bit(this ConfigResolverAccessor obj) => (bool)_accessor.InvokeMethod(MemberName(), obj.UnderlyingObject);
    ...
    internal static class ChannelsExtensionWishesAccessor
    {
        ...
        public static int Channels(this ConfigResolverAccessor obj) => (int)_accessor.InvokeMethod(MemberName(), obj.UnderlyingObject);
        public static ConfigResolverAccessor Channels(this ConfigResolverAccessor obj, int? value) => new ConfigResolverAccessor(_accessor.InvokeMethod(MemberName(), new[]{ obj.UnderlyingObject, value }, new[]{ null, typeof(int?) }));
        public static bool IsMono(this ConfigResolverAccessor obj) => (bool)_accessor.InvokeMethod(MemberName(), obj.UnderlyingObject);
        public static bool IsStereo(this ConfigResolverAccessor obj) => (bool)_accessor.InvokeMethod(MemberName(), obj.UnderlyingObject);
        public static ConfigResolverAccessor Mono(this ConfigResolverAccessor obj) => new ConfigResolverAccessor(_accessor.InvokeMethod(MemberName(), obj.UnderlyingObject));
        public static ConfigResolverAccessor Stereo(this ConfigResolverAccessor obj) => new ConfigResolverAccessor(_accessor.InvokeMethod(MemberName(), obj.UnderlyingObject));
    ...
    internal static class ChannelExtensionWishesAccessor
    {
        ...
        public static int? Channel(this ConfigResolverAccessor obj) => (int?)_accessor.InvokeMethod(MemberName(), obj.UnderlyingObject);
        public static ConfigResolverAccessor Channel(this ConfigResolverAccessor obj, int? value) => new ConfigResolverAccessor(_accessor.InvokeMethod(MemberName(), new[]{ obj.UnderlyingObject, value }, new[]{ null, typeof(int?) }));
        public static bool IsCenter(this ConfigResolverAccessor obj) => (bool)_accessor.InvokeMethod(MemberName(), obj.UnderlyingObject);
        public static bool IsLeft(this ConfigResolverAccessor obj) => (bool)_accessor.InvokeMethod(MemberName(), obj.UnderlyingObject);
        public static bool IsRight(this ConfigResolverAccessor obj) => (bool)_accessor.InvokeMethod(MemberName(), obj.UnderlyingObject);
        public static ConfigResolverAccessor Center(this ConfigResolverAccessor obj) => new ConfigResolverAccessor(_accessor.InvokeMethod(MemberName(), obj.UnderlyingObject));
        public static ConfigResolverAccessor Left(this ConfigResolverAccessor obj) => new ConfigResolverAccessor(_accessor.InvokeMethod(MemberName(), obj.UnderlyingObject));
        public static ConfigResolverAccessor Right(this ConfigResolverAccessor obj) => new ConfigResolverAccessor(_accessor.InvokeMethod(MemberName(), obj.UnderlyingObject));
        public static ConfigResolverAccessor NoChannel(this ConfigResolverAccessor obj) => new ConfigResolverAccessor(_accessor.InvokeMethod(MemberName(), obj.UnderlyingObject));
    }   
    ...
    internal static class AudioFormatExtensionWishesAccessor
    {
        ...
        public static AudioFileFormatEnum AudioFormat(this ConfigResolverAccessor obj) => (AudioFileFormatEnum)_accessor.InvokeMethod(MemberName(), obj.UnderlyingObject);
        
        public static ConfigResolverAccessor AudioFormat(this ConfigResolverAccessor obj, AudioFileFormatEnum? value) 
            => new ConfigResolverAccessor(_accessor.InvokeMethod(MemberName(), new[]{ obj?.UnderlyingObject, value }, new[]{ null, typeof(AudioFileFormatEnum?) }));
        
        public static bool IsRaw(this ConfigResolverAccessor obj) => (bool)_accessor.InvokeMethod(MemberName(), obj.UnderlyingObject);
        public static bool IsWav(this ConfigResolverAccessor obj) => (bool)_accessor.InvokeMethod(MemberName(), obj.UnderlyingObject);
    ...
    internal static class InterpolationExtensionWishesAccessor
    {
        ...
        public static ConfigResolverAccessor Blocky(this ConfigResolverAccessor obj) =>  new ConfigResolverAccessor(_accessor.InvokeMethod(MemberName(), obj.UnderlyingObject));
    ...
    internal static class CourtesyFrameExtensionWishesAccessor
    {
        ...
        public static int CourtesyFrames(this ConfigResolverAccessor obj) => (int)_accessor.InvokeMethod(MemberName(), obj.UnderlyingObject);
        public static ConfigResolverAccessor CourtesyFrames(this ConfigResolverAccessor obj, int? value) => new ConfigResolverAccessor(_accessor.InvokeMethod(MemberName(), new[]{ obj.UnderlyingObject, value }, new[]{ null, typeof(int?) }));
    ...
    internal static class FrameSizeExtensionWishesAccessor
    {
        ...
        internal static int  FrameSize(this ConfigResolverAccessor  obj)  => (int)_accessor.InvokeMethod(MemberName(), obj.UnderlyingObject);
    ...
    internal static class CourtesyByteExtensionWishesAccessor
    {
        ...
        public static int CourtesyBytes(this ConfigResolverAccessor obj) => (int)_accessor.InvokeMethod(MemberName(), obj.UnderlyingObject);
        public static ConfigResolverAccessor CourtesyBytes(this ConfigResolverAccessor obj, int? value) => new ConfigResolverAccessor(_accessor.InvokeMethod(MemberName(), obj.UnderlyingObject, value));
    ...
    internal static class FileExtensionWishesAccessor
    {
        ...
        internal static string FileExtension(this ConfigResolverAccessor obj) => (string)_accessor.InvokeMethod(MemberName(), obj.UnderlyingObject);
    ...
    internal static class HeaderLengthExtensionWishesAccessor
    {
        ...
        public static int? HeaderLength(this ConfigResolverAccessor obj) => (int?)_accessor.InvokeMethod(MemberName(), obj.UnderlyingObject);
    ...
    internal static class MaxAmplitudeExtensionWishesAccessor
    {
        ...
        public static double MaxAmplitude(this ConfigResolverAccessor obj) => (double)_accessor.InvokeMethod(MemberName(), obj.UnderlyingObject);
    ...
    internal static class ByteCountExtensionWishesAccessor
    {
        ...
        public static int ByteCount(this ConfigResolverAccessor obj, SynthWishes synthWishes) 
            => (int)_accessor.InvokeMethod(MemberName(), obj.UnderlyingObject, synthWishes);
