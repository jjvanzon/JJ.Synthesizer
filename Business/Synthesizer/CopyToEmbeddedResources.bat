...
xcopy "CopiedCode\FromFramework\Geometry.cs" "EmbeddedResources\" /R /K /Y
xcopy "CopiedCode\FromFramework\Interpolator.cs" "EmbeddedResources\" /R /K /Y
xcopy "CopiedCode\FromFramework\MathHelper.cs" "EmbeddedResources\" /R /K /Y
