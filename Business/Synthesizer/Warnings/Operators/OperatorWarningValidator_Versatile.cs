...
namespace JJ.Business.Synthesizer.Warnings.Operators
{
    internal class OperatorWarningValidator_Versatile : ValidatorBase<Operator>
    {
            ...
            new Dictionary<OperatorTypeEnum, Type>
        {
            ...
            { OperatorTypeEnum.InletsToDimension, typeof(InletsToDimension_OperatorWarningValidator) },
            ...
            { OperatorTypeEnum.RangeOverDimension, typeof(RangeOverDimension_OperatorWarningValidator) },
            { OperatorTypeEnum.RangeOverOutlets, typeof(RangeOverOutlets_OperatorWarningValidator) },
        ...
        { 
            ...
            {
                ExecuteValidator(new OperatorWarningValidator_Base(obj));
            }
            else
            {
