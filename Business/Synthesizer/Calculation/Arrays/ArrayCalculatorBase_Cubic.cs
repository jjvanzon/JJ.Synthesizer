...
namespace JJ.Business.Synthesizer.Calculation.Arrays
{
    internal abstract class ArrayCalculatorBase_Cubic : ArrayCalculatorBase
    {
        ...
        public override InterpolationTypeEnum InterpolationTypeEnum => InterpolationTypeEnum.Cubic;
        ...
        public double Calculate(double x)
        {
            ...
            double y = Interpolator.Interpolate_Cubic_Equidistant(yMinus1, y0, y1, y2, offset);
            return y;
        }
    }
}