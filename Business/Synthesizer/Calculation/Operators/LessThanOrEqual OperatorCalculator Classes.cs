...
{
    internal class LessThanOrEqual_OperatorCalculator_VarA_VarB : OperatorCalculatorBase_WithChildCalculators
    {
        private readonly OperatorCalculatorBase _calculatorA;
        private readonly OperatorCalculatorBase _calculatorB;

        public LessThanOrEqual_OperatorCalculator_VarA_VarB(
    ...
    internal class LessThanOrEqual_OperatorCalculator_VarA_ConstB : OperatorCalculatorBase_WithChildCalculators
    {
        private readonly OperatorCalculatorBase _calculatorA;
        private readonly double _b;

        public LessThanOrEqual_OperatorCalculator_VarA_ConstB(OperatorCalculatorBase calculatorA, double b)
    ...
    internal class LessThanOrEqual_OperatorCalculator_ConstA_VarB : OperatorCalculatorBase_WithChildCalculators
    {
        private readonly double _a;
        private readonly OperatorCalculatorBase _calculatorB;

        public LessThanOrEqual_OperatorCalculator_ConstA_VarB(double a, OperatorCalculatorBase calculatorB)
