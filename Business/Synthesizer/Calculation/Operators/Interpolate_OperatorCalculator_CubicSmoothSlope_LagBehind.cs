...
{
    internal class Interpolate_OperatorCalculator_CubicSmoothSlope_LagBehind : OperatorCalculatorBase_WithChildCalculators
    {
        ...
        public Interpolate_OperatorCalculator_CubicSmoothSlope_LagBehind(
