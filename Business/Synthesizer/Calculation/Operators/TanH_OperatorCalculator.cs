...
{
    internal class TanH_OperatorCalculator : OperatorCalculatorBase_WithChildCalculators
    {
        private readonly OperatorCalculatorBase _radiansCalculator;

        public TanH_OperatorCalculator(OperatorCalculatorBase radiansCalculator)
