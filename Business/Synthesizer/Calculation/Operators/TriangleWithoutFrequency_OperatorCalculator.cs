...
namespace JJ.Business.Synthesizer.Calculation.Operators
{
	internal class TriangleWithRate1_OperatorCalculator : OperatorCalculatorBase
	{
		...
		public TriangleWithRate1_OperatorCalculator(OperatorCalculatorBase positionCalculator) => _positionCalculator = positionCalculator ?? throw new ArgumentNullException(nameof(positionCalculator));
