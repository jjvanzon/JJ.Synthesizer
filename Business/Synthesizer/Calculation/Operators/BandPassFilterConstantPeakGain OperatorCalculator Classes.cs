...
namespace JJ.Business.Synthesizer.Calculation.Operators
{
        ...
        : OperatorCalculatorBase_WithChildCalculators
    {
        ...
        private void SetFilterVariables()
        {
            ...
            _biQuadFilter.SetBandPassFilterConstantPeakGainVariables(_targetSamplingRate, centerFrequency, bandWidth);
        }
    }
        ...
        : OperatorCalculatorBase_WithChildCalculators
    {
        ...
        private void ResetNonRecursive()
        {
            _biQuadFilter.SetBandPassFilterConstantPeakGainVariables(_targetSamplingRate, _centerFrequency, _bandWidth);
            _biQuadFilter.ResetSamples();
        }
    }
}