...
namespace JJ.Business.Synthesizer.Calculation.Operators
{
    ...
    internal class MinOverInlets_OperatorCalculator_SoundVarOrConst_OtherInputsVar : OperatorCalculatorBase_WithChildCalculators
    {
        ...
        public MinOverInlets_OperatorCalculator_SoundVarOrConst_OtherInputsVar(IList<OperatorCalculatorBase> operandCalculators)
            : base(operandCalculators)
        {
