...
{
    internal class OperatorEntityThruDtoToCalculatorVisitor
    {
        ...
        public OperatorEntityThruDtoToCalculatorVisitor(
        ...
        public ToCalculatorResult Execute(Outlet topLevelOutlet)
        {
            ...
            var visitor2 = new OperatorDtoVisitor_PreProcessing(_targetChannelCount);
            dto = visitor2.Execute(dto);
