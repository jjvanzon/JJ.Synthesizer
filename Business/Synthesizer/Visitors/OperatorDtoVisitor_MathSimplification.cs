...
namespace JJ.Business.Synthesizer.Visitors
{
    ...
    internal class OperatorDtoVisitor_MathSimplification : OperatorDtoVisitor_ClassSpecializationBase
    {
        private delegate void SetFilterParametersWithWidthOrBlobVolumeDelegate(
            double samplingRate,
            double limitedFrequency,
            double widthOrBlobVolume,
            out double a0,
            out double a1,
            out double a2,
            out double a3,
        ...
        protected override IOperatorDto Visit_AllPassFilter_OperatorDto_SoundVarOrConst_OtherInputsConst(
            ...
            => Process_Filter_SoundVarOrConst_OtherInputsConst_WithWidthOrBlobVolume(dto, BiQuadFilterWithoutFields.SetAllPassFilterVariables);
        ...
        protected override IOperatorDto Visit_BandPassFilterConstantPeakGain_OperatorDto_SoundVarOrConst_OtherInputsConst(
            ...
            => Process_Filter_SoundVarOrConst_OtherInputsConst_WithWidthOrBlobVolume(
                dto,
        ...
        protected override IOperatorDto Visit_DimensionToOutlets_Outlet_OperatorDto(DimensionToOutlets_Outlet_OperatorDto dto)
            => ProcessIdentity(dto.OutletPosition);
        ...
        protected override IOperatorDto Visit_HighPassFilter_OperatorDto_SoundVarOrConst_OtherInputsConst(
            ...
            => Process_Filter_SoundVarOrConst_OtherInputsConst_WithWidthOrBlobVolume(dto, BiQuadFilterWithoutFields.SetHighPassFilterVariables);
        ...
        protected override IOperatorDto Visit_HighShelfFilter_OperatorDto_SoundVarOrConst_OtherInputsConst(
            ...
            => Process_ShelfFilter_SoundVarOrConst_OtherInputsConst(dto, BiQuadFilterWithoutFields.SetHighShelfFilterVariables);
        ...
        {
            if (dto.Number.IsConst && dto.Base.IsConst)
            {
                // Precalculate
                return new Number_OperatorDto { Number = Math.Log(dto.Number.Const, dto.Base.Const) };
            }
        ...
        protected override IOperatorDto Visit_LowPassFilter_OperatorDto_SoundVarOrConst_OtherInputsConst(
            ...
            => Process_Filter_SoundVarOrConst_OtherInputsConst_WithWidthOrBlobVolume(dto, BiQuadFilterWithoutFields.SetLowPassFilterVariables);
        ...
        protected override IOperatorDto Visit_NotchFilter_OperatorDto_SoundVarOrConst_OtherInputsConst(
            ...
            => Process_Filter_SoundVarOrConst_OtherInputsConst_WithWidthOrBlobVolume(dto, BiQuadFilterWithoutFields.SetNotchFilterVariables);
        ...
        protected override IOperatorDto Visit_SumFollower_OperatorDto_ConstSignal_ConstSampleCount(
            SumFollower_OperatorDto_ConstSignal_ConstSampleCount dto)
        {
        ...
        protected override IOperatorDto Visit_SumFollower_OperatorDto_ConstSignal_VarSampleCount(
            SumFollower_OperatorDto_ConstSignal_VarSampleCount dto)
        {
        ...
        protected override IOperatorDto Visit_SumOverDimension_OperatorDto_AllConsts(SumOverDimension_OperatorDto_AllConsts dto)
        {
            ...
            // Pre-calculate
            var sampleCount = (int)(dto.Till - dto.From / dto.Step);
        ...
        protected override IOperatorDto Visit_Xor_OperatorDto(Xor_OperatorDto dto)
        {
            ...
            {
                // Precalculate
                return new Number_OperatorDto { Number = dto.A.IsConstNonZero ^ dto.B.IsConstNonZero ? 1 : 0 };
            }
