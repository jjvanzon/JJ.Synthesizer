...
namespace JJ.Business.Synthesizer.Visitors
{
	internal abstract class OperatorDtoToCalculatorVisitorBase : OperatorDtoVisitorBase_AfterDtoPreprocessing
	{
		...
		protected override IOperatorDto Visit_Add_OperatorDto(Add_OperatorDto dto) => ProcessOperatorDto(dto, () => new Add_OperatorCalculator(dto.Inputs.Select(x => _stack.Pop()).ToArray()));
	    ...
	    protected override IOperatorDto Visit_AverageOverInlets_OperatorDto(AverageOverInlets_OperatorDto dto) => ProcessOperatorDto(dto, () => new AverageOverInlets_OperatorCalculator(dto.Inputs.Select(x => _stack.Pop()).ToArray()));
	    ...
	    protected override IOperatorDto Visit_ChangeTrigger_OperatorDto(ChangeTrigger_OperatorDto dto) => ProcessOperatorDto(dto, () => new ChangeTrigger_OperatorCalculator(_stack.Pop(), _stack.Pop()));
	    ...
	    protected override IOperatorDto Visit_ClosestOverInlets_OperatorDto(ClosestOverInlets_OperatorDto dto) => ProcessOperatorDto(
	        dto,
	        () => new ClosestOverInlets_OperatorCalculator(_stack.Pop(), dto.Items.Select(x => _stack.Pop()).ToArray()));

	    protected override IOperatorDto Visit_ClosestOverInletsExp_OperatorDto(ClosestOverInletsExp_OperatorDto dto) => ProcessOperatorDto(
	        dto,
		...
		private IOperatorDto ProcessCurveOperator(Curve_OperatorDto dto) => ProcessOperatorDto(
		    dto,
		    () => OperatorCalculatorFactory.Create_Curve_OperatorCalculator(_stack.Pop(), dto.ArrayDto, dto.StandardDimensionEnum));

	    protected override IOperatorDto Visit_Divide_OperatorDto(Divide_OperatorDto dto) => ProcessOperatorDto(dto, () => new Divide_OperatorCalculator(_stack.Pop(), _stack.Pop()));

	    protected override IOperatorDto Visit_Equal_OperatorDto(Equal_OperatorDto dto) => ProcessOperatorDto(dto, () => new Equal_OperatorCalculator(_stack.Pop(), _stack.Pop()));

	    protected override IOperatorDto Visit_GreaterThanOrEqual_OperatorDto(GreaterThanOrEqual_OperatorDto dto) => ProcessOperatorDto(dto, () => new GreaterThanOrEqual_OperatorCalculator(_stack.Pop(), _stack.Pop()));

	    protected override IOperatorDto Visit_GreaterThan_OperatorDto(GreaterThan_OperatorDto dto) => ProcessOperatorDto(dto, () => new GreaterThan_OperatorCalculator(_stack.Pop(), _stack.Pop()));
	    ...
	    protected override IOperatorDto Visit_Hold_OperatorDto(Hold_OperatorDto dto) => ProcessOperatorDto(dto, () => new Hold_OperatorCalculator(_stack.Pop()));

	    protected override IOperatorDto Visit_If_OperatorDto(If_OperatorDto dto) => ProcessOperatorDto(dto, () => new If_OperatorCalculator(_stack.Pop(), _stack.Pop(), _stack.Pop()));

	    protected override IOperatorDto Visit_InletsToDimension_OperatorDto_Block(InletsToDimension_OperatorDto_Block dto) => ProcessOperatorDto(
	        dto,
	        () => new InletsToDimension_OperatorCalculator_Block(dto.InputsExceptPosition.Select(x => _stack.Pop()).ToArray(), _stack.Pop()));

	    protected override IOperatorDto Visit_InletsToDimension_OperatorDto_Stripe_LagBehind(InletsToDimension_OperatorDto_Stripe_LagBehind dto) => ProcessOperatorDto(
	        dto,
	        () => new InletsToDimension_OperatorCalculator_Stripe(dto.InputsExceptPosition.Select(x => _stack.Pop()).ToArray(), _stack.Pop()));

	    protected override IOperatorDto Visit_Interpolate_OperatorDto_Block(Interpolate_OperatorDto_Block dto) => ProcessOperatorDto(
	        dto,
	        () => new Interpolate_OperatorCalculator_Block(_stack.Pop(), _stack.Pop(), _stack.Pop()));

	    protected override IOperatorDto Visit_Interpolate_OperatorDto_Cubic_LagBehind(Interpolate_OperatorDto_Cubic_LagBehind dto) => ProcessOperatorDto(
	        dto,
	        () => new Interpolate_OperatorCalculator_Cubic_LagBehind(_stack.Pop(), _stack.Pop(), _stack.Pop()));

	    protected override IOperatorDto Visit_Interpolate_OperatorDto_Cubic_LookAhead(Interpolate_OperatorDto_Cubic_LookAhead dto) => ProcessOperatorDto(
	        dto,
	        () => new Interpolate_OperatorCalculator_Cubic_LookAhead(_stack.Pop(), _stack.Pop(), _stack.Pop(), GetPositionOutputCalculator(dto)));

	    protected override IOperatorDto Visit_Interpolate_OperatorDto_Hermite_LagBehind(Interpolate_OperatorDto_Hermite_LagBehind dto) => ProcessOperatorDto(
	        dto,
	        () => new Interpolate_OperatorCalculator_Hermite_LagBehind(_stack.Pop(), _stack.Pop(), _stack.Pop()));

	    protected override IOperatorDto Visit_Interpolate_OperatorDto_Hermite_LookAhead(Interpolate_OperatorDto_Hermite_LookAhead dto) => ProcessOperatorDto(
	        dto,
	        () => new Interpolate_OperatorCalculator_Hermite_LookAhead(_stack.Pop(), _stack.Pop(), _stack.Pop(), GetPositionOutputCalculator(dto)));

	    protected override IOperatorDto Visit_Interpolate_OperatorDto_Line_LagBehind(Interpolate_OperatorDto_Line_LagBehind dto) => ProcessOperatorDto(
	        dto,
	        () => new Interpolate_OperatorCalculator_Line_LagBehind(_stack.Pop(), _stack.Pop(), _stack.Pop()));

	    protected override IOperatorDto Visit_Interpolate_OperatorDto_Line_LookAhead(Interpolate_OperatorDto_Line_LookAhead dto) => ProcessOperatorDto(
	        dto,
	        () => new Interpolate_OperatorCalculator_Line_LookAhead(_stack.Pop(), _stack.Pop(), _stack.Pop(), GetPositionOutputCalculator(dto)));

	    protected override IOperatorDto Visit_Interpolate_OperatorDto_Stripe_LagBehind(Interpolate_OperatorDto_Stripe_LagBehind dto) => ProcessOperatorDto(
	        dto,
	        () => new Interpolate_OperatorCalculator_Stripe_LagBehind(_stack.Pop(), _stack.Pop(), _stack.Pop()));

	    protected override IOperatorDto Visit_Interpolate_OperatorDto_Stripe_LookAhead(Interpolate_OperatorDto_Stripe_LookAhead dto) => ProcessOperatorDto(
	        dto,
	        () => new Interpolate_OperatorCalculator_Stripe_LookAhead(_stack.Pop(), _stack.Pop(), _stack.Pop(), GetPositionOutputCalculator(dto)));

	    protected override IOperatorDto Visit_LessThanOrEqual_OperatorDto(LessThanOrEqual_OperatorDto dto) => ProcessOperatorDto(dto, () => new LessThanOrEqual_OperatorCalculator(_stack.Pop(), _stack.Pop()));

	    protected override IOperatorDto Visit_LessThan_OperatorDto(LessThan_OperatorDto dto) => ProcessOperatorDto(dto, () => new LessThan_OperatorCalculator(_stack.Pop(), _stack.Pop()));

	    protected override IOperatorDto Visit_Loop_OperatorDto(Loop_OperatorDto dto) => ProcessOperatorDto(
	        dto,
	        () =>
	        {
	    ...
	    protected override IOperatorDto Visit_MinOverInlets_OperatorDto(MinOverInlets_OperatorDto dto) => ProcessOperatorDto(dto, () => new MinOverInlets_OperatorCalculator(dto.Inputs.Select(x => _stack.Pop()).ToArray()));

	    protected override IOperatorDto Visit_Multiply_OperatorDto(Multiply_OperatorDto dto) => ProcessOperatorDto(dto, () => new Multiply_OperatorCalculator(dto.Inputs.Select(x => _stack.Pop()).ToArray()));

	    protected override IOperatorDto Visit_Negative_OperatorDto(Negative_OperatorDto dto) => ProcessOperatorDto(dto, () => new Negative_OperatorCalculator(_stack.Pop()));

	    protected override IOperatorDto Visit_Noise_OperatorDto(Noise_OperatorDto dto) => ProcessOperatorDto(
	        dto,
	        () =>
	        {
	    ...
	    protected override IOperatorDto Visit_NotEqual_OperatorDto(NotEqual_OperatorDto dto) => ProcessOperatorDto(dto, () => new NotEqual_OperatorCalculator(_stack.Pop(), _stack.Pop()));

	    protected override IOperatorDto Visit_Not_OperatorDto(Not_OperatorDto dto) => ProcessOperatorDto(dto, () => new Not_OperatorCalculator(_stack.Pop()));

	    protected override IOperatorDto Visit_Number_OperatorDto(Number_OperatorDto dto) => ProcessOperatorDto(dto, () => new Number_OperatorCalculator(dto.Number));

	    protected override IOperatorDto Visit_Or_OperatorDto(Or_OperatorDto dto) => ProcessOperatorDto(dto, () => new Or_OperatorCalculator(_stack.Pop(), _stack.Pop()));
	    ...
	    protected override IOperatorDto Visit_Power_OperatorDto(Power_OperatorDto dto) => ProcessOperatorDto(dto, () => new Power_OperatorCalculator(_stack.Pop(), _stack.Pop()));

	    protected override IOperatorDto Visit_PulseTrigger_OperatorDto(PulseTrigger_OperatorDto dto) => ProcessOperatorDto(dto, () => new PulseTrigger_OperatorCalculator(_stack.Pop(), _stack.Pop()));

	    protected override IOperatorDto Visit_Random_OperatorDto_Block(Random_OperatorDto_Block dto) => ProcessOperatorDto(
	        dto,
	        () =>
	        {
	    ...
	    protected override IOperatorDto Visit_Random_OperatorDto_Stripe_LagBehind(Random_OperatorDto_Stripe_LagBehind dto) => ProcessOperatorDto(
	        dto,
	        () =>
	        {
	    ...
	    protected override IOperatorDto Visit_RangeOverDimension_OperatorDto_OnlyConsts(RangeOverDimension_OperatorDto_OnlyConsts dto) => ProcessOperatorDto(dto, () => new RangeOverDimension_OperatorCalculator(_stack.Pop(), _stack.Pop(), _stack.Pop(), _stack.Pop()));

	    protected override IOperatorDto Visit_RangeOverDimension_OperatorDto_OnlyVars(RangeOverDimension_OperatorDto_OnlyVars dto) => ProcessOperatorDto(dto, () => new RangeOverDimension_OperatorCalculator(_stack.Pop(), _stack.Pop(), _stack.Pop(), _stack.Pop()));
	    ...
	    protected override IOperatorDto Visit_Remainder_OperatorDto(Remainder_OperatorDto dto) => ProcessOperatorDto(dto, () => new Remainder_OperatorCalculator(_stack.Pop(), _stack.Pop()));

	    protected override IOperatorDto Visit_Reset_OperatorDto(Reset_OperatorDto dto) => ProcessOperatorDto(
	        dto,
	        () =>
	        {
	    ...
	    protected override IOperatorDto Visit_Round_OperatorDto_StepOne_ZeroOffset(Round_OperatorDto_StepOne_ZeroOffset dto) => ProcessOperatorDto(dto, () => new Round_OperatorCalculator(_stack.Pop(), _stack.Pop(), _stack.Pop()));

	    protected override IOperatorDto Visit_Round_OperatorDto_WithOffset(Round_OperatorDto_WithOffset dto) => ProcessOperatorDto(dto, () => new Round_OperatorCalculator(_stack.Pop(), _stack.Pop(), _stack.Pop()));

	    protected override IOperatorDto Visit_Round_OperatorDto_ZeroOffset(Round_OperatorDto_ZeroOffset dto) => ProcessOperatorDto(dto, () => new Round_OperatorCalculator(_stack.Pop(), _stack.Pop(), _stack.Pop()));

	    protected override IOperatorDto Visit_SampleWithRate1_OperatorDto_MonoToStereo(SampleWithRate1_OperatorDto_MonoToStereo dto) => ProcessOperatorDto(
	        dto,
	        () =>
	        {
	    ...
	    protected override IOperatorDto Visit_SampleWithRate1_OperatorDto_NoChannelConversion(SampleWithRate1_OperatorDto_NoChannelConversion dto) => ProcessOperatorDto(
	        dto,
	        () =>
	        {
	    ...
	    protected override IOperatorDto Visit_SampleWithRate1_OperatorDto_StereoToMono(SampleWithRate1_OperatorDto_StereoToMono dto) => ProcessOperatorDto(
	        dto,
	        () =>
	        {
	            IList<ICalculatorWithPosition> underlyingCalculators = dto.ArrayDtos.Select(ArrayCalculatorFactory.CreateArrayCalculator).ToArray();
	    ...
	    protected override IOperatorDto Visit_SineWithRate1_OperatorDto(SineWithRate1_OperatorDto dto) => ProcessOperatorDto(dto, () => new SineWithRate1_OperatorCalculator(_stack.Pop()));
	    ...
	    protected override IOperatorDto Visit_SortOverInlets_Outlet_OperatorDto(SortOverInlets_Outlet_OperatorDto dto) => ProcessOperatorDto(dto, () => new SortOverInlets_OperatorCalculator(dto.Inputs.Select(x => _stack.Pop()).ToArray(), _stack.Pop()));

	    protected override IOperatorDto Visit_Spectrum_OperatorDto(Spectrum_OperatorDto dto) => ProcessOperatorDto(
	        dto,
	    ...
	    protected override IOperatorDto Visit_Squash_OperatorDto_WithOrigin(Squash_OperatorDto_WithOrigin dto) => ProcessOperatorDto(
	        dto,
	        () =>
	        {
	            OperatorCalculatorBase signalCalculator = _stack.Pop();
	    ...
	    protected override IOperatorDto Visit_Squash_OperatorDto_ZeroOrigin(Squash_OperatorDto_ZeroOrigin dto) => ProcessOperatorDto(
	        dto,
	        () =>
	        {
	            OperatorCalculatorBase signalCalculator = _stack.Pop();
	    ...
	    protected override IOperatorDto Visit_Squash_OperatorDto_VarFactor_WithPhaseTracking(Squash_OperatorDto_VarFactor_WithPhaseTracking dto) => ProcessOperatorDto(
	        dto,
	        () =>
	        {
	            OperatorCalculatorBase signalCalculator = _stack.Pop();
	    ...
	    protected override IOperatorDto Visit_ToggleTrigger_OperatorDto(ToggleTrigger_OperatorDto dto) => ProcessOperatorDto(dto, () => new ToggleTrigger_OperatorCalculator(_stack.Pop(), _stack.Pop()));

	    protected override IOperatorDto Visit_TriangleWithRate1_OperatorDto(TriangleWithRate1_OperatorDto dto) => ProcessOperatorDto(dto, () => new TriangleWithRate1_OperatorCalculator(_stack.Pop()));

	    protected override IOperatorDto Visit_VariableInput_OperatorDto(VariableInput_OperatorDto dto) => ProcessOperatorDto(
	        dto,
	        () =>
	        {
