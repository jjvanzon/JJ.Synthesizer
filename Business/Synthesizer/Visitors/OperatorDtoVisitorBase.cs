    ...
    internal class OperatorDtoVisitorBase
    {
        ...
        public OperatorDtoVisitorBase()
        {
            _delegateDictionary = new Dictionary<Type, Func<IOperatorDto, IOperatorDto>>
            {
                ...
                { typeof(Stretch_OperatorDto_WithOrigin), x => Visit_Stretch_OperatorDto_WithOrigin((Stretch_OperatorDto_WithOrigin)x) },
                { typeof(Stretch_OperatorDto_ZeroOrigin), x => Visit_Stretch_OperatorDto_ZeroOrigin((Stretch_OperatorDto_ZeroOrigin)x) },
                { typeof(Stretch_OperatorDto_ConstFactor_WithOriginShifting), x => Visit_Stretch_OperatorDto_ConstFactor_WithOriginShifting((Stretch_OperatorDto_ConstFactor_WithOriginShifting)x) },
                { typeof(Stretch_OperatorDto_VarFactor_WithPhaseTracking), x => Visit_Stretch_OperatorDto_VarFactor_WithPhaseTracking((Stretch_OperatorDto_VarFactor_WithPhaseTracking)x) },
        ...
        [DebuggerHidden] protected virtual IOperatorDto Visit_Stretch_OperatorDto_WithOrigin(Stretch_OperatorDto_WithOrigin dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual IOperatorDto Visit_Stretch_OperatorDto_ZeroOrigin(Stretch_OperatorDto_ZeroOrigin dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual IOperatorDto Visit_Stretch_OperatorDto_ConstFactor_WithOriginShifting(Stretch_OperatorDto_ConstFactor_WithOriginShifting dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual IOperatorDto Visit_Stretch_OperatorDto_VarFactor_WithPhaseTracking(Stretch_OperatorDto_VarFactor_WithPhaseTracking dto) => Visit_OperatorDto_Base(dto);
