...
namespace JJ.Business.Synthesizer.Visitors
{
	internal class OperatorDtoVisitorBase
	{
		...
		protected OperatorDtoVisitorBase() => _delegateDictionary = new Dictionary<Type, Func<IOperatorDto, IOperatorDto>>
		{
		    ...
		    { typeof(AverageFollowerWithSamplingRate_OperatorDto), x => Visit_AverageFollowerWithSamplingRate_OperatorDto((AverageFollowerWithSamplingRate_OperatorDto)x) },
		    ...
		    { typeof(MaxFollowerWithSamplingRate_OperatorDto), x => Visit_MaxFollowerWithSamplingRate_OperatorDto((MaxFollowerWithSamplingRate_OperatorDto)x) },
		    ...
		    { typeof(MinFollowerWithSamplingRate_OperatorDto), x => Visit_MinFollowerWithSamplingRate_OperatorDto((MinFollowerWithSamplingRate_OperatorDto)x) },
		    ...
		    { typeof(SumFollowerWithSamplingRate_OperatorDto), x => Visit_SumFollowerWithSamplingRate_OperatorDto((SumFollowerWithSamplingRate_OperatorDto)x) },
		    { typeof(SumFollowerWithSamplingRate_OperatorDto_AllVars), x => Visit_SumFollowerWithSamplingRate_OperatorDto_AllVars((SumFollowerWithSamplingRate_OperatorDto_AllVars)x) },
		    { typeof(SumFollowerWithSamplingRate_OperatorDto_ConstSignal_VarSamplingRate), x => Visit_SumFollowerWithSamplingRate_OperatorDto_ConstSignal_VarSamplingRate((SumFollowerWithSamplingRate_OperatorDto_ConstSignal_VarSamplingRate)x) },
		    { typeof(SumFollowerWithSamplingRate_OperatorDto_AllConsts), x => Visit_SumFollowerWithSamplingRate_OperatorDto_AllConsts((SumFollowerWithSamplingRate_OperatorDto_AllConsts)x) },
		...
		/*[DebuggerHidden]*/ protected virtual IOperatorDto Visit_AverageFollowerWithSamplingRate_OperatorDto(AverageFollowerWithSamplingRate_OperatorDto dto) => Visit_OperatorDto_Base(dto);
		...
		/*[DebuggerHidden]*/ protected virtual IOperatorDto Visit_MaxFollowerWithSamplingRate_OperatorDto(MaxFollowerWithSamplingRate_OperatorDto dto) => Visit_OperatorDto_Base(dto);
		...
		/*[DebuggerHidden]*/ protected virtual IOperatorDto Visit_MinFollowerWithSamplingRate_OperatorDto(MinFollowerWithSamplingRate_OperatorDto dto) => Visit_OperatorDto_Base(dto);
		...
		/*[DebuggerHidden]*/ protected virtual IOperatorDto Visit_SumFollowerWithSamplingRate_OperatorDto(SumFollowerWithSamplingRate_OperatorDto dto) => Visit_OperatorDto_Base(dto);
		/*[DebuggerHidden]*/ protected virtual IOperatorDto Visit_SumFollowerWithSamplingRate_OperatorDto_AllVars(SumFollowerWithSamplingRate_OperatorDto_AllVars dto) => Visit_OperatorDto_Base(dto);
		/*[DebuggerHidden]*/ protected virtual IOperatorDto Visit_SumFollowerWithSamplingRate_OperatorDto_ConstSignal_VarSamplingRate(SumFollowerWithSamplingRate_OperatorDto_ConstSignal_VarSamplingRate dto) => Visit_OperatorDto_Base(dto);
		/*[DebuggerHidden]*/ protected virtual IOperatorDto Visit_SumFollowerWithSamplingRate_OperatorDto_AllConsts(SumFollowerWithSamplingRate_OperatorDto_AllConsts dto) => Visit_OperatorDto_Base(dto);
