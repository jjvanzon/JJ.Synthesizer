    ...
    internal class OperatorDtoVisitorBase
    {
        ...
        public OperatorDtoVisitorBase()
        {
            _delegateDictionary = new Dictionary<Type, Func<OperatorDtoBase, OperatorDtoBase>>
            {
                ...
                { typeof(Cache_OperatorDto_SingleChannel_CubicInterpolation), x => Visit_Cache_OperatorDto_SingleChannel_CubicInterpolation((Cache_OperatorDto_SingleChannel_CubicInterpolation)x ) },
                { typeof(Cache_OperatorDto_SingleChannel_HermiteInterpolation), x => Visit_Cache_OperatorDto_SingleChannel_HermiteInterpolation((Cache_OperatorDto_SingleChannel_HermiteInterpolation)x ) },
                { typeof(Cache_OperatorDto_SingleChannel_LineInterpolation), x => Visit_Cache_OperatorDto_SingleChannel_LineInterpolation((Cache_OperatorDto_SingleChannel_LineInterpolation)x ) },
                { typeof(Cache_OperatorDto_SingleChannel_StripeInterpolation), x => Visit_Cache_OperatorDto_SingleChannel_StripeInterpolation((Cache_OperatorDto_SingleChannel_StripeInterpolation)x ) },
                { typeof(Cache_OperatorDto_MultiChannel_BlockInterpolation), x => Visit_Cache_OperatorDto_MultiChannel_BlockInterpolation((Cache_OperatorDto_MultiChannel_BlockInterpolation)x ) },
                { typeof(Cache_OperatorDto_MultiChannel_CubicInterpolation), x => Visit_Cache_OperatorDto_MultiChannel_CubicInterpolation((Cache_OperatorDto_MultiChannel_CubicInterpolation)x ) },
                { typeof(Cache_OperatorDto_MultiChannel_HermiteInterpolation), x => Visit_Cache_OperatorDto_MultiChannel_HermiteInterpolation((Cache_OperatorDto_MultiChannel_HermiteInterpolation)x ) },
                { typeof(Cache_OperatorDto_MultiChannel_LineInterpolation), x => Visit_Cache_OperatorDto_MultiChannel_LineInterpolation((Cache_OperatorDto_MultiChannel_LineInterpolation)x ) },
                { typeof(Cache_OperatorDto_MultiChannel_StripeInterpolation), x => Visit_Cache_OperatorDto_MultiChannel_StripeInterpolation((Cache_OperatorDto_MultiChannel_StripeInterpolation)x ) },
                ...
                { typeof(MaxFollower_OperatorDto_AllVars), x => Visit_MaxFollower_OperatorDto_AllVars((MaxFollower_OperatorDto_AllVars)x ) },
                ...
                { typeof(MaxOverDimension_OperatorDto_AllVars_CollectionRecalculationContinuous), x => Visit_MaxOverDimension_OperatorDto_AllVars_CollectionRecalculationContinuous((MaxOverDimension_OperatorDto_AllVars_CollectionRecalculationContinuous)x ) },
                { typeof(MaxOverDimension_OperatorDto_AllVars_CollectionRecalculationUponReset), x => Visit_MaxOverDimension_OperatorDto_AllVars_CollectionRecalculationUponReset((MaxOverDimension_OperatorDto_AllVars_CollectionRecalculationUponReset)x ) },
                ...
                { typeof(MinFollower_OperatorDto_AllVars), x => Visit_MinFollower_OperatorDto_AllVars((MinFollower_OperatorDto_AllVars)x ) },
                ...
                { typeof(MinOverDimension_OperatorDto_AllVars_CollectionRecalculationContinuous), x => Visit_MinOverDimension_OperatorDto_AllVars_CollectionRecalculationContinuous((MinOverDimension_OperatorDto_AllVars_CollectionRecalculationContinuous)x ) },
                { typeof(MinOverDimension_OperatorDto_AllVars_CollectionRecalculationUponReset), x => Visit_MinOverDimension_OperatorDto_AllVars_CollectionRecalculationUponReset((MinOverDimension_OperatorDto_AllVars_CollectionRecalculationUponReset)x ) },
                ...
                { typeof(SetDimension_OperatorDto_VarPassThrough_VarValue), x => Visit_SetDimension_OperatorDto_VarPassThrough_VarValue((SetDimension_OperatorDto_VarPassThrough_VarValue)x ) },
                { typeof(SetDimension_OperatorDto_VarPassThrough_ConstValue), x => Visit_SetDimension_OperatorDto_VarPassThrough_ConstValue((SetDimension_OperatorDto_VarPassThrough_ConstValue)x ) },
                { typeof(SetDimension_OperatorDto_ConstPassThrough_VarValue), x => Visit_SetDimension_OperatorDto_ConstPassThrough_VarValue((SetDimension_OperatorDto_ConstPassThrough_VarValue)x ) },
                { typeof(SetDimension_OperatorDto_ConstPassThrough_ConstValue), x => Visit_SetDimension_OperatorDto_ConstPassThrough_ConstValue((SetDimension_OperatorDto_ConstPassThrough_ConstValue)x ) },
                ...
                { typeof(SortOverDimension_OperatorDto_AllVars_CollectionRecalculationContinuous), x => Visit_SortOverDimension_OperatorDto_AllVars_CollectionRecalculationContinuous((SortOverDimension_OperatorDto_AllVars_CollectionRecalculationContinuous)x ) },
                { typeof(SortOverDimension_OperatorDto_AllVars_CollectionRecalculationUponReset), x => Visit_SortOverDimension_OperatorDto_AllVars_CollectionRecalculationUponReset((SortOverDimension_OperatorDto_AllVars_CollectionRecalculationUponReset)x ) },
        ...
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_AverageFollower_OperatorDto(AverageFollower_OperatorDto dto) => Visit_OperatorDto_Base(dto);
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_AverageFollower_OperatorDto_AllVars(AverageFollower_OperatorDto_AllVars dto) => Visit_OperatorDto_Base(dto);
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_AverageFollower_OperatorDto_ConstSignal(AverageFollower_OperatorDto_ConstSignal dto) => Visit_OperatorDto_Base(dto);
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_AverageOverDimension_OperatorDto(AverageOverDimension_OperatorDto dto) => Visit_OperatorDto_Base(dto);
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_AverageOverDimension_OperatorDto_ConstSignal(AverageOverDimension_OperatorDto_ConstSignal dto) => Visit_OperatorDto_Base(dto);
        ...
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_Cache_OperatorDto_SingleChannel_CubicInterpolation(Cache_OperatorDto_SingleChannel_CubicInterpolation dto) => Visit_OperatorDto_Base(dto);
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_Cache_OperatorDto_SingleChannel_HermiteInterpolation(Cache_OperatorDto_SingleChannel_HermiteInterpolation dto) => Visit_OperatorDto_Base(dto);
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_Cache_OperatorDto_SingleChannel_LineInterpolation(Cache_OperatorDto_SingleChannel_LineInterpolation dto) => Visit_OperatorDto_Base(dto);
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_Cache_OperatorDto_SingleChannel_StripeInterpolation(Cache_OperatorDto_SingleChannel_StripeInterpolation dto) => Visit_OperatorDto_Base(dto);
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_Cache_OperatorDto_MultiChannel_BlockInterpolation(Cache_OperatorDto_MultiChannel_BlockInterpolation dto) => Visit_OperatorDto_Base(dto);
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_Cache_OperatorDto_MultiChannel_CubicInterpolation(Cache_OperatorDto_MultiChannel_CubicInterpolation dto) => Visit_OperatorDto_Base(dto);
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_Cache_OperatorDto_MultiChannel_HermiteInterpolation(Cache_OperatorDto_MultiChannel_HermiteInterpolation dto) => Visit_OperatorDto_Base(dto);
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_Cache_OperatorDto_MultiChannel_LineInterpolation(Cache_OperatorDto_MultiChannel_LineInterpolation dto) => Visit_OperatorDto_Base(dto);
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_Cache_OperatorDto_MultiChannel_StripeInterpolation(Cache_OperatorDto_MultiChannel_StripeInterpolation dto) => Visit_OperatorDto_Base(dto);
        ...
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_DimensionToOutlets_Outlet_OperatorDto(DimensionToOutlets_Outlet_OperatorDto dto) => Visit_OperatorDto_Base(dto);
        ...
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_Hold_OperatorDto(Hold_OperatorDto dto) => Visit_OperatorDto_Base(dto);
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_Hold_OperatorDto_VarSignal(Hold_OperatorDto_VarSignal dto) => Visit_OperatorDto_Base(dto);
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_Hold_OperatorDto_ConstSignal(Hold_OperatorDto_ConstSignal dto) => Visit_OperatorDto_Base(dto);
        ...
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_InletsToDimension_OperatorDto_Stripe_LagBehind(InletsToDimension_OperatorDto_Stripe_LagBehind dto) => Visit_OperatorDto_Base(dto);
        ...
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_InletsToDimension_OperatorDto_CubicSmoothSlope_LagBehind(InletsToDimension_OperatorDto_CubicSmoothSlope_LagBehind dto) => Visit_OperatorDto_Base(dto);
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_InletsToDimension_OperatorDto_Hermite_LagBehind(InletsToDimension_OperatorDto_Hermite_LagBehind dto) => Visit_OperatorDto_Base(dto);
        ...
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_Loop_OperatorDto_ConstSignal(Loop_OperatorDto_ConstSignal dto) => Visit_OperatorDto_Base(dto);
        ...
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_MaxFollower_OperatorDto(MaxFollower_OperatorDto dto) => Visit_OperatorDto_Base(dto);
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_MaxFollower_OperatorDto_ConstSignal(MaxFollower_OperatorDto_ConstSignal dto) => Visit_OperatorDto_Base(dto);
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_MaxFollower_OperatorDto_AllVars(MaxFollower_OperatorDto_AllVars dto) => Visit_OperatorDto_Base(dto);
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_MaxOverDimension_OperatorDto(MaxOverDimension_OperatorDto dto) => Visit_OperatorDto_Base(dto);
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_MaxOverDimension_OperatorDto_ConstSignal(MaxOverDimension_OperatorDto_ConstSignal dto) => Visit_OperatorDto_Base(dto);
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_MaxOverDimension_OperatorDto_AllVars_CollectionRecalculationContinuous(MaxOverDimension_OperatorDto_AllVars_CollectionRecalculationContinuous dto) => Visit_OperatorDto_Base(dto);
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_MaxOverDimension_OperatorDto_AllVars_CollectionRecalculationUponReset(MaxOverDimension_OperatorDto_AllVars_CollectionRecalculationUponReset dto) => Visit_OperatorDto_Base(dto);
        ...
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_MinFollower_OperatorDto_AllVars(MinFollower_OperatorDto_AllVars dto) => Visit_OperatorDto_Base(dto);
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_MinFollower_OperatorDto_ConstSignal(MinFollower_OperatorDto_ConstSignal dto) => Visit_OperatorDto_Base(dto);
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_MinOverDimension_OperatorDto(MinOverDimension_OperatorDto dto) => Visit_OperatorDto_Base(dto);
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_MinOverDimension_OperatorDto_ConstSignal(MinOverDimension_OperatorDto_ConstSignal dto) => Visit_OperatorDto_Base(dto);
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_MinOverDimension_OperatorDto_AllVars_CollectionRecalculationContinuous(MinOverDimension_OperatorDto_AllVars_CollectionRecalculationContinuous dto) => Visit_OperatorDto_Base(dto);
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_MinOverDimension_OperatorDto_AllVars_CollectionRecalculationUponReset(MinOverDimension_OperatorDto_AllVars_CollectionRecalculationUponReset dto) => Visit_OperatorDto_Base(dto);
        ...
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_Power_OperatorDto_VarBase_Exponent2(Power_OperatorDto_VarBase_Exponent2 dto) => Visit_OperatorDto_Base(dto);
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_Power_OperatorDto_VarBase_Exponent3(Power_OperatorDto_VarBase_Exponent3 dto) => Visit_OperatorDto_Base(dto);
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_Power_OperatorDto_VarBase_Exponent4(Power_OperatorDto_VarBase_Exponent4 dto) => Visit_OperatorDto_Base(dto);
        ...
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_Random_OperatorDto_Stripe_LagBehind(Random_OperatorDto_Stripe_LagBehind dto) => Visit_OperatorDto_Base(dto);
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_Random_OperatorDto_Line_LagBehind_ConstRate(Random_OperatorDto_Line_LagBehind_ConstRate dto) => Visit_OperatorDto_Base(dto);
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_Random_OperatorDto_Line_LagBehind_VarRate(Random_OperatorDto_Line_LagBehind_VarRate dto) => Visit_OperatorDto_Base(dto);
        ...
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_Random_OperatorDto_CubicSmoothSlope_LagBehind(Random_OperatorDto_CubicSmoothSlope_LagBehind dto) => Visit_OperatorDto_Base(dto);
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_Random_OperatorDto_Hermite_LagBehind(Random_OperatorDto_Hermite_LagBehind dto) => Visit_OperatorDto_Base(dto);
        ...
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_RangeOverOutlets_Outlet_OperatorDto(RangeOverOutlets_Outlet_OperatorDto dto) => Visit_OperatorDto_Base(dto);
        ...
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_RangeOverOutlets_Outlet_OperatorDto_VarFrom_VarStep(RangeOverOutlets_Outlet_OperatorDto_VarFrom_VarStep dto) => Visit_OperatorDto_Base(dto);
        ...
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_Reverse_OperatorDto_VarFactor_WithPhaseTracking(Reverse_OperatorDto_VarFactor_WithPhaseTracking dto) => Visit_OperatorDto_Base(dto);
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_Reverse_OperatorDto_VarFactor_NoPhaseTracking(Reverse_OperatorDto_VarFactor_NoPhaseTracking dto) => Visit_OperatorDto_Base(dto);
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_Reverse_OperatorDto_ConstFactor_WithOriginShifting(Reverse_OperatorDto_ConstFactor_WithOriginShifting dto) => Visit_OperatorDto_Base(dto);
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_Reverse_OperatorDto_ConstFactor_NoOriginShifting(Reverse_OperatorDto_ConstFactor_NoOriginShifting dto) => Visit_OperatorDto_Base(dto);
        ...
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_SetDimension_OperatorDto_VarPassThrough_VarValue(SetDimension_OperatorDto_VarPassThrough_VarValue dto) => Visit_OperatorDto_Base(dto);
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_SetDimension_OperatorDto_VarPassThrough_ConstValue(SetDimension_OperatorDto_VarPassThrough_ConstValue dto) => Visit_OperatorDto_Base(dto);
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_SetDimension_OperatorDto_ConstPassThrough_VarValue(SetDimension_OperatorDto_ConstPassThrough_VarValue dto) => Visit_OperatorDto_Base(dto);
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_SetDimension_OperatorDto_ConstPassThrough_ConstValue(SetDimension_OperatorDto_ConstPassThrough_ConstValue dto) => Visit_OperatorDto_Base(dto);
        ...
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_SortOverDimension_OperatorDto(SortOverDimension_OperatorDto dto) => Visit_OperatorDto_Base(dto);
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_SortOverDimension_OperatorDto_ConstSignal(SortOverDimension_OperatorDto_ConstSignal dto) => Visit_OperatorDto_Base(dto);
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_SortOverDimension_OperatorDto_AllVars_CollectionRecalculationContinuous(SortOverDimension_OperatorDto_AllVars_CollectionRecalculationContinuous dto) => Visit_OperatorDto_Base(dto);
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_SortOverDimension_OperatorDto_AllVars_CollectionRecalculationUponReset(SortOverDimension_OperatorDto_AllVars_CollectionRecalculationUponReset dto) => Visit_OperatorDto_Base(dto);
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_SortOverInlets_Outlet_OperatorDto(SortOverInlets_Outlet_OperatorDto dto) => Visit_OperatorDto_Base(dto);
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_Spectrum_OperatorDto(Spectrum_OperatorDto dto) => Visit_OperatorDto_Base(dto);
        ...
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_SumFollower_OperatorDto(SumFollower_OperatorDto dto) => Visit_OperatorDto_Base(dto);
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_SumFollower_OperatorDto_AllVars(SumFollower_OperatorDto_AllVars dto) => Visit_OperatorDto_Base(dto);
        /*[DebuggerHidden]*/ protected virtual OperatorDtoBase Visit_SumFollower_OperatorDto_ConstSignal_VarSampleCount(SumFollower_OperatorDto_ConstSignal_VarSampleCount dto) => Visit_OperatorDto_Base(dto);
