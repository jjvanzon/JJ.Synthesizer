    ...
    internal class OperatorDtoVisitorBase
    {
        ...
        public OperatorDtoVisitorBase()
        {
            _delegateDictionary = new Dictionary<Type, Func<IOperatorDto, IOperatorDto>>
            {
                ...
                { typeof(AverageFollower_OperatorDto_SoundVarOrConst_OtherInputsVar), x => Visit_AverageFollower_OperatorDto_SoundVarOrConst_OtherInputsVar((AverageFollower_OperatorDto_SoundVarOrConst_OtherInputsVar)x ) },
                ...
                { typeof(AverageOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationContinuous), x => Visit_AverageOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationContinuous((AverageOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationContinuous)x ) },
                { typeof(AverageOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationUponReset), x => Visit_AverageOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationUponReset((AverageOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationUponReset)x ) },
                ...
                { typeof(Loop_OperatorDto_SoundVarOrConst_OtherInputsVar), x => Visit_Loop_OperatorDto_SoundVarOrConst_OtherInputsVar((Loop_OperatorDto_SoundVarOrConst_OtherInputsVar)x ) },
                ...
                { typeof(MaxFollower_OperatorDto_SoundVarOrConst_OtherInputsVar), x => Visit_MaxFollower_OperatorDto_SoundVarOrConst_OtherInputsVar((MaxFollower_OperatorDto_SoundVarOrConst_OtherInputsVar)x ) },
                ...
                { typeof(MaxOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationContinuous), x => Visit_MaxOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationContinuous((MaxOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationContinuous)x ) },
                { typeof(MaxOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationUponReset), x => Visit_MaxOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationUponReset((MaxOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationUponReset)x ) },
                ...
                { typeof(MinFollower_OperatorDto_SoundVarOrConst_OtherInputsVar), x => Visit_MinFollower_OperatorDto_SoundVarOrConst_OtherInputsVar((MinFollower_OperatorDto_SoundVarOrConst_OtherInputsVar)x ) },
                ...
                { typeof(MinOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationContinuous), x => Visit_MinOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationContinuous((MinOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationContinuous)x ) },
                { typeof(MinOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationUponReset), x => Visit_MinOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationUponReset((MinOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationUponReset)x ) },
                ...
                { typeof(SortOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationContinuous), x => Visit_SortOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationContinuous((SortOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationContinuous)x ) },
                ...
                { typeof(SumFollower_OperatorDto_SoundVarOrConst_OtherInputsVar), x => Visit_SumFollower_OperatorDto_SoundVarOrConst_OtherInputsVar((SumFollower_OperatorDto_SoundVarOrConst_OtherInputsVar)x ) },
                ...
                { typeof(SumOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationContinuous), x => Visit_SumOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationContinuous((SumOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationContinuous)x ) },
                { typeof(SumOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationUponReset), x => Visit_SumOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationUponReset((SumOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationUponReset)x ) },
        ...
        [DebuggerHidden] protected virtual IOperatorDto Visit_Add_OperatorDto_NoVars_NoConsts(Add_OperatorDto_NoVars_NoConsts dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual IOperatorDto Visit_Add_OperatorDto_NoVars_Consts(Add_OperatorDto_NoVars_Consts dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual IOperatorDto Visit_Add_OperatorDto_Vars_1Const(Add_OperatorDto_Vars_1Const dto) => Visit_OperatorDto_Base(dto);
        ...
        [DebuggerHidden] protected virtual IOperatorDto Visit_AverageFollower_OperatorDto_SoundVarOrConst_OtherInputsVar(AverageFollower_OperatorDto_SoundVarOrConst_OtherInputsVar dto) => Visit_OperatorDto_Base(dto);
        ...
        [DebuggerHidden] protected virtual IOperatorDto Visit_AverageOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationContinuous(AverageOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationContinuous dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual IOperatorDto Visit_AverageOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationUponReset(AverageOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationUponReset dto) => Visit_OperatorDto_Base(dto);
        ...
        [DebuggerHidden] protected virtual IOperatorDto Visit_Loop_OperatorDto_SoundVarOrConst_OtherInputsVar(Loop_OperatorDto_SoundVarOrConst_OtherInputsVar dto) => Visit_OperatorDto_Base(dto);
        ...
        [DebuggerHidden] protected virtual IOperatorDto Visit_MaxFollower_OperatorDto_SoundVarOrConst_OtherInputsVar(MaxFollower_OperatorDto_SoundVarOrConst_OtherInputsVar dto) => Visit_OperatorDto_Base(dto);
        ...
        [DebuggerHidden] protected virtual IOperatorDto Visit_MaxOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationContinuous(MaxOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationContinuous dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual IOperatorDto Visit_MaxOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationUponReset(MaxOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationUponReset dto) => Visit_OperatorDto_Base(dto);
        ...
        [DebuggerHidden] protected virtual IOperatorDto Visit_MinFollower_OperatorDto_SoundVarOrConst_OtherInputsVar(MinFollower_OperatorDto_SoundVarOrConst_OtherInputsVar dto) => Visit_OperatorDto_Base(dto);
        ...
        [DebuggerHidden] protected virtual IOperatorDto Visit_MinOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationContinuous(MinOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationContinuous dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual IOperatorDto Visit_MinOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationUponReset(MinOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationUponReset dto) => Visit_OperatorDto_Base(dto);
        ...
        [DebuggerHidden] protected virtual IOperatorDto Visit_MinOverInlets_OperatorDto_Vars_Consts(MinOverInlets_OperatorDto_Vars_Consts dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual IOperatorDto Visit_MinOverInlets_OperatorDto_Vars_NoConsts(MinOverInlets_OperatorDto_Vars_NoConsts dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual IOperatorDto Visit_MinOverInlets_OperatorDto_NoVars_NoConsts(MinOverInlets_OperatorDto_NoVars_NoConsts dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual IOperatorDto Visit_MinOverInlets_OperatorDto_NoVars_Consts(MinOverInlets_OperatorDto_NoVars_Consts dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual IOperatorDto Visit_MinOverInlets_OperatorDto_Vars_1Const(MinOverInlets_OperatorDto_Vars_1Const dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual IOperatorDto Visit_MinOverInlets_OperatorDto_1Var_1Const(MinOverInlets_OperatorDto_1Var_1Const dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual IOperatorDto Visit_MinOverInlets_OperatorDto_2Vars(MinOverInlets_OperatorDto_2Vars dto) => Visit_OperatorDto_Base(dto);
        ...
        [DebuggerHidden] protected virtual IOperatorDto Visit_Multiply_OperatorDto_Vars_Consts(Multiply_OperatorDto_Vars_Consts dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual IOperatorDto Visit_Multiply_OperatorDto_Vars_NoConsts(Multiply_OperatorDto_Vars_NoConsts dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual IOperatorDto Visit_Multiply_OperatorDto_NoVars_NoConsts(Multiply_OperatorDto_NoVars_NoConsts dto) => Visit_OperatorDto_Base(dto);
        ...
        [DebuggerHidden] protected virtual IOperatorDto Visit_Pulse_OperatorDto_ConstFrequency_ConstWidth_WithOriginShifting(Pulse_OperatorDto_ConstFrequency_ConstWidth_WithOriginShifting dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual IOperatorDto Visit_Pulse_OperatorDto_ConstFrequency_VarWidth_WithOriginShifting(Pulse_OperatorDto_ConstFrequency_VarWidth_WithOriginShifting dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual IOperatorDto Visit_Pulse_OperatorDto_VarFrequency_HalfWidth_WithPhaseTracking(Pulse_OperatorDto_VarFrequency_HalfWidth_WithPhaseTracking dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual IOperatorDto Visit_Pulse_OperatorDto_VarFrequency_ConstWidth_WithPhaseTracking(Pulse_OperatorDto_VarFrequency_ConstWidth_WithPhaseTracking dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual IOperatorDto Visit_Pulse_OperatorDto_VarFrequency_VarWidth_WithPhaseTracking(Pulse_OperatorDto_VarFrequency_VarWidth_WithPhaseTracking dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual IOperatorDto Visit_Pulse_OperatorDto_ConstFrequency_HalfWidth_NoOriginShifting(Pulse_OperatorDto_ConstFrequency_HalfWidth_NoOriginShifting dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual IOperatorDto Visit_Pulse_OperatorDto_ConstFrequency_ConstWidth_NoOriginShifting(Pulse_OperatorDto_ConstFrequency_ConstWidth_NoOriginShifting dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual IOperatorDto Visit_Pulse_OperatorDto_ConstFrequency_VarWidth_NoOriginShifting(Pulse_OperatorDto_ConstFrequency_VarWidth_NoOriginShifting dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual IOperatorDto Visit_Pulse_OperatorDto_VarFrequency_HalfWidth_NoPhaseTracking(Pulse_OperatorDto_VarFrequency_HalfWidth_NoPhaseTracking dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual IOperatorDto Visit_Pulse_OperatorDto_VarFrequency_ConstWidth_NoPhaseTracking(Pulse_OperatorDto_VarFrequency_ConstWidth_NoPhaseTracking dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual IOperatorDto Visit_Pulse_OperatorDto_VarFrequency_VarWidth_NoPhaseTracking(Pulse_OperatorDto_VarFrequency_VarWidth_NoPhaseTracking dto) => Visit_OperatorDto_Base(dto);
        ...
        [DebuggerHidden] protected virtual IOperatorDto Visit_Sample_OperatorDto_ZeroFrequency(Sample_OperatorDto_ZeroFrequency dto) => Visit_OperatorDto_Base(dto);
        ...
        [DebuggerHidden] protected virtual IOperatorDto Visit_SawDown_OperatorDto(SawDown_OperatorDto dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual IOperatorDto Visit_SawDown_OperatorDto_ZeroFrequency(SawDown_OperatorDto_ZeroFrequency dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual IOperatorDto Visit_SawDown_OperatorDto_ConstFrequency_NoOriginShifting(SawDown_OperatorDto_ConstFrequency_NoOriginShifting dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual IOperatorDto Visit_SawDown_OperatorDto_ConstFrequency_WithOriginShifting(SawDown_OperatorDto_ConstFrequency_WithOriginShifting dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual IOperatorDto Visit_SawDown_OperatorDto_VarFrequency_NoPhaseTracking(SawDown_OperatorDto_VarFrequency_NoPhaseTracking dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual IOperatorDto Visit_SawDown_OperatorDto_VarFrequency_WithPhaseTracking(SawDown_OperatorDto_VarFrequency_WithPhaseTracking dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual IOperatorDto Visit_SawUp_OperatorDto(SawUp_OperatorDto dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual IOperatorDto Visit_SawUp_OperatorDto_ZeroFrequency(SawUp_OperatorDto_ZeroFrequency dto) => Visit_OperatorDto_Base(dto);
        ...
        [DebuggerHidden] protected virtual IOperatorDto Visit_SortOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationContinuous(SortOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationContinuous dto) => Visit_OperatorDto_Base(dto);
        ...
        [DebuggerHidden] protected virtual IOperatorDto Visit_Square_OperatorDto_ConstFrequency_WithOriginShifting(Square_OperatorDto_ConstFrequency_WithOriginShifting dto) => Visit_OperatorDto_Base(dto);
        ...
        [DebuggerHidden] protected virtual IOperatorDto Visit_SumFollower_OperatorDto_SoundVarOrConst_OtherInputsVar(SumFollower_OperatorDto_SoundVarOrConst_OtherInputsVar dto) => Visit_OperatorDto_Base(dto);
        ...
        [DebuggerHidden] protected virtual IOperatorDto Visit_SumOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationContinuous(SumOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationContinuous dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual IOperatorDto Visit_SumOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationUponReset(SumOverDimension_OperatorDto_SoundVarOrConst_OtherInputsVar_CollectionRecalculationUponReset dto) => Visit_OperatorDto_Base(dto);
