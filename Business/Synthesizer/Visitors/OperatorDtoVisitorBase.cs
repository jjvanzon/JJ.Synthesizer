    ...
    internal class OperatorDtoVisitorBase
    {
        ...
        public OperatorDtoVisitorBase()
        {
            _delegateDictionary = new Dictionary<Type, Func<OperatorDtoBase, OperatorDtoBase>>
            {
                ...
                { typeof(Reverse_OperatorDto_VarSpeed_WithPhaseTracking), x => Visit_Reverse_OperatorDto_VarSpeed_WithPhaseTracking((Reverse_OperatorDto_VarSpeed_WithPhaseTracking)x ) },
                { typeof(Reverse_OperatorDto_VarSpeed_NoPhaseTracking), x => Visit_Reverse_OperatorDto_VarSpeed_NoPhaseTracking((Reverse_OperatorDto_VarSpeed_NoPhaseTracking)x ) },
        ...
        [DebuggerHidden] protected virtual OperatorDtoBase Visit_Reverse_OperatorDto_VarSpeed_WithPhaseTracking(Reverse_OperatorDto_VarSpeed_WithPhaseTracking dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual OperatorDtoBase Visit_Reverse_OperatorDto_VarSpeed_NoPhaseTracking(Reverse_OperatorDto_VarSpeed_NoPhaseTracking dto) => Visit_OperatorDto_Base(dto);
