    ...
    internal class OperatorDtoVisitorBase
    {
        ...
        public OperatorDtoVisitorBase()
        {
            _delegateDictionary = new Dictionary<Type, Func<OperatorDtoBase, OperatorDtoBase>>
            {
                ...
                { typeof(ClosestOverInlets_OperatorDto_AllVars), x => Visit_ClosestOverInlets_OperatorDto_AllVars((ClosestOverInlets_OperatorDto_AllVars)x ) },
                ...
                { typeof(ClosestOverInletsExp_OperatorDto_AllVars), x => Visit_ClosestOverInletsExp_OperatorDto_AllVars((ClosestOverInletsExp_OperatorDto_AllVars)x ) },
                ...
                { typeof(Divide_OperatorDto_VarNumerator_VarDenominator_VarOrigin), x => Visit_Divide_OperatorDto_VarNumerator_VarDenominator_VarOrigin((Divide_OperatorDto_VarNumerator_VarDenominator_VarOrigin)x ) },
                { typeof(Divide_OperatorDto_VarNumerator_VarDenominator_ConstOrigin), x => Visit_Divide_OperatorDto_VarNumerator_VarDenominator_ConstOrigin((Divide_OperatorDto_VarNumerator_VarDenominator_ConstOrigin)x ) },
                { typeof(Divide_OperatorDto_VarNumerator_VarDenominator_ZeroOrigin), x => Visit_Divide_OperatorDto_VarNumerator_VarDenominator_ZeroOrigin((Divide_OperatorDto_VarNumerator_VarDenominator_ZeroOrigin)x ) },
                { typeof(Divide_OperatorDto_VarNumerator_ConstDenominator_VarOrigin), x => Visit_Divide_OperatorDto_VarNumerator_ConstDenominator_VarOrigin((Divide_OperatorDto_VarNumerator_ConstDenominator_VarOrigin)x ) },
                { typeof(Divide_OperatorDto_VarNumerator_ConstDenominator_ConstOrigin), x => Visit_Divide_OperatorDto_VarNumerator_ConstDenominator_ConstOrigin((Divide_OperatorDto_VarNumerator_ConstDenominator_ConstOrigin)x ) },
                { typeof(Divide_OperatorDto_VarNumerator_ConstDenominator_ZeroOrigin), x => Visit_Divide_OperatorDto_VarNumerator_ConstDenominator_ZeroOrigin((Divide_OperatorDto_VarNumerator_ConstDenominator_ZeroOrigin)x ) },
                { typeof(Divide_OperatorDto_ConstNumerator_VarDenominator_VarOrigin), x => Visit_Divide_OperatorDto_ConstNumerator_VarDenominator_VarOrigin((Divide_OperatorDto_ConstNumerator_VarDenominator_VarOrigin)x ) },
                { typeof(Divide_OperatorDto_ConstNumerator_VarDenominator_ConstOrigin), x => Visit_Divide_OperatorDto_ConstNumerator_VarDenominator_ConstOrigin((Divide_OperatorDto_ConstNumerator_VarDenominator_ConstOrigin)x ) },
                { typeof(Divide_OperatorDto_ConstNumerator_VarDenominator_ZeroOrigin), x => Visit_Divide_OperatorDto_ConstNumerator_VarDenominator_ZeroOrigin((Divide_OperatorDto_ConstNumerator_VarDenominator_ZeroOrigin)x ) },
                { typeof(Divide_OperatorDto_ConstNumerator_ConstDenominator_VarOrigin), x => Visit_Divide_OperatorDto_ConstNumerator_ConstDenominator_VarOrigin((Divide_OperatorDto_ConstNumerator_ConstDenominator_VarOrigin)x ) },
                { typeof(Divide_OperatorDto_ConstNumerator_ConstDenominator_ConstOrigin), x => Visit_Divide_OperatorDto_ConstNumerator_ConstDenominator_ConstOrigin((Divide_OperatorDto_ConstNumerator_ConstDenominator_ConstOrigin)x ) },
                { typeof(Divide_OperatorDto_ConstNumerator_ConstDenominator_ZeroOrigin), x => Visit_Divide_OperatorDto_ConstNumerator_ConstDenominator_ZeroOrigin((Divide_OperatorDto_ConstNumerator_ConstDenominator_ZeroOrigin)x ) },
                ...
                { typeof(Round_OperatorDto_VarStep_VarOffset), x => Visit_Round_OperatorDto_VarStep_VarOffset((Round_OperatorDto_VarStep_VarOffset)x ) },
                { typeof(Round_OperatorDto_VarStep_ConstOffset), x => Visit_Round_OperatorDto_VarStep_ConstOffset((Round_OperatorDto_VarStep_ConstOffset)x ) },
                { typeof(Round_OperatorDto_VarStep_ZeroOffset), x => Visit_Round_OperatorDto_VarStep_ZeroOffset((Round_OperatorDto_VarStep_ZeroOffset)x ) },
                { typeof(Round_OperatorDto_ConstStep_VarOffset), x => Visit_Round_OperatorDto_ConstStep_VarOffset((Round_OperatorDto_ConstStep_VarOffset)x ) },
                { typeof(Round_ConstStep_ConstOffSet_OperatorCalculator), x => Visit_Round_ConstStep_ConstOffSet_OperatorCalculator((Round_ConstStep_ConstOffSet_OperatorCalculator)x ) },
                { typeof(Round_OperatorDto_ConstStep_ZeroOffset), x => Visit_Round_OperatorDto_ConstStep_ZeroOffset((Round_OperatorDto_ConstStep_ZeroOffset)x ) },
                { typeof(Round_ConstSignal_OperatorCalculator), x => Visit_Round_ConstSignal_OperatorCalculator((Round_ConstSignal_OperatorCalculator)x ) },
                { typeof(Round_VarSignal_StepOne_OffsetZero), x => Visit_Round_VarSignal_StepOne_OffsetZero((Round_VarSignal_StepOne_OffsetZero)x ) },
        ...
        [DebuggerHidden] protected virtual OperatorDtoBase Visit_ClosestOverInlets_OperatorDto_AllVars(ClosestOverInlets_OperatorDto_AllVars dto) => Visit_OperatorDto_Base(dto);
        ...
        [DebuggerHidden] protected virtual OperatorDtoBase Visit_ClosestOverInletsExp_OperatorDto_AllVars(ClosestOverInletsExp_OperatorDto_AllVars dto) => Visit_OperatorDto_Base(dto);
        ...
        [DebuggerHidden] protected virtual OperatorDtoBase Visit_Divide_OperatorDto_VarNumerator_VarDenominator_VarOrigin(Divide_OperatorDto_VarNumerator_VarDenominator_VarOrigin dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual OperatorDtoBase Visit_Divide_OperatorDto_VarNumerator_VarDenominator_ConstOrigin(Divide_OperatorDto_VarNumerator_VarDenominator_ConstOrigin dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual OperatorDtoBase Visit_Divide_OperatorDto_VarNumerator_VarDenominator_ZeroOrigin(Divide_OperatorDto_VarNumerator_VarDenominator_ZeroOrigin dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual OperatorDtoBase Visit_Divide_OperatorDto_VarNumerator_ConstDenominator_VarOrigin(Divide_OperatorDto_VarNumerator_ConstDenominator_VarOrigin dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual OperatorDtoBase Visit_Divide_OperatorDto_VarNumerator_ConstDenominator_ConstOrigin(Divide_OperatorDto_VarNumerator_ConstDenominator_ConstOrigin dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual OperatorDtoBase Visit_Divide_OperatorDto_VarNumerator_ConstDenominator_ZeroOrigin(Divide_OperatorDto_VarNumerator_ConstDenominator_ZeroOrigin dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual OperatorDtoBase Visit_Divide_OperatorDto_ConstNumerator_VarDenominator_VarOrigin(Divide_OperatorDto_ConstNumerator_VarDenominator_VarOrigin dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual OperatorDtoBase Visit_Divide_OperatorDto_ConstNumerator_VarDenominator_ConstOrigin(Divide_OperatorDto_ConstNumerator_VarDenominator_ConstOrigin dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual OperatorDtoBase Visit_Divide_OperatorDto_ConstNumerator_VarDenominator_ZeroOrigin(Divide_OperatorDto_ConstNumerator_VarDenominator_ZeroOrigin dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual OperatorDtoBase Visit_Divide_OperatorDto_ConstNumerator_ConstDenominator_VarOrigin(Divide_OperatorDto_ConstNumerator_ConstDenominator_VarOrigin dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual OperatorDtoBase Visit_Divide_OperatorDto_ConstNumerator_ConstDenominator_ConstOrigin(Divide_OperatorDto_ConstNumerator_ConstDenominator_ConstOrigin dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual OperatorDtoBase Visit_Divide_OperatorDto_ConstNumerator_ConstDenominator_ZeroOrigin(Divide_OperatorDto_ConstNumerator_ConstDenominator_ZeroOrigin dto) => Visit_OperatorDto_Base(dto);
        ...
        [DebuggerHidden] protected virtual OperatorDtoBase Visit_Round_OperatorDto_VarStep_VarOffset(Round_OperatorDto_VarStep_VarOffset dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual OperatorDtoBase Visit_Round_OperatorDto_VarStep_ConstOffset(Round_OperatorDto_VarStep_ConstOffset dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual OperatorDtoBase Visit_Round_OperatorDto_VarStep_ZeroOffset(Round_OperatorDto_VarStep_ZeroOffset dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual OperatorDtoBase Visit_Round_OperatorDto_ConstStep_VarOffset(Round_OperatorDto_ConstStep_VarOffset dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual OperatorDtoBase Visit_Round_ConstStep_ConstOffSet_OperatorCalculator(Round_ConstStep_ConstOffSet_OperatorCalculator dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual OperatorDtoBase Visit_Round_OperatorDto_ConstStep_ZeroOffset(Round_OperatorDto_ConstStep_ZeroOffset dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual OperatorDtoBase Visit_Round_ConstSignal_OperatorCalculator(Round_ConstSignal_OperatorCalculator dto) => Visit_OperatorDto_Base(dto);
        [DebuggerHidden] protected virtual OperatorDtoBase Visit_Round_VarSignal_StepOne_OffsetZero(Round_VarSignal_StepOne_OffsetZero dto) => Visit_OperatorDto_Base(dto);
