...
namespace JJ.Business.Synthesizer.Visitors
{
    internal abstract class OperatorDtoVisitorBase_AfterClassSpecialization : OperatorDtoVisitorBase
    {
        ...
        protected sealed override IOperatorDto Visit_Reverse_OperatorDto(Reverse_OperatorDto dto) => throw new NotSupportedException();
        ...
        protected sealed override IOperatorDto Visit_SawDown_OperatorDto(SawDown_OperatorDto dto) => throw new NotSupportedException();
        protected sealed override IOperatorDto Visit_SawUp_OperatorDto(SawUp_OperatorDto dto) => throw new NotSupportedException();
        ...
        protected sealed override IOperatorDto Visit_Spectrum_OperatorDto(Spectrum_OperatorDto dto) => throw new NotSupportedException();
