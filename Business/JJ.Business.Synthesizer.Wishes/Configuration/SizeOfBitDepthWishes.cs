...
namespace JJ.Business.Synthesizer.Wishes.Configuration
{
    ...
    public static class SizeOfBitDepthExtensionWishes
    {
        ...
        public static int SizeOfBitDepth(this int bits) => AssertBits(bits) / 8;
        
        /// <inheritdoc cref="docs._quasisetter" />
        public static int SizeOfBitDepth(this int oldBits, int newByteSize) => AssertSizeOfBitDepth(newByteSize) * 8;
        ...
        /// <inheritdoc cref="docs._quasisetter" />
        [Obsolete(ObsoleteMessage)]
        public static SampleDataTypeEnum SizeOfBitDepth(this SampleDataTypeEnum oldEnumValue, int newByteSize) => (AssertSizeOfBitDepth(newByteSize) * 8).BitsToEnum();
        ...
        /// <inheritdoc cref="docs._quasisetter" />
        [Obsolete(ObsoleteMessage)]
        public static SampleDataType SizeOfBitDepth(this SampleDataType oldSampleDataType, int newByteSize, IContext context) => (AssertSizeOfBitDepth(newByteSize) * 8).BitsToEntity(context);
    ...
    public partial class ConfigWishes
    {
        ...
        public static int SizeOfBitDepth(int bits) => AssertBits(bits) / 8;
