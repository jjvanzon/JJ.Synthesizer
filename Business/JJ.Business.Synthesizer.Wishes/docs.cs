...
namespace JJ.Business.Synthesizer.Wishes
{
    internal struct docs
    {
        ...
        /// <summary>
        /// Manages note length configuration and fallback logic in audio synthesis.
        ...
        ///
        /// <para> <strong>Snapshot Functionality</strong> <br/>
        /// <see cref="SynthWishes.GetNoteLengthSnapShot">GetNoteLengthSnapShot</see> resolves dynamic note lengths <br/>
        /// for specific <paramref name="time"/> and <paramref name="channel"/> values. <br/>
        /// Ensures fixed lengths for buffer sizing and curve stretching. </para>
        ///
        /// <para> <strong>Members</strong> <br/>
        /// - <see cref="SynthWishes.GetNoteLength">GetNoteLength</see>: Resolves note length using the fallback logic. <br/>
        /// - <see cref="SynthWishes.WithNoteLength">WithNoteLength</see>: Sets note length as a <see cref="FlowNode">FlowNode</see> or <c>double</c>. <br/>
        /// - <see cref="SynthWishes.ResetNoteLength">ResetNoteLength</see>: Clears the note length, reverting to fallbacks. <br/>
        /// - <see cref="SynthWishes.GetNoteLengthSnapShot">GetNoteLengthSnapShot</see>: Captures a stable note length for a specific time and channel. </para>
        /// </summary>
