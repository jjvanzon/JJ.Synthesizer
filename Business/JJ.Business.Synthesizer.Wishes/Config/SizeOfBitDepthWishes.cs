...
namespace JJ.Business.Synthesizer.Wishes.Config
{
    ...
    public static class SizeOfBitDepthExtensionWishes
    {
        ...
        [UsedImplicitly] internal static ConfigResolver SizeOfBitDepth(this ConfigResolver obj, int? sizeOfBitDepth) => obj.Bits(sizeOfBitDepth.ToBits());
        ...
        [Obsolete(ObsoleteMessage)] public static SampleDataTypeEnum SizeOfBitDepth(this SampleDataTypeEnum oldEnumValue, int newByteSize) => newByteSize.Bits().BitsToEnum();
    ...
    public partial class ConfigWishes
    {
        ...
        public static Type SizeOfBitDepthToType(int value)
        {
            ...
            AssertSizeOfBitDepth(value, strict: false);
            return default;
        }
