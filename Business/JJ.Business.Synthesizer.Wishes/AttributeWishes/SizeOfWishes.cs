...
namespace JJ.Business.Synthesizer.Wishes.AttributeWishes
{
    ...
    public static partial class AttributeExtensionWishes
    {
        ...
        [Obsolete(ObsoleteEnumWishesMessages.ObsoleteMessage)] public static int SizeOfBitDepth(this SampleDataTypeEnum obj) => SampleDataTypeHelper.SizeOf(obj);
        /// <inheritdoc cref="docs._quasisetter" />
        // ReSharper disable once UnusedParameter.Global
        [Obsolete(ObsoleteEnumWishesMessages.ObsoleteMessage)] public static SampleDataTypeEnum SizeOfBitDepth(this SampleDataTypeEnum obj, int byteSize) => BitsToEnum(byteSize * 8);
        [Obsolete(ObsoleteEnumWishesMessages.ObsoleteMessage)] public static int SizeOfBitDepth(this SampleDataType obj) => SampleDataTypeHelper.SizeOf(obj);
        /// <inheritdoc cref="docs._quasisetter" />
        // ReSharper disable once UnusedParameter.Global
