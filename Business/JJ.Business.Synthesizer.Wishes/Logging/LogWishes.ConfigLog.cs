...
namespace JJ.Business.Synthesizer.Wishes.Logging
{
    ...
    {
        public   static string ConfigLog(this FlowNode        flowNode                                 ) => flowNode      .Logging.ConfigLog(       flowNode            );
        public   static string ConfigLog(this FlowNode        flowNode,        string title            ) => flowNode      .Logging.ConfigLog(title, flowNode            );
        public   static string ConfigLog(this FlowNode        flowNode,        string title, string sep) => flowNode      .Logging.ConfigLog(title, flowNode,        sep);
        public   static string ConfigLog(this Tape            tape                                     ) => tape          .Logging.ConfigLog(       tape                );
        public   static string ConfigLog(this Tape            tape,            string title            ) => tape          .Logging.ConfigLog(title, tape                );
        public   static string ConfigLog(this Tape            tape,            string title, string sep) => tape          .Logging.ConfigLog(title, tape,            sep);
        public   static string ConfigLog(this TapeConfig      tapeConfig                               ) => tapeConfig    .Logging.ConfigLog(       tapeConfig          );
        public   static string ConfigLog(this TapeActions     tapeActions                              ) => tapeActions   .Logging.ConfigLog(       tapeActions         );
        public   static string ConfigLog(this TapeActions     tapeActions,     string title            ) => tapeActions   .Logging.ConfigLog(title, tapeActions         );
        public   static string ConfigLog(this TapeActions     tapeActions,     string title, string sep) => tapeActions   .Logging.ConfigLog(title, tapeActions,     sep);
        public   static string ConfigLog(this TapeAction      tapeAction                               ) => tapeAction    .Logging.ConfigLog(       tapeAction          );
        public   static string ConfigLog(this TapeAction      tapeAction ,     string title            ) => tapeAction    .Logging.ConfigLog(title, tapeAction          );
        public   static string ConfigLog(this TapeAction      tapeAction ,     string title, string sep) => tapeAction    .Logging.ConfigLog(title, tapeAction,      sep);
        public   static string ConfigLog(this Buff            buff                                     ) => buff          .Logging.ConfigLog(       buff                );
        public   static string ConfigLog(this Buff            buff,            string title            ) => buff          .Logging.ConfigLog(title, buff                );
        public   static string ConfigLog(this Buff            buff,            string title, string sep) => buff          .Logging.ConfigLog(title, buff,            sep);
        internal static string ConfigLog(this ConfigResolver  configResolver                           ) => configResolver.Logging.ConfigLog(       configResolver      );
        internal static string ConfigLog(this ConfigResolver  configResolver,  string title            ) => configResolver.Logging.ConfigLog(title, configResolver      );
        internal static string ConfigLog(this ConfigResolver  configResolver,  string title, string sep) => configResolver.Logging.ConfigLog(title, configResolver,  sep);
        internal static string ConfigLog(this ConfigSection   configSection                                                     ) => configSection  .Logging(           ).ConfigLog(       configSection       );
        internal static string ConfigLog(this ConfigSection   configSection,                            string title            ) => configSection  .Logging(           ).ConfigLog(title, configSection       );
        internal static string ConfigLog(this ConfigSection   configSection,                            string title, string sep) => configSection  .Logging(           ).ConfigLog(title, configSection,   sep);
        internal static string ConfigLog(this ConfigSection   configSection,   SynthWishes synthWishes                          ) => configSection  .Logging(synthWishes).ConfigLog(       configSection       );
        internal static string ConfigLog(this ConfigSection   configSection,   SynthWishes synthWishes, string title            ) => configSection  .Logging(synthWishes).ConfigLog(title, configSection       );
        internal static string ConfigLog(this ConfigSection   configSection,   SynthWishes synthWishes, string title, string sep) => configSection  .Logging(synthWishes).ConfigLog(title, configSection,   sep);
        public   static string ConfigLog(this AudioFileOutput audioFileOutput                                                   ) => audioFileOutput.Logging(           ).ConfigLog(       audioFileOutput     );
        public   static string ConfigLog(this AudioFileOutput audioFileOutput,                          string title            ) => audioFileOutput.Logging(           ).ConfigLog(title, audioFileOutput     );
        public   static string ConfigLog(this AudioFileOutput audioFileOutput,                          string title, string sep) => audioFileOutput.Logging(           ).ConfigLog(title, audioFileOutput, sep);
        public   static string ConfigLog(this AudioFileOutput audioFileOutput, SynthWishes synthWishes                          ) => audioFileOutput.Logging(synthWishes).ConfigLog(       audioFileOutput     );
        public   static string ConfigLog(this AudioFileOutput audioFileOutput, SynthWishes synthWishes, string title            ) => audioFileOutput.Logging(synthWishes).ConfigLog(title, audioFileOutput     );
        public   static string ConfigLog(this AudioFileOutput audioFileOutput, SynthWishes synthWishes, string title, string sep) => audioFileOutput.Logging(synthWishes).ConfigLog(title, audioFileOutput, sep);
        public   static string ConfigLog(this Sample          sample                                                            ) => sample         .Logging(           ).ConfigLog(       sample              );
        public   static string ConfigLog(this Sample          sample,                                   string title            ) => sample         .Logging(           ).ConfigLog(title, sample              );
        public   static string ConfigLog(this Sample          sample,                                   string title, string sep) => sample         .Logging(           ).ConfigLog(title, sample,          sep);
        public   static string ConfigLog(this Sample          sample,          SynthWishes synthWishes                          ) => sample         .Logging(synthWishes).ConfigLog(       sample              );
        public   static string ConfigLog(this Sample          sample,          SynthWishes synthWishes, string title            ) => sample         .Logging(synthWishes).ConfigLog(title, sample              );
        public   static string ConfigLog(this Sample          sample,          SynthWishes synthWishes, string title, string sep) => sample         .Logging(synthWishes).ConfigLog(title, sample,          sep);
        public   static string ConfigLog(this AudioInfoWish   audioInfoWish                                                     ) => audioInfoWish  .Logging(           ).ConfigLog(       audioInfoWish       );
        public   static string ConfigLog(this AudioInfoWish   audioInfoWish,                            string title            ) => audioInfoWish  .Logging(           ).ConfigLog(title, audioInfoWish       );
        public   static string ConfigLog(this AudioInfoWish   audioInfoWish,                            string title, string sep) => audioInfoWish  .Logging(           ).ConfigLog(title, audioInfoWish,   sep);
        public   static string ConfigLog(this AudioInfoWish   audioInfoWish,   SynthWishes synthWishes                          ) => audioInfoWish  .Logging(synthWishes).ConfigLog(       audioInfoWish       );
        public   static string ConfigLog(this AudioInfoWish   audioInfoWish,   SynthWishes synthWishes, string title            ) => audioInfoWish  .Logging(synthWishes).ConfigLog(title, audioInfoWish       );
        public   static string ConfigLog(this AudioInfoWish   audioInfoWish,   SynthWishes synthWishes, string title, string sep) => audioInfoWish  .Logging(synthWishes).ConfigLog(title, audioInfoWish,   sep);
        public   static string ConfigLog(this AudioFileInfo   audioFileInfo                                                     ) => audioFileInfo  .Logging(           ).ConfigLog(       audioFileInfo       );
        public   static string ConfigLog(this AudioFileInfo   audioFileInfo,                            string title            ) => audioFileInfo  .Logging(           ).ConfigLog(title, audioFileInfo       );
        public   static string ConfigLog(this AudioFileInfo   audioFileInfo,                            string title, string sep) => audioFileInfo  .Logging(           ).ConfigLog(title, audioFileInfo,   sep);
        public   static string ConfigLog(this AudioFileInfo   audioFileInfo,   SynthWishes synthWishes                          ) => audioFileInfo  .Logging(synthWishes).ConfigLog(       audioFileInfo       );
        public   static string ConfigLog(this AudioFileInfo   audioFileInfo,   SynthWishes synthWishes, string title            ) => audioFileInfo  .Logging(synthWishes).ConfigLog(title, audioFileInfo       );
        public   static string ConfigLog(this AudioFileInfo   audioFileInfo,   SynthWishes synthWishes, string title, string sep) => audioFileInfo  .Logging(synthWishes).ConfigLog(title, audioFileInfo,   sep);
        public   static string ConfigLog(this WavHeaderStruct wavHeader                                                         ) => wavHeader      .Logging(           ).ConfigLog(       wavHeader           );
        public   static string ConfigLog(this WavHeaderStruct wavHeader,                                string title            ) => wavHeader      .Logging(           ).ConfigLog(title, wavHeader           );
        public   static string ConfigLog(this WavHeaderStruct wavHeader,                                string title, string sep) => wavHeader      .Logging(           ).ConfigLog(title, wavHeader,       sep);
        public   static string ConfigLog(this WavHeaderStruct wavHeader,       SynthWishes synthWishes                          ) => wavHeader      .Logging(synthWishes).ConfigLog(       wavHeader           );
        public   static string ConfigLog(this WavHeaderStruct wavHeader,       SynthWishes synthWishes, string title            ) => wavHeader      .Logging(synthWishes).ConfigLog(title, wavHeader           );
        public   static string ConfigLog(this WavHeaderStruct wavHeader,       SynthWishes synthWishes, string title, string sep) => wavHeader      .Logging(synthWishes).ConfigLog(title, wavHeader,       sep);
        
        public   static void   LogConfig(this FlowNode        flowNode                                 ) => flowNode      .Logging.LogConfig(       flowNode            );
        public   static void   LogConfig(this FlowNode        flowNode,        string title            ) => flowNode      .Logging.LogConfig(title, flowNode            );
        public   static void   LogConfig(this FlowNode        flowNode,        string title, string sep) => flowNode      .Logging.LogConfig(title, flowNode,        sep);
        public   static void   LogConfig(this Tape            tape                                     ) => tape          .Logging.LogConfig(       tape                );
        public   static void   LogConfig(this Tape            tape,            string title            ) => tape          .Logging.LogConfig(title, tape                );
        public   static void   LogConfig(this Tape            tape,            string title, string sep) => tape          .Logging.LogConfig(title, tape,            sep);
        public   static void   LogConfig(this TapeConfig      tapeConfig                               ) => tapeConfig    .Logging.LogConfig(       tapeConfig          );
        public   static void   LogConfig(this TapeActions     tapeActions                              ) => tapeActions   .Logging.LogConfig(       tapeActions         );
        public   static void   LogConfig(this TapeActions     tapeActions,     string title            ) => tapeActions   .Logging.LogConfig(title, tapeActions         );
        public   static void   LogConfig(this TapeActions     tapeActions,     string title, string sep) => tapeActions   .Logging.LogConfig(title, tapeActions,     sep);
        public   static void   LogConfig(this TapeAction      tapeAction                               ) => tapeAction    .Logging.LogConfig(       tapeAction          );
        public   static void   LogConfig(this TapeAction      tapeAction ,     string title            ) => tapeAction    .Logging.LogConfig(title, tapeAction          );
        public   static void   LogConfig(this TapeAction      tapeAction ,     string title, string sep) => tapeAction    .Logging.LogConfig(title, tapeAction,      sep);
        public   static void   LogConfig(this Buff            buff                                     ) => buff          .Logging.LogConfig(       buff                );
        public   static void   LogConfig(this Buff            buff,            string title            ) => buff          .Logging.LogConfig(title, buff                );
        public   static void   LogConfig(this Buff            buff,            string title, string sep) => buff          .Logging.LogConfig(title, buff,            sep);
        internal static void   LogConfig(this ConfigResolver  configResolver                           ) => configResolver.Logging.LogConfig(       configResolver      );
        internal static void   LogConfig(this ConfigResolver  configResolver,  string title            ) => configResolver.Logging.LogConfig(title, configResolver      );
        internal static void   LogConfig(this ConfigResolver  configResolver,  string title, string sep) => configResolver.Logging.LogConfig(title, configResolver,  sep);
        internal static void   LogConfig(this ConfigSection   configSection                                                     ) => configSection  .Logging(           ).LogConfig(       configSection       );
        internal static void   LogConfig(this ConfigSection   configSection,                            string title            ) => configSection  .Logging(           ).LogConfig(title, configSection       );
        internal static void   LogConfig(this ConfigSection   configSection,                            string title, string sep) => configSection  .Logging(           ).LogConfig(title, configSection,   sep);
        internal static void   LogConfig(this ConfigSection   configSection,   SynthWishes synthWishes                          ) => configSection  .Logging(synthWishes).LogConfig(       configSection       );
        internal static void   LogConfig(this ConfigSection   configSection,   SynthWishes synthWishes, string title            ) => configSection  .Logging(synthWishes).LogConfig(title, configSection       );
        internal static void   LogConfig(this ConfigSection   configSection,   SynthWishes synthWishes, string title, string sep) => configSection  .Logging(synthWishes).LogConfig(title, configSection,   sep);
        public   static void   LogConfig(this AudioFileOutput audioFileOutput                                                   ) => audioFileOutput.Logging(           ).LogConfig(       audioFileOutput     );
        public   static void   LogConfig(this AudioFileOutput audioFileOutput,                          string title            ) => audioFileOutput.Logging(           ).LogConfig(title, audioFileOutput     );
        public   static void   LogConfig(this AudioFileOutput audioFileOutput,                          string title, string sep) => audioFileOutput.Logging(           ).LogConfig(title, audioFileOutput, sep);
        public   static void   LogConfig(this AudioFileOutput audioFileOutput, SynthWishes synthWishes                          ) => audioFileOutput.Logging(synthWishes).LogConfig(       audioFileOutput     );
        public   static void   LogConfig(this AudioFileOutput audioFileOutput, SynthWishes synthWishes, string title            ) => audioFileOutput.Logging(synthWishes).LogConfig(title, audioFileOutput     );
        public   static void   LogConfig(this AudioFileOutput audioFileOutput, SynthWishes synthWishes, string title, string sep) => audioFileOutput.Logging(synthWishes).LogConfig(title, audioFileOutput, sep);
        public   static void   LogConfig(this Sample          sample                                                            ) => sample         .Logging(           ).LogConfig(       sample              );
        public   static void   LogConfig(this Sample          sample,                                   string title            ) => sample         .Logging(           ).LogConfig(title, sample              );
        public   static void   LogConfig(this Sample          sample,                                   string title, string sep) => sample         .Logging(           ).LogConfig(title, sample,          sep);
        public   static void   LogConfig(this Sample          sample,          SynthWishes synthWishes                          ) => sample         .Logging(synthWishes).LogConfig(       sample              );
        public   static void   LogConfig(this Sample          sample,          SynthWishes synthWishes, string title            ) => sample         .Logging(synthWishes).LogConfig(title, sample              );
        public   static void   LogConfig(this Sample          sample,          SynthWishes synthWishes, string title, string sep) => sample         .Logging(synthWishes).LogConfig(title, sample,          sep);
        public   static void   LogConfig(this AudioInfoWish   audioInfoWish                                                     ) => audioInfoWish  .Logging(           ).LogConfig(       audioInfoWish       );
        public   static void   LogConfig(this AudioInfoWish   audioInfoWish,                            string title            ) => audioInfoWish  .Logging(           ).LogConfig(title, audioInfoWish       );
        public   static void   LogConfig(this AudioInfoWish   audioInfoWish,                            string title, string sep) => audioInfoWish  .Logging(           ).LogConfig(title, audioInfoWish,   sep);
        public   static void   LogConfig(this AudioInfoWish   audioInfoWish,   SynthWishes synthWishes                          ) => audioInfoWish  .Logging(synthWishes).LogConfig(       audioInfoWish       );
        public   static void   LogConfig(this AudioInfoWish   audioInfoWish,   SynthWishes synthWishes, string title            ) => audioInfoWish  .Logging(synthWishes).LogConfig(title, audioInfoWish       );
        public   static void   LogConfig(this AudioInfoWish   audioInfoWish,   SynthWishes synthWishes, string title, string sep) => audioInfoWish  .Logging(synthWishes).LogConfig(title, audioInfoWish,   sep);
        public   static void   LogConfig(this AudioFileInfo   audioFileInfo                                                     ) => audioFileInfo  .Logging(           ).LogConfig(       audioFileInfo       );
        public   static void   LogConfig(this AudioFileInfo   audioFileInfo,                            string title            ) => audioFileInfo  .Logging(           ).LogConfig(title, audioFileInfo       );
        public   static void   LogConfig(this AudioFileInfo   audioFileInfo,                            string title, string sep) => audioFileInfo  .Logging(           ).LogConfig(title, audioFileInfo,   sep);
        public   static void   LogConfig(this AudioFileInfo   audioFileInfo,   SynthWishes synthWishes                          ) => audioFileInfo  .Logging(synthWishes).LogConfig(       audioFileInfo       );
        public   static void   LogConfig(this AudioFileInfo   audioFileInfo,   SynthWishes synthWishes, string title            ) => audioFileInfo  .Logging(synthWishes).LogConfig(title, audioFileInfo       );
        public   static void   LogConfig(this AudioFileInfo   audioFileInfo,   SynthWishes synthWishes, string title, string sep) => audioFileInfo  .Logging(synthWishes).LogConfig(title, audioFileInfo,   sep);
        public   static void   LogConfig(this WavHeaderStruct wavHeader                                                         ) => wavHeader      .Logging(           ).LogConfig(       wavHeader           );
        public   static void   LogConfig(this WavHeaderStruct wavHeader,                                string title            ) => wavHeader      .Logging(           ).LogConfig(title, wavHeader           );
        public   static void   LogConfig(this WavHeaderStruct wavHeader,                                string title, string sep) => wavHeader      .Logging(           ).LogConfig(title, wavHeader,       sep);
        public   static void   LogConfig(this WavHeaderStruct wavHeader,       SynthWishes synthWishes                          ) => wavHeader      .Logging(synthWishes).LogConfig(       wavHeader           );
        public   static void   LogConfig(this WavHeaderStruct wavHeader,       SynthWishes synthWishes, string title            ) => wavHeader      .Logging(synthWishes).LogConfig(title, wavHeader           );
        public   static void   LogConfig(this WavHeaderStruct wavHeader,       SynthWishes synthWishes, string title, string sep) => wavHeader      .Logging(synthWishes).LogConfig(title, wavHeader,       sep);
    }
}
