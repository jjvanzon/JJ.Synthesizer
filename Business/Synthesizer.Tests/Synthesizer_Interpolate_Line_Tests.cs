...
namespace JJ.Business.Synthesizer.Tests
{
    ...
    public class Synthesizer_Interpolate_Line_Tests : Synthesizer_Interpolate_Tests_Base
    {
        ...
        [TestMethod]
        public void Test_Synthesizer_Interpolate_Line_LagBehind_Backward_WithCalculatorClasses()
            => Test_Synthesizer_Interpolate_Line_LagBehind_Backward(CalculationEngineEnum.CalculatorClasses);

        private void Test_Synthesizer_Interpolate_Line_LagBehind_Backward(CalculationEngineEnum calculationEngineEnum)
        {
            double y0 = Math.Sin(Math.PI * 09 / 12);
