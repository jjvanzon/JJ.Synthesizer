...
{
    public class AllPassFilter_OperatorWrapper : OperatorWrapperBase
    {
        ...
        public static implicit operator Outlet(AllPassFilter_OperatorWrapper wrapper) => wrapper?.Result;
    }
}