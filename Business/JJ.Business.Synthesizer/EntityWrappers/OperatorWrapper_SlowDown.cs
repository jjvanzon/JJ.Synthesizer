...
{
    public class OperatorWrapper_SlowDown : OperatorWrapperBase
    {
        public OperatorWrapper_SlowDown(Operator op)
            : base(op)
        { }
        ...
        public static implicit operator Outlet(OperatorWrapper_SlowDown wrapper)
        {
