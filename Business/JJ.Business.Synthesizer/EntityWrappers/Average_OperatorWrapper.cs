...
namespace JJ.Business.Synthesizer.EntityWrappers
{
    public class Average_OperatorWrapper : OperatorWrapperBase
    {
        ...
        {
            get { return OperatorHelper.GetInputOutlet(_wrappedOperator, OperatorConstants.AVERAGE_SIGNAL_INDEX); }
            set { OperatorHelper.GetInlet(_wrappedOperator, OperatorConstants.AVERAGE_SIGNAL_INDEX).LinkTo(value); }
        }

        public Outlet Result
        {
            get { return OperatorHelper.GetOutlet(_wrappedOperator, OperatorConstants.AVERAGE_RESULT_INDEX); }
        }
