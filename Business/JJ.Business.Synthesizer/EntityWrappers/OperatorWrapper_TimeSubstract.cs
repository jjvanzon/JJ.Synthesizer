...
{
    public class OperatorWrapper_TimeSubstract : OperatorWrapperBase
    {
        public OperatorWrapper_TimeSubstract(Operator op)
            : base(op)
        { }
        ...
        public static implicit operator Outlet(OperatorWrapper_TimeSubstract wrapper)
        {
