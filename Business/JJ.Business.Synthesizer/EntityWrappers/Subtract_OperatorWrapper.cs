...
namespace JJ.Business.Synthesizer.EntityWrappers
{
    public class Subtract_OperatorWrapper : OperatorWrapperBase
    {
        ...
        {
            get { return OperatorHelper.GetInputOutlet(_operator, OperatorConstants.SUBTRACT_OPERAND_A_INDEX); }
            set { OperatorHelper.GetInlet(_operator, OperatorConstants.SUBTRACT_OPERAND_A_INDEX).LinkTo(value); }
        }

        public Outlet OperandB
        {
            get { return OperatorHelper.GetInputOutlet(_operator, OperatorConstants.SUBTRACT_OPERAND_B_INDEX); }
