...
{
    public class OperatorWrapper_SpeedUp : OperatorWrapperBase
    {
        public OperatorWrapper_SpeedUp(Operator op)
            : base(op)
        { }
        ...
        public static implicit operator Outlet(OperatorWrapper_SpeedUp wrapper)
        {
