...
{
    internal abstract class OperatorWarningValidator_Base_AnyInletsFilledIn : FluentValidator<Operator>
    {
        public OperatorWarningValidator_Base_AnyInletsFilledIn(Operator obj)
            : base(obj)
        { }
