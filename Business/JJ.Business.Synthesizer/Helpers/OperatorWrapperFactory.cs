...
namespace JJ.Business.Synthesizer.Helpers
{
    public static class OperatorWrapperFactory
    {
                   ...
                   new Dictionary<OperatorTypeEnum, Func<Operator, OperatorWrapperBase>>
        {
            ...
            { OperatorTypeEnum.RangeOverDimension, Create_Range_OperatorWrapper },
        ...
        private static RangeOverDimension_OperatorWrapper Create_Range_OperatorWrapper(Operator op) { return new RangeOverDimension_OperatorWrapper(op); }
