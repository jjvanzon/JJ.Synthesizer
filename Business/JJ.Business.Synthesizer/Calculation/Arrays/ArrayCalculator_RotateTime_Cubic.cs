...
{
    internal class ArrayCalculator_RotateTime_Cubic : ArrayCalculatorBase_Cubic
    {
        public ArrayCalculator_RotateTime_Cubic(double[] array, double rate, double minTime) 
            : base(array, rate, minTime)
        { }

        public ArrayCalculator_RotateTime_Cubic(
