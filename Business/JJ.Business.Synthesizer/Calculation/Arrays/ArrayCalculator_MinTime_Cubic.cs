...
{
    internal class ArrayCalculator_MinTime_Cubic : ArrayCalculatorBase_Cubic
    {
        public ArrayCalculator_MinTime_Cubic(double[] array, double rate, double minTime)
            : base(array, rate, minTime)
        { }

        public ArrayCalculator_MinTime_Cubic(
