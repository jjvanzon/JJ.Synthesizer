...
{
    internal class ArrayCalculator_Line_MinTime_Channels : ArrayCalculatorBase_MinTime_Channels
    {
        private const int EXTRA_TIME_TICK_COUNT = 1;

        public ArrayCalculator_Line_MinTime_Channels(double[,] array, double rate, double minTime)
            : base(array, rate, minTime, EXTRA_TIME_TICK_COUNT)
        { }

        public ArrayCalculator_Line_MinTime_Channels(
            double[,] array,
            double valueBefore,
            double valueAfter,
            double rate,
