...
{
    internal class ArrayCalculator_MinTime_Hermite : ArrayCalculatorBase_Hermite
    {
        public ArrayCalculator_MinTime_Hermite(double[] array, double rate, double minTime)
            : base(array, rate, minTime)
        { }

        public ArrayCalculator_MinTime_Hermite(
