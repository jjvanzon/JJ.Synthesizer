    ...
    internal partial class OptimizedPatchCalculatorVisitor
    {
	    private OperatorCalculatorBase CreateMultiplyCalculatorWithConst(double constValue, IList<OperatorCalculatorBase> varOperandCalculators)
        {
            ...
            switch (varOperandCalculators.Count)
            {
                ...
                case 16:
                    return new Multiply_OperatorCalculator_1Const_16Var
					(
						constValue,
						varOperandCalculators[0],
						varOperandCalculators[1],
                ...
                case 17:
                    return new Multiply_OperatorCalculator_1Const_17Var
					(
						constValue,
						varOperandCalculators[0],
						varOperandCalculators[1],
                ...
                case 18:
                    return new Multiply_OperatorCalculator_1Const_18Var
					(
						constValue,
						varOperandCalculators[0],
						varOperandCalculators[1],
                ...
                case 19:
                    return new Multiply_OperatorCalculator_1Const_19Var
					(
						constValue,
						varOperandCalculators[0],
						varOperandCalculators[1],
                ...
                case 20:
                    return new Multiply_OperatorCalculator_1Const_20Var
					(
						constValue,
						varOperandCalculators[0],
						varOperandCalculators[1],
                ...
                case 21:
                    return new Multiply_OperatorCalculator_1Const_21Var
					(
						constValue,
						varOperandCalculators[0],
						varOperandCalculators[1],
                ...
                case 22:
                    return new Multiply_OperatorCalculator_1Const_22Var
					(
						constValue,
						varOperandCalculators[0],
						varOperandCalculators[1],
                ...
                case 23:
                    return new Multiply_OperatorCalculator_1Const_23Var
					(
						constValue,
						varOperandCalculators[0],
						varOperandCalculators[1],
                ...
                case 24:
                    return new Multiply_OperatorCalculator_1Const_24Var
					(
						constValue,
						varOperandCalculators[0],
						varOperandCalculators[1],
                ...
                case 25:
                    return new Multiply_OperatorCalculator_1Const_25Var
					(
						constValue,
						varOperandCalculators[0],
						varOperandCalculators[1],
                ...
                case 26:
                    return new Multiply_OperatorCalculator_1Const_26Var
					(
						constValue,
						varOperandCalculators[0],
						varOperandCalculators[1],
                ...
                case 27:
                    return new Multiply_OperatorCalculator_1Const_27Var
					(
						constValue,
						varOperandCalculators[0],
						varOperandCalculators[1],
                ...
                case 28:
                    return new Multiply_OperatorCalculator_1Const_28Var
					(
						constValue,
						varOperandCalculators[0],
						varOperandCalculators[1],
                ...
                case 29:
                    return new Multiply_OperatorCalculator_1Const_29Var
					(
						constValue,
						varOperandCalculators[0],
						varOperandCalculators[1],
                ...
                case 30:
                    return new Multiply_OperatorCalculator_1Const_30Var
					(
						constValue,
						varOperandCalculators[0],
						varOperandCalculators[1],
                ...
                case 31:
                    return new Multiply_OperatorCalculator_1Const_31Var
					(
						constValue,
						varOperandCalculators[0],
						varOperandCalculators[1],
