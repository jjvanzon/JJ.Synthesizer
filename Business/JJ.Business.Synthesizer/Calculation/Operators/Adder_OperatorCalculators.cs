...
,					operandCalculator3
			...
			{
				return 
						_operandCalculator1.Calculate(dimensionStack)
+						_operandCalculator2.Calculate(dimensionStack)
+						_operandCalculator3.Calculate(dimensionStack)
;
			}
		}
...
+						_operandCalculator2.Calculate(dimensionStack)
+						_operandCalculator3.Calculate(dimensionStack)
+						_operandCalculator4.Calculate(dimensionStack)
;
			}
		}
...
+						_operandCalculator3.Calculate(dimensionStack)
+						_operandCalculator4.Calculate(dimensionStack)
+						_operandCalculator5.Calculate(dimensionStack)
;
			}
		}
...
+						_operandCalculator4.Calculate(dimensionStack)
+						_operandCalculator5.Calculate(dimensionStack)
+						_operandCalculator6.Calculate(dimensionStack)
;
			}
		}
...
+						_operandCalculator5.Calculate(dimensionStack)
+						_operandCalculator6.Calculate(dimensionStack)
+						_operandCalculator7.Calculate(dimensionStack)
;
			}
		}
...
+						_operandCalculator6.Calculate(dimensionStack)
+						_operandCalculator7.Calculate(dimensionStack)
+						_operandCalculator8.Calculate(dimensionStack)
;
			}
		}
...
+						_operandCalculator7.Calculate(dimensionStack)
+						_operandCalculator8.Calculate(dimensionStack)
+						_operandCalculator9.Calculate(dimensionStack)
;
			}
		}
...
+						_operandCalculator8.Calculate(dimensionStack)
+						_operandCalculator9.Calculate(dimensionStack)
+						_operandCalculator10.Calculate(dimensionStack)
;
			}
		}
...
+						_operandCalculator9.Calculate(dimensionStack)
+						_operandCalculator10.Calculate(dimensionStack)
+						_operandCalculator11.Calculate(dimensionStack)
;
			}
		}
...
+						_operandCalculator10.Calculate(dimensionStack)
+						_operandCalculator11.Calculate(dimensionStack)
+						_operandCalculator12.Calculate(dimensionStack)
;
			}
		}
...
+						_operandCalculator11.Calculate(dimensionStack)
+						_operandCalculator12.Calculate(dimensionStack)
+						_operandCalculator13.Calculate(dimensionStack)
;
			}
		}
...
+						_operandCalculator12.Calculate(dimensionStack)
+						_operandCalculator13.Calculate(dimensionStack)
+						_operandCalculator14.Calculate(dimensionStack)
;
			}
		}
...
+						_operandCalculator13.Calculate(dimensionStack)
+						_operandCalculator14.Calculate(dimensionStack)
+						_operandCalculator15.Calculate(dimensionStack)
;
			}
		}
...
+						_operandCalculator14.Calculate(dimensionStack)
+						_operandCalculator15.Calculate(dimensionStack)
+						_operandCalculator16.Calculate(dimensionStack)
;
			}
		}
...
+						_operandCalculator15.Calculate(dimensionStack)
+						_operandCalculator16.Calculate(dimensionStack)
+						_operandCalculator17.Calculate(dimensionStack)
;
			}
		}
...
+						_operandCalculator16.Calculate(dimensionStack)
+						_operandCalculator17.Calculate(dimensionStack)
+						_operandCalculator18.Calculate(dimensionStack)
;
			}
		}
...
+						_operandCalculator17.Calculate(dimensionStack)
+						_operandCalculator18.Calculate(dimensionStack)
+						_operandCalculator19.Calculate(dimensionStack)
;
			}
		}
...
+						_operandCalculator18.Calculate(dimensionStack)
+						_operandCalculator19.Calculate(dimensionStack)
+						_operandCalculator20.Calculate(dimensionStack)
;
			}
		}
...
+						_operandCalculator19.Calculate(dimensionStack)
+						_operandCalculator20.Calculate(dimensionStack)
+						_operandCalculator21.Calculate(dimensionStack)
;
			}
		}
...
+						_operandCalculator20.Calculate(dimensionStack)
+						_operandCalculator21.Calculate(dimensionStack)
+						_operandCalculator22.Calculate(dimensionStack)
;
			}
		}
...
+						_operandCalculator21.Calculate(dimensionStack)
+						_operandCalculator22.Calculate(dimensionStack)
+						_operandCalculator23.Calculate(dimensionStack)
;
			}
		}
...
+						_operandCalculator22.Calculate(dimensionStack)
+						_operandCalculator23.Calculate(dimensionStack)
+						_operandCalculator24.Calculate(dimensionStack)
;
			}
		}
...
+						_operandCalculator23.Calculate(dimensionStack)
+						_operandCalculator24.Calculate(dimensionStack)
+						_operandCalculator25.Calculate(dimensionStack)
;
			}
		}
...
+						_operandCalculator24.Calculate(dimensionStack)
+						_operandCalculator25.Calculate(dimensionStack)
+						_operandCalculator26.Calculate(dimensionStack)
;
			}
		}
...
+						_operandCalculator25.Calculate(dimensionStack)
+						_operandCalculator26.Calculate(dimensionStack)
+						_operandCalculator27.Calculate(dimensionStack)
;
			}
		}
...
+						_operandCalculator26.Calculate(dimensionStack)
+						_operandCalculator27.Calculate(dimensionStack)
+						_operandCalculator28.Calculate(dimensionStack)
;
			}
		}
...
+						_operandCalculator27.Calculate(dimensionStack)
+						_operandCalculator28.Calculate(dimensionStack)
+						_operandCalculator29.Calculate(dimensionStack)
;
			}
		}
...
+						_operandCalculator28.Calculate(dimensionStack)
+						_operandCalculator29.Calculate(dimensionStack)
+						_operandCalculator30.Calculate(dimensionStack)
;
			}
		}
...
+						_operandCalculator29.Calculate(dimensionStack)
+						_operandCalculator30.Calculate(dimensionStack)
+						_operandCalculator31.Calculate(dimensionStack)
;
			}
		}
...
+						_operandCalculator30.Calculate(dimensionStack)
+						_operandCalculator31.Calculate(dimensionStack)
+						_operandCalculator32.Calculate(dimensionStack)
;
			}
		}
}
