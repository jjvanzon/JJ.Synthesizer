...
{
    internal class GreaterThanOrEqual_VarA_VarB_OperatorCalculator : OperatorCalculatorBase_WithChildCalculators
    {
        private readonly OperatorCalculatorBase _calculatorA;
        private readonly OperatorCalculatorBase _calculatorB;

        public GreaterThanOrEqual_VarA_VarB_OperatorCalculator(
    ...
    internal class GreaterThanOrEqual_VarA_ConstB_OperatorCalculator : OperatorCalculatorBase_WithChildCalculators
    {
        private readonly OperatorCalculatorBase _calculatorA;
    ...
    internal class GreaterThanOrEqual_ConstA_VarB_OperatorCalculator : OperatorCalculatorBase_WithChildCalculators
    {
