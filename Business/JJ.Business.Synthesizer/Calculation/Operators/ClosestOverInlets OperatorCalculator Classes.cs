...
{
    internal class ClosestOverInlets_OperatorCalculator_AllVars : OperatorCalculatorBase_WithChildCalculators
    {
        ...
        public ClosestOverInlets_OperatorCalculator_AllVars(
