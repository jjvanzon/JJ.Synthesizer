...
{
    internal class Add_WithConstOperandA_Calculator : OperatorCalculatorBase
    {
        private double _operandAValue;
        private OperatorCalculatorBase _operandBCalculator;

        public Add_WithConstOperandA_Calculator(double operandAValue, OperatorCalculatorBase operandBCalculator)
        {
