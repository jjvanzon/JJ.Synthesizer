...
{
    internal class TimeDivide_WithOrigin_WithConstTimeDivider_Calculator : OperatorCalculatorBase
    {
        private OperatorCalculatorBase _signalCalculator;
        private double _timeDividerValue;
        private OperatorCalculatorBase _originCalculator;

        public TimeDivide_WithOrigin_WithConstTimeDivider_Calculator(
