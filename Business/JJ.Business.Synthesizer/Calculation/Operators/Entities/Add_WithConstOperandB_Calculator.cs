...
{
    internal class Add_WithConstOperandB_Calculator : OperatorCalculatorBase
    {
        private OperatorCalculatorBase _operandACalculator;
        private double _operandBValue;

        public Add_WithConstOperandB_Calculator(OperatorCalculatorBase operandACalculator, double operandBValue)
        {
