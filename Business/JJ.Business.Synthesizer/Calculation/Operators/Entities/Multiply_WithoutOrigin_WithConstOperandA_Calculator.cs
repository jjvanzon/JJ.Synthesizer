...
{
    internal class Multiply_WithoutOrigin_WithConstOperandA_Calculator : OperatorCalculatorBase
    {
        private double _operandAValue;
        private OperatorCalculatorBase _operandBCalculator;

        public Multiply_WithoutOrigin_WithConstOperandA_Calculator(double operandValue, OperatorCalculatorBase operandBCalculator)
        {
