...
{
    internal class Pulse_OperatorCalculator_ConstFrequency_HalfWidth_WithOriginShifting : OperatorCalculatorBase
    {
        ...
        public Pulse_OperatorCalculator_ConstFrequency_HalfWidth_WithOriginShifting(
            double frequency,
    ...
    internal class Pulse_OperatorCalculator_VarFrequency_HalfWidth_WithPhaseTracking : OperatorCalculatorBase_WithChildCalculators
    {
        ...
        public Pulse_OperatorCalculator_VarFrequency_HalfWidth_WithPhaseTracking(
    ...
    internal class Pulse_OperatorCalculator_ConstFrequency_HalfWidth_NoOriginShifting : OperatorCalculatorBase
    {
        private readonly double _frequency;
        private readonly DimensionStack _dimensionStack;
        private readonly int _dimensionStackIndex;

        public Pulse_OperatorCalculator_ConstFrequency_HalfWidth_NoOriginShifting(
            double frequency,
            DimensionStack dimensionStack)
        {
            OperatorCalculatorHelper.AssertFrequency(frequency);
    ...
    internal class Pulse_OperatorCalculator_VarFrequency_HalfWidth_NoPhaseTracking : OperatorCalculatorBase_WithChildCalculators
    {
        private readonly OperatorCalculatorBase _frequencyCalculator;
        private readonly DimensionStack _dimensionStack;
        private readonly int _dimensionStackIndex;

        public Pulse_OperatorCalculator_VarFrequency_HalfWidth_NoPhaseTracking(
            OperatorCalculatorBase frequencyCalculator,
            DimensionStack dimensionStack)
            : base(new OperatorCalculatorBase[] { frequencyCalculator })
        {
