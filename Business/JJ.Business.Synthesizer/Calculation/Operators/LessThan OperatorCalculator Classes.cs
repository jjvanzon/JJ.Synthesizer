...
{
    internal class LessThan_VarA_VarB_OperatorCalculator : OperatorCalculatorBase_WithChildCalculators
    {
        private readonly OperatorCalculatorBase _calculatorA;
        private readonly OperatorCalculatorBase _calculatorB;

        public LessThan_VarA_VarB_OperatorCalculator(
    ...
    internal class LessThan_VarA_ConstB_OperatorCalculator : OperatorCalculatorBase_WithChildCalculators
    {
        private readonly OperatorCalculatorBase _calculatorA;
        private readonly double _b;

        public LessThan_VarA_ConstB_OperatorCalculator(OperatorCalculatorBase calculatorA, double b)
    ...
    internal class LessThan_ConstA_VarB_OperatorCalculator : OperatorCalculatorBase_WithChildCalculators
    {
        private readonly double _a;
        private readonly OperatorCalculatorBase _calculatorB;

        public LessThan_ConstA_VarB_OperatorCalculator(double a, OperatorCalculatorBase calculatorB)
