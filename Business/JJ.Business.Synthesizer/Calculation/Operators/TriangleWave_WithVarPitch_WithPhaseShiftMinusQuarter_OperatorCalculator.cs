...
{
    internal class TriangleWave_WithVarPitch_WithPhaseShiftMinusQuarter_OperatorCalculator : OperatorCalculatorBase
    {
        private readonly OperatorCalculatorBase _pitchCalculator;
        private double _phase;
        private double _previousTime;

        public TriangleWave_WithVarPitch_WithPhaseShiftMinusQuarter_OperatorCalculator(OperatorCalculatorBase pitchCalculator)
        {
