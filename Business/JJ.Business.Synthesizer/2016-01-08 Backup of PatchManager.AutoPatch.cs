...
//            PatchInlet_OperatorWrapper noteStartPatchInletWrapper = null;
...
//                // TODO: Enumerate the inlets of CustomOperator instead.
//                var sourcePatchInletWrappers = monophonicAutoPatch.EnumerateOperatorWrappersOfType<PatchInlet_OperatorWrapper>();

//                foreach (PatchInlet_OperatorWrapper monophonicPatchInletWrapper in sourcePatchInletWrappers)
//                {
//                    InletTypeEnum inletTypeEnum = monophonicPatchInletWrapper.Inlet.GetInletTypeEnum();
//                    if (inletTypeEnum != InletTypeEnum.Undefined)
//                    {
//                        Inlet customOperatorInlet = customOperatorWrapper.Inlets.Where(x => x.GetInletTypeEnum() == inletTypeEnum).SingleOrDefault();
//                        if (customOperatorInlet != null)
//                        {
//                            PatchInlet_OperatorWrapper polyphonicPatchInletWrapper = PatchInlet(inletTypeEnum);
//                            polyphonicPatchInletWrapper.Name = String.Format("{0} {1}", inletTypeEnum, i);

//                            customOperatorInlet.LinkTo((Outlet)polyphonicPatchInletWrapper);

//                            if (inletTypeEnum == InletTypeEnum.NoteStart)
//                            {
//                                noteStartPatchInletWrapper = polyphonicPatchInletWrapper;
//                            }
//                        }
//                    }
//                }
...
//                    if (noteStartPatchInletWrapper == null)
//                    {
//                        noteStartPatchInletWrapper = PatchInlet(InletTypeEnum.NoteStart);
...
//                    else
//                    {
//                        monophonicOutlets.Add(noteStartPatchInletWrapper);
//                    }
//                }
//            }
