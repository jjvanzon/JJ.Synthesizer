...
namespace JJ.Data.Synthesizer.NHibernate
{
	...
	/// </summary>
	[UsedImplicitly]
	public class SynthesizerNHibernateContext : NHibernateContext
	{
		public SynthesizerNHibernateContext(string connectionString, Assembly modelAssembly, Assembly mappingAssembly, string dialect)
