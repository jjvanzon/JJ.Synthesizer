    ...
    internal static partial class ToViewModelHelper
    {
        ...
        public static AutoPatchPopupViewModel CreateEmptyAutoPatchViewModel()
        {
            var viewModel = new AutoPatchPopupViewModel
            {
                ...
                OperatorPropertiesDictionary_WithCollectionRecalculation =
                    new Dictionary<int, OperatorPropertiesViewModel_WithCollectionRecalculation>(),
                ValidationMessages = new List<string>(),
                Successful = true
            };
        ...
        public static DocumentViewModel CreateEmptyDocumentViewModel()
        {
            var viewModel = new DocumentViewModel
            {
                ...
                TopButtonBar = CreateEmptyTopButtonBarViewModel(),
        ...
        private static MonitoringBarMidiViewModel CreateEmptyMonitoringBarMidiViewModel()
        {
            ...
            {
                Controller = CreateEmptyMonitoringItemViewModel(),
                Channel = CreateEmptyMonitoringItemViewModel(),
                Velocity = CreateEmptyMonitoringItemViewModel(),
                NoteNumber = CreateEmptyMonitoringItemViewModel(),
                IsEmpty = true
            };
        ...
        private static MonitoringItemViewModel CreateEmptyMonitoringItemViewModel() => new MonitoringItemViewModel();
        ...
        public static SaveChangesPopupViewModel CreateEmptySaveChangesPopupViewModel()
            => new SaveChangesPopupViewModel
            {
                ValidationMessages = new List<string>()
            };

        public static TopButtonBarViewModel CreateEmptyTopButtonBarViewModel()
        {
            var viewModel = new TopButtonBarViewModel
            {
                ValidationMessages = new List<string>(),
                Successful = true
            };
