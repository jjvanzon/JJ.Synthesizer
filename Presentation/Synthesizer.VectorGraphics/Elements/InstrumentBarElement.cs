...
namespace JJ.Presentation.Synthesizer.VectorGraphics.Elements
{
    public class InstrumentBarElement : ElementBaseWithScreenViewModel
    {
        ...
        public InstrumentBarElement(Element parent, UnderlyingPictureWrapper underlyingPictureWrapper, ITextMeasurer textMeasurer) : base(parent)
        {
            ...
            _buttonsElement = new InstrumentBarButtonsElement(
                this,
                toolTipElement,
