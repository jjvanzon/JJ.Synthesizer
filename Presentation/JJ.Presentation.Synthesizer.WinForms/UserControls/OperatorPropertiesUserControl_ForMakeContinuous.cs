...
namespace JJ.Presentation.Synthesizer.WinForms.UserControls
{
        ...
        : OperatorPropertiesUserControl_ForMakeContinuous_NotDesignable
    {
        ...
        private void OperatorPropertiesUserControl_ForMakeContinuous_Load(object sender, EventArgs e)
        {
            ApplyStyling();
        }
        ...
        private void OperatorPropertiesUserControl_ForMakeContinuous_Leave(object sender, EventArgs e)
        {
    ...
    internal class OperatorPropertiesUserControl_ForMakeContinuous_NotDesignable
        : UserControlBase<OperatorPropertiesViewModel_ForMakeContinuous>
    {
        protected override void ApplyViewModelToControls()
        {
