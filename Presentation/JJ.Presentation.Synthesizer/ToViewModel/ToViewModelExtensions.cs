    ...
    internal static class ToViewModelExtensions
    {
            ...
            EntityPositionManager entityPositionManager)
        {
            ...
            var viewModel = new DocumentViewModel
            {
                ...
                Instruments = document.Instruments.Select(x => x.ToChildDocumentViewModel(audioFileFormatRepository, sampleDataTypeRepository, speakerSetupRepository, interpolationTypeRepository, nodeTypeRepository, entityPositionManager)).ToList(),
                ...
                Effects = document.Effects.Select(x => x.ToChildDocumentViewModel(audioFileFormatRepository, sampleDataTypeRepository, speakerSetupRepository, interpolationTypeRepository, nodeTypeRepository, entityPositionManager)).ToList(),
