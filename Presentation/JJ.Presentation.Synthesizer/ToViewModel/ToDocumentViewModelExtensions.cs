    ...
    internal static class ToDocumentViewModelExtensions
    {
            ...
            EntityPositionManager entityPositionManager)
        {
            ...
            var viewModel = new PatchDocumentViewModel
            {
                ...
                OperatorPropertiesList_ForPatchOutlets = childDocument.Patches.SelectMany(x => x.ToPropertiesViewModelList_ForPatchOutlets(repositories.DimensionRepository)).ToList(),
