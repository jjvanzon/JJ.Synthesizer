...
namespace JJ.Presentation.Synthesizer.Presenters
{
    ...
    public partial class MainPresenter
    {
        ...
        private readonly OperatorPropertiesPresenter_ForDimension _operatorPropertiesPresenter_ForDimension;
        ...
        public MainPresenter(RepositoryWrapper repositoryWrapper)
        {
            ...
            _operatorPropertiesPresenter_ForDimension = new OperatorPropertiesPresenter_ForDimension(_patchRepositories);
        ...
        private void HideAllPropertiesViewModels()
        {
            ...
            MainViewModel.Document.PatchDocumentList.SelectMany(x => x.OperatorPropertiesList_ForDimensions).ForEach(x => x.Visible = false);
